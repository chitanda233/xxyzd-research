...
public class LockFreeLinkedListNode {
    ...
    public static abstract class CondAddOp extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void complete(LockFreeLinkedListNode affected, Object failure) {
            ...
            if (lockFreeLinkedListNode != null && LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, affected, this, lockFreeLinkedListNode) && z) {
    ...
    public final boolean addOneIfEmpty(LockFreeLinkedListNode node) {
        ...
        while (getNext() == this) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_next$FU, this, this, node)) {
                node.finishAdd(this);
                return true;
            }
        }
    ...
    public final boolean addNext(LockFreeLinkedListNode node, LockFreeLinkedListNode next) {
        ...
        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, next, node)) {
            return false;
        }
        node.finishAdd(next);
        return true;
    ...
    public final int tryCondAddNext(LockFreeLinkedListNode node, LockFreeLinkedListNode next, CondAddOp condAdd) {
        ...
        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, next, condAdd)) {
    ...
    public final LockFreeLinkedListNode removeOrNext() {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_next$FU, this, next, lockFreeLinkedListNode.removed()));
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo1921remove()) {
    ...
    public static class AddLastDesc<T extends LockFreeLinkedListNode> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_affectedNode$FU, this, (Object) null, prepareOp.affected);
        }

        @Override // kotlinx.coroutines.internal.LockFreeLinkedListNode.AbstractAtomicDesc
        public Object updatedNext(LockFreeLinkedListNode affected, LockFreeLinkedListNode next) {
            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._prev$FU, this.node, this.node, affected);
            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, this.node, this.node, this.queue);
            return this.node;
        }
    ...
    public static class RemoveFirstDesc<T> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_affectedNode$FU, this, (Object) null, prepareOp.affected);
            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_originalNext$FU, this, (Object) null, prepareOp.next);
        }
        ...
        public Object perform(Object affected) {
            ...
            if (affected != null) {
                ...
                if (objOnPrepare == LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, lockFreeLinkedListNode2.removed())) {
                ...
                LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, objUpdatedNext);
                return null;
            }
    ...
    public static abstract class AbstractAtomicDesc extends AtomicDesc {
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (retry(lockFreeLinkedListNodeTakeAffectedNode, obj)) {
                        ...
                        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNodeTakeAffectedNode, obj, prepareOp)) {
                            try {
                                ...
                                LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNodeTakeAffectedNode, prepareOp, obj);
                                throw th;
                            }
                        } else {
                            continue;
        ...
        public final void complete(AtomicOp<?> op, Object failure) {
            ...
            if (queue == null) {
                ...
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, affectedNode, op, z ? updatedNext(affectedNode, queue) : queue) && z) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (obj == this) {
                        if (lockFreeLinkedListNode != lockFreeLinkedListNode2 && !LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_prev$FU, this, lockFreeLinkedListNode, lockFreeLinkedListNode2)) {
                            break;
                        }
                ...
                if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_next$FU, lockFreeLinkedListNode3, lockFreeLinkedListNode2, ((Removed) obj).ref)) {
                    break;
                }
    ...
    public final void finishAdd(LockFreeLinkedListNode next) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_prev$FU, next, lockFreeLinkedListNode, this));
        if (isRemoved()) {
            next.correctPrev(null);
        }
    }

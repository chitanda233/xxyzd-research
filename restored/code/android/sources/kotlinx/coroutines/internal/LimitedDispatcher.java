...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1923scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1923scheduleResumeAfterDelay(timeMillis, continuation);
    }
                ...
                if (runnableRemoveFirstOrNull != null) {
                    ...
                    if (i >= 16) {
                        ...
                        if (this.dispatcher.isDispatchNeeded(limitedDispatcher)) {
                            this.dispatcher.mo1922dispatch(limitedDispatcher, this);
                            return;
                        }
                    }
                }
    ...
    public void mo1922dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo1922dispatch(this, this);
    }

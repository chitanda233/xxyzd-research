...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM370constructorimpl = Result.m370constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM370constructorimpl = Result.m370constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m373exceptionOrNullimpl(objM370constructorimpl) == null) {
            obj2 = objM370constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM370constructorimpl2 = Result.m370constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM370constructorimpl2 = Result.m370constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m373exceptionOrNullimpl(objM370constructorimpl2) == null) {
            obj = objM370constructorimpl2;
        }

    ...
    public final Object lockSuspend(final Object obj, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (obj2 instanceof Empty) {
                ...
                if (empty.locked != MutexKt.UNLOCKED) {
                    LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj2, new LockedQueue(empty.locked));
                } else {
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj2, obj == null ? MutexKt.EMPTY_LOCKED : new Empty(obj))) {

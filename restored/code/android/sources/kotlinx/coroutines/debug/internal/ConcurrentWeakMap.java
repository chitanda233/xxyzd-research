...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int index) {
            ...
            } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.values, index, obj, (Object) null));
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (hashedWeakRef != null) {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.keys, iIndex, (Object) null, weakKey0)) {
                        break;
                    }
                } else {
                    return null;
            ...
            } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.values, iIndex, obj, value));
            return obj;
        }
        ...
        public final ConcurrentWeakMap<K, V>.Core rehash() {
            ...
            while (true) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.values, i2, obj, ConcurrentWeakMapKt.mark(obj)));

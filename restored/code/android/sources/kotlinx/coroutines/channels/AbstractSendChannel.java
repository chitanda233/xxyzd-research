...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object mo1877trySendJP2dKIU(E element) {
        Object objOfferInternal = offerInternal(element);
        if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m1897successJP2dKIU(Unit.INSTANCE);
        }
        if (objOfferInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m1896failurePtdJZtk() : ChannelResult.INSTANCE.m1895closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1895closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m370constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m370constructorimpl(ResultKt.createFailure(sendException)));
    }

    /* JADX WARN: Code duplicated, block: B:22:0x0041  */
    /* JADX WARN: Code duplicated, block: B:24:0x0044 A[ORIG_RETURN, RETURN] */
    ...
    private final void invokeOnCloseHandler(Throwable cause) {
        ...
        if (obj == null || obj == AbstractChannelKt.HANDLER_INVOKED || !LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(onCloseHandler$FU, this, obj, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> handler) {
        ...
        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, (Object) null, handler)) {
            Object obj = this.onCloseHandler;
        ...
        Closed<?> closedForSend = getClosedForSend();
        if (closedForSend == null || !LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, handler, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1921remove()) {
                receive.helpRemove();
            } else {
                objM1913constructorimpl$default = InlineList.m1918plusFjFbRPM(objM1913constructorimpl$default, receive);
            }
        }
        if (objM1913constructorimpl$default != null) {
            if (!(objM1913constructorimpl$default instanceof ArrayList)) {
                ((Receive) objM1913constructorimpl$default).resumeReceiveClosed(closed);
            } else if (objM1913constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) objM1913constructorimpl$default;
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            if (isFullImpl()) {
                ...
                if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl.resumeWith(Result.m370constructorimpl(Unit.INSTANCE));
                    break;
                }
                if (objOfferInternal != AbstractChannelKt.OFFER_FAILED) {
                    if (objOfferInternal instanceof Closed) {

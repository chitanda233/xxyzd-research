...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            return ChannelResult.m1882boximpl(Result.m377isSuccessimpl(objM370constructorimpl) ? ChannelResult.INSTANCE.m1897successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1895closedJP2dKIU(Result.m373exceptionOrNullimpl(objM370constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1877trySendJP2dKIU = sendChannel.mo1877trySendJP2dKIU(e);
        if (objMo1877trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1892isSuccessimpl(sendChannel.mo1877trySendJP2dKIU(e))) {
            return;
        }

...
public interface ReceiveChannel<E> {
    ...
    Object mo1875receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1876tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1876tryReceivePtdJZtk = receiveChannel.mo1876tryReceivePtdJZtk();
            if (ChannelResult.m1892isSuccessimpl(objMo1876tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1888getOrThrowimpl(objMo1876tryReceivePtdJZtk);
            }
            Throwable thM1886exceptionOrNullimpl = ChannelResult.m1886exceptionOrNullimpl(objMo1876tryReceivePtdJZtk);
            if (thM1886exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1886exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo1875receiveCatchingJP2dKIU = receiveChannel.mo1875receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m1887getOrNullimpl(objMo1875receiveCatchingJP2dKIU);
        }

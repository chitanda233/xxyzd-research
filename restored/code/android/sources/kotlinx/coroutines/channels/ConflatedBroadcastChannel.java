...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(state.value, addSubscriber(state.subscribers, subscriber))));
        return subscriber;
    }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> handler) {
        ...
        if ((obj2 instanceof Closed) && LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, handler, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo1877trySendJP2dKIU(E element) {
        Closed closedOfferInternal = offerInternal(element);
        return closedOfferInternal != null ? ChannelResult.INSTANCE.m1895closedJP2dKIU(closedOfferInternal.getSendException()) : ChannelResult.INSTANCE.m1897successJP2dKIU(Unit.INSTANCE);
    }
    ...
    private final Closed offerInternal(E element) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(element, ((State) obj).subscribers)));
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(obj2, removeSubscriber(subscriberArr, subscriber))));
    }
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, cause == null ? CLOSED : new Closed(cause)));
        Subscriber<E>[] subscriberArr = ((State) obj).subscribers;
        if (subscriberArr != null) {
            for (Subscriber<E> subscriber : subscriberArr) {

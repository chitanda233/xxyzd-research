...
public interface SendChannel<E> {
    ...
    Object mo1877trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1892isSuccessimpl(objMo1877trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1886exceptionOrNullimpl = ChannelResult.m1886exceptionOrNullimpl(objMo1877trySendJP2dKIU);

...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        a.AbstractBinderC0002a abstractBinderC0002a;
        T tInvoke;
        do {
            abstractBinderC0002a = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(abstractBinderC0002a);
        } while (!mutableStateFlow.compareAndSet(abstractBinderC0002a, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            abstractBinderC0002a = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(abstractBinderC0002a, function1.invoke(abstractBinderC0002a)));
    }

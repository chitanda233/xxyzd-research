...
public final class CombineKt {
  ...
  0x00ec: PHI (r10v8 kotlin.collections.IndexedValue) = (r10v7 kotlin.collections.IndexedValue), (r10v21 kotlin.collections.IndexedValue) binds: [B:25:0x00e7, B:51:?] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                try {
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (this.$flows[this.$i].collect(new C05761(this.$resultChannel, this.$i), this) == coroutine_suspended) {
            ...
            static final class C05761<T> implements FlowCollector {
                final /* synthetic */ int $i;
                final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;

                C05761(Channel<IndexedValue<Object>> channel, int i) {
                    this.$resultChannel = channel;
                    this.$i = i;
                }

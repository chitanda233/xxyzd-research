...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1903debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1860toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1860toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    static final class C08402<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C08402(long j, Flow<? extends T> flow, Continuation<? super C08402> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C08402 c08402 = new C08402(this.$periodMillis, this.$this_sample, continuation);
            c08402.L$0 = coroutineScope;
            c08402.L$1 = flowCollector;
            return c08402.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (objectRef.element != NullSurrogateKt.DONE) {
                ...
                this.label = 1;
                C08402<T> c08402 = this;
                SelectBuilderImpl selectBuilderImpl = new SelectBuilderImpl(c08402);
                try {
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c08402);
                }
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j) {
        ...
        return FlowCoroutineKt.scopedFlow(new C08402(j, flow, null));
    }
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$fixedPeriodTicker$3", f = "Delay.kt", i = {0, 1, 2}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_WAIT_TIME_AFTER_FIRST_FRAME, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_TCP_FAST_OPEN, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_CHECK_PACKET_CORRUPT}, m = "invokeSuspend", n = {"$this$produce", "$this$produce", "$this$produce"}, s = {"L$0", "L$0", "L$0"})
    static final class C08393 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08393(long j, long j2, Continuation<? super C08393> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C08393 c08393 = new C08393(this.$initialDelayMillis, this.$delayMillis, continuation);
            c08393.L$0 = obj;
            return c08393;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C08393) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L57:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C08393.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope coroutineScope, long j, long j2) {
        ...
        return ProduceKt.produce$default(coroutineScope, null, 0, new C08393(j2, j, null), 1, null);
    }

    /* JADX INFO: renamed from: sample-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m1904sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1860toDelayMillisLRDsOJo(j));
    }
}

...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0, 0}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_EGL_NEED_WORKAROUND}, m = "first", n = {"predicate", o.c, "collector$iv"}, s = {"L$0", "L$1", "L$2"})
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_EGL_NEED_WORKAROUND}, m = "firstOrNull", n = {o.c, "collector$iv"}, s = {"L$0", "L$1"})
    static final class C08461<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_EGL_NEED_WORKAROUND}, m = "firstOrNull", n = {o.c, "collector$iv"}, s = {"L$0", "L$1"})
    static final class C08473<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C08473(Continuation<? super C08473> continuation) {
            super(continuation);
        }
    ...
    static final class C08481<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0}, l = {155}, m = "last", n = {o.c}, s = {"L$0"})
    static final class C08491<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_SUPER_RES_STRENGTH_OPTION}, m = "lastOrNull", n = {o.c}, s = {"L$0"})
    static final class C08511<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C08511(Continuation<? super C08511> continuation) {
            super(continuation);
        }
    ...
    static final class C08531<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C08531(Continuation<? super C08531> continuation) {
            super(continuation);
        }
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0}, l = {57}, m = "single", n = {o.c}, s = {"L$0"})
    static final class C08551<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C08551(Continuation<? super C08551> continuation) {
            super(continuation);
        }
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_EGL_NEED_WORKAROUND}, m = "singleOrNull", n = {o.c, "collector$iv"}, s = {"L$0", "L$1"})
    static final class C08571<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) throws Throwable {
        ...
        if (continuation instanceof C08531) {
            c08531 = (C08531) continuation;
            if ((c08531.label & Integer.MIN_VALUE) != 0) {
                c08531.label -= Integer.MIN_VALUE;
            } else {
                c08531 = new C08531(continuation);
            }
        } else {
            c08531 = new C08531(continuation);
        }
        Object obj = c08531.result;
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c08542 = new C08542<>(objectRef2, function3);
            c08531.L$0 = objectRef2;
            c08531.label = 1;
            if (flow.collect(c08542, c08531) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c08531.L$0;
            ResultKt.throwOnFailure(obj);
        }
    ...
    static final class C08542<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        C08542(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c08481.L$0 = objectRef2;
            c08481.label = 1;
            if (flow.collect(anonymousClass2, c08481) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c08481.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        C08551 c08551;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C08551) {
            c08551 = (C08551) continuation;
            if ((c08551.label & Integer.MIN_VALUE) != 0) {
                c08551.label -= Integer.MIN_VALUE;
            } else {
                c08551 = new C08551(continuation);
            }
        } else {
            c08551 = new C08551(continuation);
        }
        Object obj = c08551.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c08551.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c08551.L$0 = objectRef2;
            c08551.label = 1;
            if (flow.collect(flowCollector, c08551) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c08551.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                c08571.L$0 = objectRef2;
                c08571.L$1 = flowCollector2;
                c08571.label = 1;
                if (flow.collect(flowCollector2, c08571) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c08571.L$1;
            objectRef = (Ref.ObjectRef) c08571.L$0;
            try {
                ResultKt.throwOnFailure(obj);
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                c08461.L$0 = objectRef2;
                c08461.L$1 = flowCollector2;
                c08461.label = 1;
                if (flow.collect(flowCollector2, c08461) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c08461.L$1;
            objectRef = (Ref.ObjectRef) c08461.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C08473) {
            c08473 = (C08473) continuation;
            if ((c08473.label & Integer.MIN_VALUE) != 0) {
                c08473.label -= Integer.MIN_VALUE;
            } else {
                c08473 = new C08473(continuation);
            }
        } else {
            c08473 = new C08473(continuation);
        }
        Object obj = c08473.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c08473.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c08473.L$0 = objectRef2;
                c08473.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c08473.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c08473) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c08473.L$1;
            objectRef = (Ref.ObjectRef) c08473.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object last(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c08491.L$0 = objectRef2;
            c08491.label = 1;
            if (flow.collect(flowCollector, c08491) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c08491.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
            throw new NoSuchElementException("Expected at least one element");
    ...
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        C08511 c08511;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C08511) {
            c08511 = (C08511) continuation;
            if ((c08511.label & Integer.MIN_VALUE) != 0) {
                c08511.label -= Integer.MIN_VALUE;
            } else {
                c08511 = new C08511(continuation);
            }
        } else {
            c08511 = new C08511(continuation);
        }
        Object obj = c08511.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c08511.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c08511.L$0 = objectRef2;
            c08511.label = 1;
            if (flow.collect(flowCollector, c08511) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c08511.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }

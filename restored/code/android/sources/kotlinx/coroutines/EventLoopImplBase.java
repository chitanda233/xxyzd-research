...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo1923scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
    ...
    public final void mo1922dispatch(CoroutineContext context, Runnable block) {
        enqueue(block);
    }
    ...
    private final void closeQueue() {
        ...
        while (true) {
            Object obj = this._queue;
            if (obj == null) {
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, (Object) null, EventLoop_commonKt.CLOSED_EMPTY)) {
                    return;
                }
                ...
                if (obj != null) {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore)) {
                        return;
                    }
                } else {
    ...
    private final int scheduleImpl(long now, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_delayed$FU, this, (Object) null, new DelayedTaskQueue(now));
    ...
    private final boolean enqueueImpl(Runnable task) {
        while (true) {
            ...
            if (obj == null) {
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, (Object) null, task)) {
                    return true;
                }
            } else if (obj instanceof LockFreeTaskQueueCore) {
                if (obj != null) {
                    ...
                    if (iAddLast == 1) {
                        LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore.next());
                    } else if (iAddLast == 2) {
                        return false;
                    }
                } else {
                ...
                if (obj != null) {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore2)) {
                        return true;
                    }
                } else {
                    throw new NullPointerException("null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
    ...
    private final Runnable dequeue() {
        while (true) {
            ...
            if (obj instanceof LockFreeTaskQueueCore) {
                ...
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, (Object) null)) {
                    if (obj != null) {
                        return (Runnable) obj;
                    }
                    throw new NullPointerException("null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");

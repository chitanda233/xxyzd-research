...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    private final void doResume(Function0<? extends Object> value, Function0<Unit> block) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.UNDECIDED, value.invoke())) {
                    return;
                }
            } else if (obj == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    block.invoke();
                    return;
                }
            } else {
    ...
    public final Object getResult() {
        ...
        Object obj = this._result;
        if (obj == SelectKt.UNDECIDED) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            ...
            resumeWith(Result.m370constructorimpl(ResultKt.createFailure(e)));
        } else {
    ...
    private static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            if (affected != null) {
                ...
                LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(SelectBuilderImpl._state$FU, selectBuilderImpl, this, objDecide == null ? this.otherOp.desc : SelectKt.getNOT_SELECTED());
                return objDecide;
            }
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            Object obj = this._result;
            if (obj == SelectKt.UNDECIDED) {
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.UNDECIDED, CompletionStateKt.toState$default(result, null, 1, null))) {
                    return;
                }
            } else if (obj == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    if (Result.m376isFailureimpl(result)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable thM373exceptionOrNullimpl = Result.m373exceptionOrNullimpl(result);
                        Intrinsics.checkNotNull(thM373exceptionOrNullimpl);
                        Result.Companion companion = Result.INSTANCE;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            thM373exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM373exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m370constructorimpl(ResultKt.createFailure(thM373exceptionOrNullimpl)));
                        return;
                    }
        ...
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                ...
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuationIntercepted.resumeWith(Result.m370constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            } else {
                throw new IllegalStateException("Already resumed");
    ...
    public Object trySelectOther(LockFreeLinkedListNode.PrepareOp otherOp) {
        while (true) {
            ...
            if (obj == SelectKt.getNOT_SELECTED()) {
                if (otherOp == null) {
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, SelectKt.getNOT_SELECTED(), (Object) null)) {
                        break;
                    }
                } else {
                    PairSelectOp pairSelectOp = new PairSelectOp(otherOp);
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, SelectKt.getNOT_SELECTED(), pairSelectOp)) {

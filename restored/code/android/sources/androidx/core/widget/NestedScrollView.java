...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (keyEvent.isAltPressed()) {
                return fullScroll(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE);
            }
            return arrowScroll(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE);
        }
        if (keyCode == 62) {
        ...
        pageScroll(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE);
        return false;
    }
    ...
    public final void smoothScrollBy(int i, int i2) {
        smoothScrollBy(i, i2, MediaPlayer.MEDIA_PLAYER_OPTION_TT_HLS_DRM, false);
    }
    ...
    public final void smoothScrollTo(int i, int i2) {
        smoothScrollTo(i, i2, MediaPlayer.MEDIA_PLAYER_OPTION_TT_HLS_DRM, false);
    }
    ...
    void smoothScrollTo(int i, int i2, boolean z) {
        smoothScrollTo(i, i2, MediaPlayer.MEDIA_PLAYER_OPTION_TT_HLS_DRM, z);
    }
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.scrollPosition + l.d;
        }
    }

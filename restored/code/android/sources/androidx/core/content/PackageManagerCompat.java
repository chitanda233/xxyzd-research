...
public final class PackageManagerCompat {
    ...
    public static String getPermissionRevocationVerifierApp(PackageManager packageManager) {
        String str = null;
        Iterator<ResolveInfo> it = packageManager.queryIntentActivities(new Intent(ACTION_PERMISSION_REVOCATION_SETTINGS).setData(Uri.fromParts(AbsServerManager.PACKAGE_QUERY_BINDER, "com.example", null)), 0).iterator();
        while (it.hasNext()) {

...
public class FileProvider extends ContentProvider {
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        String str = providerInfo.authority.split(l.b)[0];
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Uri.Builder().scheme(IAdInterListener.AdProdType.PRODUCT_CONTENT).authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(strSubstring, "/")).build();

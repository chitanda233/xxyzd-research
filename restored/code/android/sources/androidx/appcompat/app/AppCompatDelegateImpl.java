...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private boolean onKeyUpPanel(int i, KeyEvent keyEvent) {
        ...
        if (zHideOverflowMenu) {
            AudioManager audioManager = (AudioManager) this.mContext.getApplicationContext().getSystemService(MediaFormat.KEY_AUDIO);
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT) != (configuration2.screenLayout & MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT)) {
                configuration3.screenLayout |= configuration2.screenLayout & MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT;
            }

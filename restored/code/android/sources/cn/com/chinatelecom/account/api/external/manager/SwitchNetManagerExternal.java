...
public class SwitchNetManagerExternal implements ISwitchNetExternal {
    ...
    public void switchToMobileNetV4(final SwitchCalllBackExternal switchCalllBackExternal, final String str) {
        new ThreadPoolManager().executeTask(new WorkTask() { // from class: cn.com.chinatelecom.account.api.external.manager.SwitchNetManagerExternal.3
        ...
        try {
            ...
            if (connectivityManager.getNetworkInfo(5).getState().compareTo(NetworkInfo.State.CONNECTED) != 0) {
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < i && connectivityManager.getNetworkInfo(5).getState().compareTo(NetworkInfo.State.CONNECTED) != 0; i2++) {
                        Thread.sleep(500L);
                    }
                } catch (Throwable th) {

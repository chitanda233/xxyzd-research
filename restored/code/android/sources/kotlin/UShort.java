...
public final class UShort implements Comparable<UShort> {
    ...
    private static final int m647compareToVKZWuLQ(short s, long j) {
        return Long.compareUnsigned(ULong.m544constructorimpl(((long) s) & 65535), j);
    }
    ...
    private static final long m676plusVKZWuLQ(short s, long j) {
        return ULong.m544constructorimpl(ULong.m544constructorimpl(((long) s) & 65535) + j);
    }
    ...
    private static final long m654divVKZWuLQ(short s, long j) {
        return Long.divideUnsigned(ULong.m544constructorimpl(((long) s) & 65535), j);
    }
    ...
    private static final long m682remVKZWuLQ(short s, long j) {
        return Long.remainderUnsigned(ULong.m544constructorimpl(((long) s) & 65535), j);
    }
    ...
    private static final UIntRange m680rangeUntilxj2QHRw(short s, short s2) {
        return URangesKt.m1650untilJ1ME1BU(UInt.m465constructorimpl(s & MAX_VALUE), UInt.m465constructorimpl(s2 & MAX_VALUE));
    }
    ...
    private static final long m698toULongsVKNKU(short s) {
        return ULong.m544constructorimpl(((long) s) & 65535);
    }

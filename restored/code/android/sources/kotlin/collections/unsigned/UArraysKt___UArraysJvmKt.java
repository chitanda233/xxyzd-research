...
class UArraysKt___UArraysJvmKt {
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m859maxByjgv0xPQ(int[] maxBy, Function1<? super UInt, ? extends R> selector) {
        ...
        int iM525getpVg5ArA = UIntArray.m525getpVg5ArA(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UInt.m459boximpl(iM525getpVg5ArA));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                int iM525getpVg5ArA2 = UIntArray.m525getpVg5ArA(maxBy, it.nextInt());
                R rInvoke2 = selector.invoke(UInt.m459boximpl(iM525getpVg5ArA2));
                if (rInvoke.compareTo(rInvoke2) < 0) {
                    iM525getpVg5ArA = iM525getpVg5ArA2;
                    rInvoke = rInvoke2;
                }
            }
        }
        return UInt.m459boximpl(iM525getpVg5ArA);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m858maxByMShoTSo(long[] maxBy, Function1<? super ULong, ? extends R> selector) {
        ...
        long jM604getsVKNKU = ULongArray.m604getsVKNKU(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(ULong.m538boximpl(jM604getsVKNKU));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                long jM604getsVKNKU2 = ULongArray.m604getsVKNKU(maxBy, it.nextInt());
                R rInvoke2 = selector.invoke(ULong.m538boximpl(jM604getsVKNKU2));
                if (rInvoke.compareTo(rInvoke2) < 0) {
                    jM604getsVKNKU = jM604getsVKNKU2;
                    rInvoke = rInvoke2;
                }
            }
        }
        return ULong.m538boximpl(jM604getsVKNKU);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m857maxByJOV_ifY(byte[] maxBy, Function1<? super UByte, ? extends R> selector) {
        ...
        byte bM446getw2LRezQ = UByteArray.m446getw2LRezQ(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UByte.m382boximpl(bM446getw2LRezQ));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                byte bM446getw2LRezQ2 = UByteArray.m446getw2LRezQ(maxBy, it.nextInt());
                R rInvoke2 = selector.invoke(UByte.m382boximpl(bM446getw2LRezQ2));
                if (rInvoke.compareTo(rInvoke2) < 0) {
                    bM446getw2LRezQ = bM446getw2LRezQ2;
                    rInvoke = rInvoke2;
                }
            }
        }
        return UByte.m382boximpl(bM446getw2LRezQ);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m860maxByxTcfx_M(short[] maxBy, Function1<? super UShort, ? extends R> selector) {
        ...
        short sM709getMh2AYeg = UShortArray.m709getMh2AYeg(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UShort.m645boximpl(sM709getMh2AYeg));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                short sM709getMh2AYeg2 = UShortArray.m709getMh2AYeg(maxBy, it.nextInt());
                R rInvoke2 = selector.invoke(UShort.m645boximpl(sM709getMh2AYeg2));
                if (rInvoke.compareTo(rInvoke2) < 0) {
                    sM709getMh2AYeg = sM709getMh2AYeg2;
                    rInvoke = rInvoke2;
                }
            }
        }
        return UShort.m645boximpl(sM709getMh2AYeg);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m871minByjgv0xPQ(int[] minBy, Function1<? super UInt, ? extends R> selector) {
        ...
        int iM525getpVg5ArA = UIntArray.m525getpVg5ArA(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UInt.m459boximpl(iM525getpVg5ArA));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                int iM525getpVg5ArA2 = UIntArray.m525getpVg5ArA(minBy, it.nextInt());
                R rInvoke2 = selector.invoke(UInt.m459boximpl(iM525getpVg5ArA2));
                if (rInvoke.compareTo(rInvoke2) > 0) {
                    iM525getpVg5ArA = iM525getpVg5ArA2;
                    rInvoke = rInvoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m870minByMShoTSo(long[] minBy, Function1<? super ULong, ? extends R> selector) {
        ...
        long jM604getsVKNKU = ULongArray.m604getsVKNKU(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(ULong.m538boximpl(jM604getsVKNKU));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                long jM604getsVKNKU2 = ULongArray.m604getsVKNKU(minBy, it.nextInt());
                R rInvoke2 = selector.invoke(ULong.m538boximpl(jM604getsVKNKU2));
                if (rInvoke.compareTo(rInvoke2) > 0) {
                    jM604getsVKNKU = jM604getsVKNKU2;
                    rInvoke = rInvoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m869minByJOV_ifY(byte[] minBy, Function1<? super UByte, ? extends R> selector) {
        ...
        byte bM446getw2LRezQ = UByteArray.m446getw2LRezQ(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UByte.m382boximpl(bM446getw2LRezQ));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                byte bM446getw2LRezQ2 = UByteArray.m446getw2LRezQ(minBy, it.nextInt());
                R rInvoke2 = selector.invoke(UByte.m382boximpl(bM446getw2LRezQ2));
                if (rInvoke.compareTo(rInvoke2) > 0) {
                    bM446getw2LRezQ = bM446getw2LRezQ2;
                    rInvoke = rInvoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m872minByxTcfx_M(short[] minBy, Function1<? super UShort, ? extends R> selector) {
        ...
        short sM709getMh2AYeg = UShortArray.m709getMh2AYeg(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UShort.m645boximpl(sM709getMh2AYeg));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                short sM709getMh2AYeg2 = UShortArray.m709getMh2AYeg(minBy, it.nextInt());
                R rInvoke2 = selector.invoke(UShort.m645boximpl(sM709getMh2AYeg2));
                if (rInvoke.compareTo(rInvoke2) > 0) {
                    sM709getMh2AYeg = sM709getMh2AYeg2;
                    rInvoke = rInvoke2;
    ...
    private static final BigDecimal sumOfBigDecimal(int[] sumOf, Function1<? super UInt, ? extends BigDecimal> selector) {
        ...
        int iM526getSizeimpl = UIntArray.m526getSizeimpl(sumOf);
        for (int i = 0; i < iM526getSizeimpl; i++) {
            bigDecimalValueOf = bigDecimalValueOf.add(selector.invoke(UInt.m459boximpl(UIntArray.m525getpVg5ArA(sumOf, i))));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] sumOf, Function1<? super ULong, ? extends BigDecimal> selector) {
        ...
        BigDecimal bigDecimalValueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "valueOf(this.toLong())");
        int iM605getSizeimpl = ULongArray.m605getSizeimpl(sumOf);
        for (int i = 0; i < iM605getSizeimpl; i++) {
            bigDecimalValueOf = bigDecimalValueOf.add(selector.invoke(ULong.m538boximpl(ULongArray.m604getsVKNKU(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "this.add(other)");
        }
        return bigDecimalValueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] sumOf, Function1<? super UByte, ? extends BigDecimal> selector) {
        ...
        BigDecimal bigDecimalValueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "valueOf(this.toLong())");
        int iM447getSizeimpl = UByteArray.m447getSizeimpl(sumOf);
        for (int i = 0; i < iM447getSizeimpl; i++) {
            bigDecimalValueOf = bigDecimalValueOf.add(selector.invoke(UByte.m382boximpl(UByteArray.m446getw2LRezQ(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "this.add(other)");
        }
        return bigDecimalValueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sumOf, Function1<? super UShort, ? extends BigDecimal> selector) {
        ...
        BigDecimal bigDecimalValueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "valueOf(this.toLong())");
        int iM710getSizeimpl = UShortArray.m710getSizeimpl(sumOf);
        for (int i = 0; i < iM710getSizeimpl; i++) {
            bigDecimalValueOf = bigDecimalValueOf.add(selector.invoke(UShort.m645boximpl(UShortArray.m709getMh2AYeg(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "this.add(other)");
        }
        return bigDecimalValueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(int[] sumOf, Function1<? super UInt, ? extends BigInteger> selector) {
        ...
        int iM526getSizeimpl = UIntArray.m526getSizeimpl(sumOf);
        for (int i = 0; i < iM526getSizeimpl; i++) {
            bigIntegerValueOf = bigIntegerValueOf.add(selector.invoke(UInt.m459boximpl(UIntArray.m525getpVg5ArA(sumOf, i))));
    ...
    private static final BigInteger sumOfBigInteger(long[] sumOf, Function1<? super ULong, ? extends BigInteger> selector) {
        ...
        int iM605getSizeimpl = ULongArray.m605getSizeimpl(sumOf);
        for (int i = 0; i < iM605getSizeimpl; i++) {
            bigIntegerValueOf = bigIntegerValueOf.add(selector.invoke(ULong.m538boximpl(ULongArray.m604getsVKNKU(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigIntegerValueOf, "this.add(other)");
        }
        return bigIntegerValueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(byte[] sumOf, Function1<? super UByte, ? extends BigInteger> selector) {
        ...
        int iM447getSizeimpl = UByteArray.m447getSizeimpl(sumOf);
        for (int i = 0; i < iM447getSizeimpl; i++) {
            bigIntegerValueOf = bigIntegerValueOf.add(selector.invoke(UByte.m382boximpl(UByteArray.m446getw2LRezQ(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigIntegerValueOf, "this.add(other)");
        }
        return bigIntegerValueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(short[] sumOf, Function1<? super UShort, ? extends BigInteger> selector) {
        ...
        int iM710getSizeimpl = UShortArray.m710getSizeimpl(sumOf);
        for (int i = 0; i < iM710getSizeimpl; i++) {
            bigIntegerValueOf = bigIntegerValueOf.add(selector.invoke(UShort.m645boximpl(UShortArray.m709getMh2AYeg(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigIntegerValueOf, "this.add(other)");
        }
        return bigIntegerValueOf;
    }

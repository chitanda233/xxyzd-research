...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C07931(input, limit, null));
    }
    ...
    static final class C07931 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07931(CharSequence charSequence, int i, Continuation<? super C07931> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07931 c07931 = Regex.this.new C07931(this.$input, this.$limit, continuation);
            c07931.L$0 = obj;
            return c07931;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C07931) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i2 == 0) {
                ...
                if (this.$limit == 1 || !matcher2.find()) {
                    ...
                    matcher = matcher2;
                    i = 0;
                    c07931.L$0 = sequenceScope;
                    c07931.L$1 = matcher;
                    c07931.I$0 = i;
                    c07931.label = 2;
                    if (sequenceScope.yield(c07931.$input.subSequence(iEnd, matcher.start()).toString(), c07931) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    iEnd = matcher.end();
                    i++;
                    ...
                    charSequence = c07931.$input;
                    c07931.L$0 = null;
                    c07931.L$1 = null;
                    c07931.label = 3;
                    if (sequenceScope.yield(charSequence.subSequence(iEnd, charSequence.length()).toString(), c07931) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                ...
                if (i2 != 1) {
                    if (i2 == 2) {
                        ...
                        iEnd = matcher.end();
                        i++;
                        if (i != c07931.$limit - 1 || !matcher.find()) {
                            charSequence = c07931.$input;
                            c07931.L$0 = null;
                            c07931.L$1 = null;
                            c07931.label = 3;

...
public final class UStringsKt {
    ...
    public static final String m1682toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1684toStringolVBNx4(short s, int i) {
    ...
    public static final String m1683toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1681toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m465constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m382boximpl(UByte.m388constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m465constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m645boximpl(UShort.m651constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM465constructorimpl = UInt.m465constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM465constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM465constructorimpl2 = UInt.m465constructorimpl(i3 * iM465constructorimpl);
            int iM465constructorimpl3 = UInt.m465constructorimpl(UInt.m465constructorimpl(iDigitOf) + iM465constructorimpl2);
            if (Integer.compareUnsigned(iM465constructorimpl3, iM465constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM465constructorimpl3;
        }
        return UInt.m459boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM544constructorimpl = ULong.m544constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM544constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM544constructorimpl2 = ULong.m544constructorimpl(j * jM544constructorimpl);
            long jM544constructorimpl3 = ULong.m544constructorimpl(ULong.m544constructorimpl(((long) UInt.m465constructorimpl(iDigitOf)) & 4294967295L) + jM544constructorimpl2);
            if (Long.compareUnsigned(jM544constructorimpl3, jM544constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM544constructorimpl3;
        }
        return ULong.m538boximpl(j);
    }
}

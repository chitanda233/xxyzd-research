...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1835boximpl(m1829markNowz9LOYto());
    }
    ...
    public long m1829markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1838constructorimpl(read());
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1828elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1827differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m1826adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1838constructorimpl(LongSaturatedMathKt.m1824saturatingAddpTJri5U(timeMark, duration));
    }
}

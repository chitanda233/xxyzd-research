...
public final class DurationKt {
    ...
    private static final long m1822timesmvk6XK0(int i, long j) {
        return Duration.m1734timesUwyO8pc(j, i);
    }
    ...
    private static final long m1821timeskIfJnKk(double d, long j) {
        return Duration.m1733timesUwyO8pc(j, d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code duplicated, block: B:171:0x00af A[EDGE_INSN: B:171:0x00af->B:49:0x00af BREAK  A[LOOP:1: B:36:0x006d->B:47:0x009f], SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:47:0x009f A[LOOP:1: B:36:0x006d->B:47:0x009f, LOOP_END] */
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1798getZEROUwyO8pc = Duration.INSTANCE.m1798getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    i3 = length3 + 1;
                    DurationUnit durationUnitDurationUnitByIsoChar = DurationUnitKt.durationUnitByIsoChar(cCharAt3, z8);
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM1732plusLRDsOJo = Duration.m1732plusLRDsOJo(jM1798getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1798getZEROUwyO8pc = Duration.m1732plusLRDsOJo(jM1732plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM1798getZEROUwyO8pc = Duration.m1732plusLRDsOJo(jM1798getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM1798getZEROUwyO8pc = Duration.INSTANCE.m1796getINFINITEUwyO8pc();
            } else {
                boolean z9 = !z6;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1732plusLRDsOJo2 = Duration.m1732plusLRDsOJo(jM1798getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring7 = strSubstring4.substring(iIndexOf$default2);
                        String str6 = str4;
                        Intrinsics.checkNotNullExpressionValue(strSubstring7, str6);
                        jM1798getZEROUwyO8pc = Duration.m1732plusLRDsOJo(jM1732plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                        str4 = str6;
                    } else {
                        jM1798getZEROUwyO8pc = Duration.m1732plusLRDsOJo(jM1798getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m1748unaryMinusUwyO8pc(jM1798getZEROUwyO8pc) : jM1798getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1696constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1696constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1696constructorimpl((j << 1) + ((long) i));
    }

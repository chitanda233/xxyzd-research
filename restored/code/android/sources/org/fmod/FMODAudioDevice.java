...
public class FMODAudioDevice implements Runnable {
    ...
    private volatile Thread f4092a = null;
    ...
    public boolean isRunning() {
        return this.f4092a != null && this.f4092a.isAlive();
    }
    ...
    public synchronized void start() {
        ...
        this.f4092a = new Thread(this, "FMODAudioDevice");
        this.f4092a.setPriority(10);
        this.b = true;
        this.f4092a.start();
        if (this.g != null) {
            this.g.c();

...
final class FakeDrag {
    ...
    private final ViewPager2 f522a;
    ...
    boolean a(float f) {
        ...
        boolean z = this.f522a.getOrientation() == 0;
        int i = z ? iRound : 0;
        int i2 = z ? 0 : iRound;
    ...
    private void d() {
        ...
        if (velocityTracker == null) {
            ...
            this.e = ViewConfiguration.get(this.f522a.getContext()).getScaledMaximumFlingVelocity();
        } else {

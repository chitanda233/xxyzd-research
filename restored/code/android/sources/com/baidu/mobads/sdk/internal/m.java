                ...
                if (!map.isEmpty()) {
                    ...
                    if (!map2.isEmpty()) {
                        ...
                        for (String str5 : setKeySet) {
                            if (!TextUtils.isEmpty(str5)) {
                                ...
                                if (!TextUtils.isEmpty(str6)) {
                                    ...
                                    jSONObject.put(com.kuaishou.weapon.p0.t.f2732a, str5);
                                    jSONObject.put(com.kuaishou.weapon.p0.t.c, str6);
                        ...
                        if (jSONArray.length() > 0) {
                            ...
                            jSONObject2.put(com.sigmob.sdk.base.n.m, jSONArray.toString());
                            if (jSONObject2.toString().length() < 3000) {
                                map3.put(com.sigmob.sdk.base.n.m, jSONObject2.toString());
                            }
                        }
                    }
                    return map3;

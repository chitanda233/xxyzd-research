...
public class ViewPager2 extends ViewGroup {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (parcelable != null) {
            ...
            StatefulAdapter adapter = this.j.getAdapter();
            if (adapter instanceof StatefulAdapter) {
                savedState.c = adapter.saveState();
            }
        }
        return savedState;
    }
    ...
    protected void dispatchRestoreInstanceState(SparseArray<Parcelable> sparseArray) {
        ...
        if (parcelable instanceof SavedState) {
            int i = ((SavedState) parcelable).f540a;
    ...
    private class PagerSnapHelperImpl extends PagerSnapHelper {
        ...
        @Override // com.baidu.mobads.sdk.internal.widget.PagerSnapHelper
    ...
    private static class SmoothScrollToPosition implements Runnable {
        ...
        public void run() {
            this.b.smoothScrollToPosition(this.f541a);
        }
    }

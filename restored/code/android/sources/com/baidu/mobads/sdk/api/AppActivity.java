...
public class AppActivity extends Activity {
    ...
    @Override // android.app.Activity
    protected void onCreate(Bundle bundle) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        Class<?> clsA;
        activity = this;
        super.onCreate(bundle);
        Intent intent = getIntent();
        try {
            ClassLoader classLoaderA = bu.a(this);
            ...
            if (!TextUtils.isEmpty(stringExtra) && (clsA = av.a(stringExtra, this.mLoader)) != null) {
                try {
                    objNewInstance = clsA.getConstructor(new Class[0]).newInstance(new Object[0]);
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }

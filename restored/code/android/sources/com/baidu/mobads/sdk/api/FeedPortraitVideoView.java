...
public class FeedPortraitVideoView extends RelativeLayout {
    ...
    public void play() {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, PointCategory.PLAY, new Class[0], new Object[0]);
        }
    }
    ...
    public void pause() {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, a.j, new Class[0], new Object[0]);
        }
    }

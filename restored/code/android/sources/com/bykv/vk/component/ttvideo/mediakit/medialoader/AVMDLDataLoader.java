...
public class AVMDLDataLoader implements Handler.Callback {
    ...
    private int testFileIOSpeed() {
        ...
        String str = this.mConfigure.mCacheDir.charAt(this.mConfigure.mCacheDir.length() - 1) == '/' ? String.format("%siospeed", this.mConfigure.mCacheDir) : String.format("%s/iospeed", this.mConfigure.mCacheDir);
        ...
        try {
            ...
            for (int i = 0; i < 30; i++) {
                try {
                    dTestFileIO = testFileIO(str, i, randomAccessFile);
                    try {

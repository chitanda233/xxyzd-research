...
public class TTPlayerClient extends MediaPlayerClient implements Handler.Callback, ISurfaceListener {
    ...
    public void setDataSource(Context context, Uri uri) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        ...
        if (IAdInterListener.AdProdType.PRODUCT_CONTENT.equals(uri.getScheme()) && "settings".equals(uri.getAuthority()) && (uri = RingtoneManager.getActualDefaultRingtoneUri(context, RingtoneManager.getDefaultType(uri))) == null) {
                ...
                switch (i2) {
                    ...
                    case 6:
                        ...
                        if (onVideoSizeChangedListener != null) {
                            onVideoSizeChangedListener.onVideoSizeChanged(this.mWrapper, i3 & SupportMenu.USER_MASK, i3 >> 16);
                            return;
                        }
                        return;
                    default:
                        switch (i2) {
                            ...
                            case 23:
                                ...
                                if (onsarchangedlistener != null) {
                                    onsarchangedlistener.onSARChanged(this.mWrapper, i3 & SupportMenu.USER_MASK, i3 >> 16);
                                    return;
                                }
                                return;
                            default:

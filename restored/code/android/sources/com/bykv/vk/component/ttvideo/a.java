...
public class a implements MediaPlayer {
    ...
    private MediaPlayerClient f1662a;
    ...
    public static MediaPlayer a(Context context, int i) {
        ...
        synchronized (a.class) {
            try {
                if (i == 1) {
                    aVar.f1662a = OSPlayerClient.create(aVar, context);
                    str = "MediaPlayerWrapper";
                    str2 = "create player type OS";
                } else {
                    aVar.f1662a = TTPlayerClient.create(aVar, context);
                    str = "MediaPlayerWrapper";
    ...
    public int getCurrentPosition() {
        MediaPlayerClient mediaPlayerClient = this.f1662a;
    ...
    public boolean isOSPlayer() {
        return this.f1662a instanceof OSPlayerClient;
    }
    ...
    public void setIsMute(boolean z) {
        ...
        if (!isOSPlayer()) {
            this.f1662a.setIsMute(z);
            return;
        }
        float f = z ? 0.0f : 1.0f;
        try {
            this.f1662a.setVolume(f, f);
    ...
    public void setSurface(Surface surface) {
        ...
        if ((surface == null || surface.isValid()) && (mediaPlayerClient = this.f1662a) != null) {

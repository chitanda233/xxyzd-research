...
public class TTVideoEngine implements com.bykv.vk.component.ttvideo.log.a, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    class a implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ MediaPlayer f1659a;

        a(TTVideoEngine tTVideoEngine, MediaPlayer mediaPlayer) {
            this.f1659a = mediaPlayer;
        }

        @Override // java.lang.Runnable
        public void run() {
            MediaPlayer mediaPlayer = this.f1659a;
            if (mediaPlayer != null) {
                try {
                    mediaPlayer.release();
                } catch (Exception e) {
    ...
    private static class c implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final Map<String, String> f1661a;
        ...
        public void run() {
            ...
            if (tTVideoEngine == null || tTVideoEngine.b == 5 || (map = this.f1661a) == null || map.size() <= 0) {
                return;
            }
            for (String str : this.f1661a.keySet()) {
                String str2 = this.f1661a.get(str);
    ...
    private void a(int i, int i2) {
        if (this.l != i) {
            ...
            if (i == 2 && this.f1658a && !this.c && this.l != 3) {
                this.V = i2;
            }
            this.l = i;
    ...
    private void a(String str, HashMap map) {
        ...
        this.H.setIntOption(MediaPlayer.MEDIA_PLAYER_OPTION_OUTPUT_LOG, this.q);
    ...
    private void c() {
        ...
        if (!this.f1658a && mediaPlayer.getIntOption(62, -100) == 0 && !this.i && this.T && this.f) {
            k();
        }
    }
    ...
    public Map versionInfo() {
        ...
        map.put(com.alipay.sdk.m.w.a.v, "5.6");
        return map;
    }
}

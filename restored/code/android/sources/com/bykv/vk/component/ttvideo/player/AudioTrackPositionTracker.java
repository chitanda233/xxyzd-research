...
final class AudioTrackPositionTracker {
    ...
    private long framesToDurationUs(long j) {
        return (j * C.MICROS_PER_SECOND) / ((long) this.outputSampleRate);
    }
    ...
    private long getPlaybackHeadPosition() {
        ...
        if (this.stopTimestampUs != -9223372036854775807L) {
            return Math.min(this.endPlaybackHeadPosition, this.stopPlaybackHeadPosition + ((((SystemClock.elapsedRealtime() * 1000) - this.stopTimestampUs) * ((long) this.outputSampleRate)) / C.MICROS_PER_SECOND));
        }

...
public class DataLoaderHelper implements AVMDLDataLoaderListener, AVMDLStartCompleteListener {
    ...
    public class c {
        ...
        public class a {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            public String f1653a = null;
            public long b = 0;
            public long c = 0;
            public List<C0321a> d = null;
            public Error f = null;
            ...
            void a(long j) {
                ...
                if (this.d.size() == 0) {
                    this.d.add(new C0321a(this));
                }
                this.d.get(0).f1654a = 0L;
                this.d.get(0).b = j;
            }
            ...
            public boolean a() {
                ...
                List<C0321a> list = this.d;
                C0321a c0321a = list != null ? list.get(list.size() - 1) : null;
                if (this.f == null) {
                    return c0321a != null && this.b > 0 && c0321a.f1654a + c0321a.b >= jMin;
                }
                return true;
            }
    ...
    private class d {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final ReentrantLock f1655a;
        private final ArrayList<b> b;
        private long c;

        private d(DataLoaderHelper dataLoaderHelper) {
            this.f1655a = new ReentrantLock();
        ...
        public b b(b bVar) {
            b bVarC;
            if (TextUtils.isEmpty(bVar.f1650a)) {
                bVarC = null;
            } else {
                bVarC = d(bVar.f1650a);
                if (bVarC != null) {
            ...
            while (it.hasNext() && (bVarC = c(it.next().f1651a)) == null) {
            }
            return bVarC;
        }
        ...
        public b d(String str) {
            ...
            for (int i = 0; i < this.b.size(); i++) {
                b bVar2 = this.b.get(i);
                if (!TextUtils.isEmpty(bVar2.f1650a) && bVar2.f1650a.equals(str)) {
                    bVar = bVar2;
                    break;
                }
            }
    ...
    private void a(b bVar) {
        ...
        while (true) {
            ...
            if (!TextUtils.isEmpty(bVar2.f1650a) && !TextUtils.isEmpty(bVar.f1650a) && bVar2.f1650a.equals(bVar.f1650a)) {
                z = false;
                break;
            }
            i++;
        }
        if (!z || (arrayListA = a(bVar.f1650a)) == null || arrayListA.size() == 0) {
            return;
        }
    ...
    private void a(b bVar, b.a aVar) {
        ...
        TTVideoEngineLog.i("DataLoaderHelper", "[preload] start mdl preload task.  key = " + aVar.f1651a);
        String str = aVar.f1651a;
        String[] strArr = aVar.c;
        if (strArr != null) {
            String strA = a(str, bVar.f1650a, aVar.f, 0L, strArr, aVar.d);
            aVar.b = strA;
            if (!TextUtils.isEmpty(strA)) {
                ...
                TTVideoEngineLog.i("DataLoaderHelper", String.format("[preload] exect preload task ,key is %s; videoId = %s", aVar.f1651a, bVar.f1650a));
                return;
            }
        }
        bVar.a(-100001);
    ...
    private void a(AVMDLDataLoaderNotifyInfo aVMDLDataLoaderNotifyInfo, boolean z, boolean z2) {
        ...
        try {
            ...
            if (loadProgressByRawKey.b() || z2) {
                ...
                dataLoaderTaskProgressInfo.mVideoId = bVarB.f1650a;
    ...
    public String _proxyUrl(String str, String str2, long j, String[] strArr, String str3) {
        if (this.f1649a != 0 || TextUtils.isEmpty(str) || strArr == null || strArr.length <= 0) {
            return null;
        }
        String[] strArr2 = (String[]) strArr.clone();
        for (String str4 : strArr2) {
        ...
        if (i != 0 && i != 15) {
            ...
            if ((aVMDLDataLoaderNotifyInfo.logInfo == null || aVMDLDataLoaderNotifyInfo.parameter != 3) && aVMDLDataLoaderNotifyInfo.logInfo != null) {
                ...
                if (strArrSplit2.length > 0 && (bVarB = this.d.b((str = strArrSplit2[0]))) != null) {
                    ...
                    dVar.c(str);
                    TTVideoEngineLog.i("DataLoaderHelper", "pop all task item. videoId = " + bVarB.f1650a + " key = " + str);
                    removeLoadProgressByRawKey(str3);

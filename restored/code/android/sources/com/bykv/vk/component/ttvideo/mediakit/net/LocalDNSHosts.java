                        ...
                        if (!TextUtils.isEmpty(LocalDNSHosts.this.mHosts[i])) {
                            try {
                                ...
                                if (!TextUtils.isEmpty(str2)) {
                                    ...
                                    IPCache.getInstance().put(LocalDNSHosts.this.mHosts[i], new AVMDLDNSInfo(0, LocalDNSHosts.this.mHosts[i], str2, ((long) ((AVMDLDNSParser.mGlobalForceExpiredTime > 0 ? AVMDLDNSParser.mGlobalForceExpiredTime : AVMDLDNSParser.mGlobalDefaultExpiredTime) * 1000)) + System.currentTimeMillis(), LocalDNSHosts.this.mId));
                                }
                            } catch (Throwable th) {

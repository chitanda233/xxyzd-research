...
public class LiveLoggerService implements Handler.Callback {
            ...
            if (map != null) {
                for (Map.Entry<String, String> entry : map.entrySet()) {
                    if (entry.getKey().equals("Host")) {
                        jSONObjectPut10.put("headers_host", entry.getValue().replace(" ", ""));
                        break;
                    }
                }
            }
    ...
    public void onUpdateMetaData(String str) {
        ...
        try {
            ...
            if (jSONObject.has(bn.i)) {
                this.mPushClientModel = jSONObject.getString(bn.i);
            }
    ...
    public void onUpdateSeiInfo(String str) {
        ...
        try {
            ...
            if (jSONObject2.has(n.l)) {
                this.mLogBundle.seiSource = jSONObject2.getString(n.l);
    ...
    public void onRenderStall(long j, int i, boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            if (jSONObjectCreateCommonLog != null) {
                try {
                    jSONObjectCreateCommonLog.put("event_key", "render_stall").put("type", z ? "video" : MediaFormat.KEY_AUDIO).put("render_stall_time", j).put("video_buffer_time", this.mLogBundle.videoBufferTime).put("audio_buffer_time", this.mLogBundle.audioBufferTime);
                    this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                    long j2 = this.mLogTotalCount;
                    if (j2 > 0) {
                        this.mLogTotalCount = j2 + 1;
    ...
    public void onDemuxerStall(long j, int i, boolean z) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "demux_stall").put("type", z ? "video" : MediaFormat.KEY_AUDIO).put("demux_stall_time", j);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j2 = this.mLogTotalCount;
                if (j2 > 0) {
                    this.mLogTotalCount = j2 + 1;
    ...
    public void onDecoderStall(long j, int i, boolean z) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "decode_stall").put("type", z ? "video" : MediaFormat.KEY_AUDIO).put("decode_stall_time", j);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j2 = this.mLogTotalCount;
                if (j2 > 0) {
                    this.mLogTotalCount = j2 + 1;
    ...
    public void onRtcDecoderStall(long j, boolean z) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "rtc_decode_stall").put("type", z ? "video" : MediaFormat.KEY_AUDIO).put("decode_stall_time", j);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j2 = this.mLogTotalCount;
                if (j2 > 0) {
                    this.mLogTotalCount = j2 + 1;
    ...
    public void onPtsBack(long j, boolean z) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "pts_back").put("type", z ? "video" : MediaFormat.KEY_AUDIO).put("pts_back_diff", j);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
            } catch (JSONException e) {
                m.c(e);
            }
    ...
    public void onError(int i, String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "play_error").put(PluginConstants.KEY_ERROR_CODE, i).put("info", str);
                reportQuicOpenResult(jSONObjectCreateCommonLog);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
    ...
    public void onSDKDNSError(LiveError liveError) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                JSONObject jSONObjectPut = jSONObjectCreateCommonLog.put("event_key", "prepare_result").put("error_msg", liveError.getInfoJSON()).put(o.c, liveError.code);
    ...
    public void onAudioDTSRollback(long j, long j2) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "timestamp_rollback").put("packet_type", MediaFormat.KEY_AUDIO).put("timestamp_type", "dts").put("latest_ts", j2).put("previous_ts", j);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j3 = this.mLogTotalCount;
                if (j3 > 0) {
                    this.mLogTotalCount = j3 + 1;
    ...
    public void onPrepare(int i) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                ...
                JSONObject jSONObjectPut = jSONObjectCreateCommonLog.put("event_key", "prepare_result").put("error_msg", i != 0 ? this.mLiveEngine.getPlayerErrorInfo() : "none").put(o.c, i);
                String str2 = this.mSdkParams;
                if (str2 != null) {
                    str = str2;
                }
                JSONObject jSONObjectPut2 = jSONObjectPut.put("sdk_params", str).put("first_audio_packet_dts_rollback", z ? 1 : 0).put("first_audio_packet_dts", this.mFirstAudioPacketDTS).put("previous_audio_packet_dts", this.mPreviousAudioPacketDTS).put("stream_type", this.mLogBundle.mStreamType).put("suggest_format", this.mSuggestFormat).put("suggest_protocol", this.mSuggestProtocol);
                if (!this.mLiveEngine.getSRState() && !this.mLiveEngine.getSharpenState()) {
                    i2 = 0;
                }
                jSONObjectPut2.put("nnsr_enabled", i2);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j3 = this.mLogTotalCount;
                if (j3 > 0) {
                    this.mLogTotalCount = j3 + 1;
    ...
    private void onLink(boolean z) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "link").put("info", z ? "start" : PointCategory.END);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
                    this.mLogTotalCount = j + 1;
    ...
    private JSONObject _createSessionTimeSeries() {
        updateSessionSeries();
        try {
            JSONObject jSONObjectPut = new JSONObject().put("start_time", this.mLogBundle.startPlayTime).put(MediationConstant.EXTRA_DURATION, System.currentTimeMillis() - this.mLogBundle.startPlayTime).put("render_fps_series", new JSONArray((Collection) this.mRenderFpsTimeSeries)).put("download_bitrate_series", new JSONArray((Collection) this.mDownloadSpeedTimeSeries)).put("play_buffer_series", new JSONArray((Collection) this.mAudioBufferTimeSeries)).put("push_bitrate_series", this.mSeiBitrateTimeSeries == null ? new JSONArray() : new JSONArray((Collection) this.mSeiBitrateTimeSeries)).put("push_fps_series", this.mSeiFpsTimeSeries == null ? new JSONArray() : new JSONArray((Collection) this.mSeiFpsTimeSeries)).put("stall_series", this.mStallTimeSeries == null ? new JSONArray() : new JSONArray((Collection) this.mStallTimeSeries));
    ...
    public void onIllegalAPICall(String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "illegal_call").put(com.alipay.sdk.m.t.e.k, str);
                reportQuicOpenResult(jSONObjectCreateCommonLog);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
    ...
    public void onCallNotInMainThread(String str) {
        ...
        try {
            jSONObjectCreateCommonLog.put("event_key", "call_not_in_main_thread").put(com.alipay.sdk.m.t.e.k, str);
            this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
            long j = this.mLogTotalCount;
            if (j > 0) {
                this.mLogTotalCount = j + 1;

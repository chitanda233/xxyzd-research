...
public class i {
    ...
    public Map<String, Object> c(Map map) {
        if (map != null) {
            try {
                ...
                map2.put(com.alipay.sdk.m.c0.d.E, sDKInfo);
                return map2;
            } catch (Throwable th) {
                th.printStackTrace();
            }
    ...
    public int a() {
        return (this.f2489a || this.b == null) ? e() : d();
    }

    public Map<String, Object> a(Map map) {
        return (this.f2489a || this.b == null) ? b(map) : c(map);
    }
    ...
    public String b() {
        return (this.f2489a || this.b == null) ? c() : f();
    }
    ...
    public void b(MediationInitConfig mediationInitConfig) {
        ...
        Log.i("Tme", "gdt c:" + zIsCanUseLocation + " n:" + zA + " m:" + zA2 + " w:" + zA3 + " s&b:" + mediationInitConfig.isCanUseWifiState() + " h:" + zA5 + " a:" + mediationInitConfig.appList() + "  s:" + zA4 + " ic:" + this.f2489a + " soate:" + zA6);
    }

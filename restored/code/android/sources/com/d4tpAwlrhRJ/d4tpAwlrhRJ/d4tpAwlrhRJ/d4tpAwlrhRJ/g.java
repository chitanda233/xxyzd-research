...
public class g {
    ...
    private static Map<NativeExpressADView, b> f2474a = new HashMap();
    ...
    private final NativeExpressAD.NativeExpressADListener d = new NativeExpressAD.NativeExpressADListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.g.3
        ...
        public void onADClicked(NativeExpressADView nativeExpressADView) {
            b bVar;
            if (g.f2474a == null || (bVar = (b) g.f2474a.get(nativeExpressADView)) == null) {
                return;
            }
        ...
        public void onADClosed(NativeExpressADView nativeExpressADView) {
            if (g.f2474a != null) {
                b bVar = (b) g.f2474a.get(nativeExpressADView);
                if (bVar != null) {
                    bVar.a();
                }
                g.f2474a.remove(nativeExpressADView);
            }
        ...
        public void onADLoaded(List<NativeExpressADView> list) {
            if (list == null || list.size() == 0) {
                g.this.b.notifyAdFailed(80001, "list is empty");
                return;
            }
        ...
        public void onNoAD(AdError adError) {
            if (adError != null) {
                ...
                g.this.b.notifyAdFailed(80001, "adError is null");
            }
        }
    ...
    private void c(final Context context, final MediationAdSlotValueSet mediationAdSlotValueSet) {
        NativeUnifiedAD nativeUnifiedAD = new NativeUnifiedAD(context, mediationAdSlotValueSet.getADNId(), new NativeADUnifiedListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.g.2
            ...
            public void onADLoaded(List<NativeUnifiedADData> list) {
                if (list == null || list.size() <= 0) {
                    g.this.b.notifyAdFailed(80001, "请求成功，但无广告可用");
                    return;
                }
                ArrayList arrayList = new ArrayList();
            ...
            public void onNoAD(AdError adError) {
                if (adError != null) {
                    ...
                    g.this.b.notifyAdFailed(80001, "error is null");
                }
            }
        });

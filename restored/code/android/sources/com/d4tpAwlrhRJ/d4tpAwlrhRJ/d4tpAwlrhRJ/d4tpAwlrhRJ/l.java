...
public class l extends MediationBaseAdBridge {
    ...
    public l(MediationAdSlotValueSet mediationAdSlotValueSet, Function function, GdtRewardLoader gdtRewardLoader) {
        ...
        this.f2510a = new RewardVideoADListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.l.4
            ...
            public void onADLoad() {
                if (l.this.b == null) {
                    l.this.f.notifyAdFailed(80001, "load成功但广告为空");
                    return;
                }
            ...
            public void onError(AdError adError) {
                if (adError != null) {
                    ...
                    l.this.f.notifyAdFailed(80001, "error is null");
                }
            }
    ...
    public void c(Context context) {
        ...
        this.b = !TextUtils.isEmpty(this.f.getAdm()) ? new RewardVideoAD(context, this.f.getAdnId(), this.f2510a, z, this.f.getAdm()) : new RewardVideoAD(context, this.f.getAdnId(), this.f2510a, z);
    ...
    public String f() {
        ...
        try {
            RewardVideoAD rewardVideoAD = this.b;
            if (rewardVideoAD == null || (obj = rewardVideoAD.getExtraInfo().get(PointParamKey.REQUEST_ID)) == null) {
                return null;
            }
            return obj.toString();

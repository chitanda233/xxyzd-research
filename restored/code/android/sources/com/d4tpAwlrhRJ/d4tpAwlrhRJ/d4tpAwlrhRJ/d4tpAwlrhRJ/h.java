...
public class h extends MediationBaseAdBridge {
    ...
    UnifiedInterstitialADListener f2478a;
    ...
    public h(MediationAdSlotValueSet mediationAdSlotValueSet, Function function, GdtFullVideoLoader gdtFullVideoLoader) {
        ...
        this.d = "TMe";
        this.f2478a = new UnifiedInterstitialADListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.h.6
            ...
            public void onNoAD(AdError adError) {
                ...
                if (adError != null) {
                    ...
                    h.this.f.notifyAdFailed(80001, "暂无广告");
                }
            }
    ...
    public void b(Context context) {
        ...
        if (context instanceof Activity) {
            this.e = new UnifiedInterstitialAD((Activity) context, this.f.getAdnId(), this.f2478a);

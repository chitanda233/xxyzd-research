...
public class d extends MediationNativeAd {
    ...
    private NativeUnifiedADData f2424a;
    ...
    public d(Context context, MediationAdLoaderBaseFunction mediationAdLoaderBaseFunction, Function function, NativeUnifiedADData nativeUnifiedADData, FrameLayout.LayoutParams layoutParams, VideoOption videoOption, boolean z) {
        ...
        this.h = new NativeADMediaListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d.9
            ...
            public void onVideoError(AdError adError) {
                if (adError != null) {
                    ...
                    d.this.notifyOnVideoError(80004, "error is null");
                }
            }
        ...
        this.f = context;
        this.f2424a = nativeUnifiedADData;
        this.c = layoutParams;
        this.d = videoOption;
        this.e = z;
        b();
    ...
    public void a(Context context, ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, MediationViewBinder mediationViewBinder) {
        ...
        if (isServerBidding() && (nativeUnifiedADData = this.f2424a) != null) {
        ...
        if (this.f2424a != null) {
            ...
            this.f2424a.bindAdToView(context2, nativeAdContainer2, this.c, list, list4);
            MediaView mediaView = this.g;
            if (mediaView != null) {
                this.f2424a.bindMediaView(mediaView, h(), this.h);
            }
            this.f2424a.setNativeAdEventListener(new NativeADEventListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d.8
    ...
    private void a(Object obj) {
        ...
        if (this.e) {
            n.a(new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d.6
                ...
                public void run() {
                    d.this.f2424a.sendLossNotification(0, iA, null);
                }
            });
        } else {
            this.f2424a.sendLossNotification(0, iA, null);
        }
    }

    private void a(List<View> list) {
        NativeUnifiedADData nativeUnifiedADData;
        if (list == null || (nativeUnifiedADData = this.f2424a) == null || TextUtils.isEmpty(nativeUnifiedADData.getCTAText())) {
            return;
        }
        this.f2424a.bindCTAViews(list);
    }
    ...
    private void b() {
        ...
        NativeUnifiedADAppMiitInfo appMiitInfo = this.f2424a.getAppMiitInfo();
        if (appMiitInfo != null) {
        ...
        sparseArray.put(8045, this.f2424a.getTitle());
        sparseArray.put(8046, this.f2424a.getDesc());
        sparseArray.put(8061, this.f2424a.getCTAText());
        sparseArray.put(8048, this.f2424a.getIconUrl());
        sparseArray.put(8050, this.f2424a.getImgUrl());
        sparseArray.put(8052, Integer.valueOf(this.f2424a.getPictureWidth()));
        sparseArray.put(8051, Integer.valueOf(this.f2424a.getPictureHeight()));
        sparseArray.put(8053, this.f2424a.getImgList());
        sparseArray.put(8082, Double.valueOf(this.f2424a.getAppScore()));
        sparseArray.put(8049, this.f2424a.getTitle());
        sparseArray.put(8055, Boolean.valueOf(this.f2424a.isAppAd()));
        if (!isClientBidding()) {
            if (isMultiBidding()) {
                eCPMLevel = this.f2424a.getECPMLevel();
                i = 8058;
            }
            if (this.f2424a.getAdPatternType() != 2) {
                i2 = 5;
            } else {
                if (this.f2424a.getAdPatternType() == 4 && this.f2424a.getAdPatternType() != 1) {
                    if (this.f2424a.getAdPatternType() == 3) {
                        i2 = 4;
                    }
                    if (this.f2424a.isAppAd()) {
                        i3 = 4;
                    } else {
                        i3 = 3;
                    }
        ...
        eCPMLevel = Double.valueOf(Math.max(this.f2424a.getECPM(), 0.0d));
        i = 8016;
        sparseArray.put(i, eCPMLevel);
        if (this.f2424a.getAdPatternType() != 2) {
            if (this.f2424a.getAdPatternType() == 4) {
                i2 = 3;
            } else {
                i2 = 3;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public int d() {
        NativeUnifiedADData nativeUnifiedADData = this.f2424a;
        ...
        if (i == 8148) {
            if (this.e) {
                runnable = new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d.11
                    @Override // java.lang.Runnable
                    public void run() {
                        if (d.this.f2424a != null) {
                            d.this.f2424a.resume();
                        }
                    }
                };
                n.b(runnable);
            ...
            if (this.e) {
                runnable = new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d.12
                    ...
                    public void run() {
                        if (d.this.f2424a != null) {
                            d.this.f2424a.pauseVideo();
                        }
                    }
                };
                n.b(runnable);
            } else {
                NativeUnifiedADData nativeUnifiedADData2 = this.f2424a;
            ...
            if (i == 8191) {
                if (this.e) {
                    runnable = new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d.14
                        ...
                        public void run() {
                            if (d.this.f2424a != null) {
                                d.this.f2424a.pauseAppDownload();
                            }
                        }
                    };
                    n.b(runnable);
                } else {
                    NativeUnifiedADData nativeUnifiedADData3 = this.f2424a;
                ...
                if (this.e) {
                    runnable = new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d.2
                        ...
                        public void run() {
                            if (d.this.f2424a != null) {
                                d.this.f2424a.resumeAppDownload();
                            }
                        }
                    };
                    n.b(runnable);
                } else {
                    NativeUnifiedADData nativeUnifiedADData4 = this.f2424a;
                    ...
                    if (i == 8142) {
                        ...
                        if (this.e) {
                            runnable = new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d.4
                                ...
                                public void run() {
                                    if (d.this.f2424a != null) {
                                        d.this.f2424a.negativeFeedback();
                                    }
                                }
                            };
                            n.b(runnable);
                        } else {
                            NativeUnifiedADData nativeUnifiedADData6 = this.f2424a;
                        ...
                        if (i == 8268) {
                            NativeUnifiedADData nativeUnifiedADData7 = this.f2424a;

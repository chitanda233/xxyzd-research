...
public class k {
    ...
    private static Map<NativeExpressADView, e> f2506a = new HashMap();
    ...
    private final NativeExpressAD.NativeExpressADListener f = new NativeExpressAD.NativeExpressADListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.k.2
        ...
        public void onADClicked(NativeExpressADView nativeExpressADView) {
            e eVar;
            if (k.f2506a == null || (eVar = (e) k.f2506a.get(nativeExpressADView)) == null) {
                return;
            }
        ...
        public void onADClosed(NativeExpressADView nativeExpressADView) {
            if (k.f2506a != null) {
                e eVar = (e) k.f2506a.get(nativeExpressADView);
                if (eVar != null) {
                    eVar.a();
                }
                k.f2506a.remove(nativeExpressADView);
            }
        ...
        public void onADLoaded(List<NativeExpressADView> list) {
            if (list == null || list.size() == 0) {
                k.this.c.notifyAdFailed(80001, "list is empty");
                return;
            }
        ...
        public void onNoAD(AdError adError) {
            if (adError != null) {
                ...
                k.this.c.notifyAdFailed(80001, "adError is null");
            }
        }
    ...
    private final NativeADUnifiedListener g = new NativeADUnifiedListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.k.3
        ...
        public void onADLoaded(List<NativeUnifiedADData> list) {
            if (list == null || list.size() <= 0) {
                k.this.c.notifyAdFailed(80001, "请求成功，但无广告可用");
                return;
            }
            ArrayList arrayList = new ArrayList();
        ...
        public void onNoAD(AdError adError) {
            if (adError != null) {
                ...
                k.this.c.notifyAdFailed(80001, "请求失败");
            }
        }
    };

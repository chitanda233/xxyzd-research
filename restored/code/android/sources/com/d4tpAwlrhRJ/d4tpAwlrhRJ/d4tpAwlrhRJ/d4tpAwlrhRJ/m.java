...
public class m extends MediationBaseAdBridge {
    ...
    public m(MediationAdSlotValueSet mediationAdSlotValueSet, Function function, Context context, GdtSplashLoader gdtSplashLoader) {
        ...
        this.d = 2;
        this.f = null;
        this.f2518a = new SplashADListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.m.5
            ...
            public void onADLoaded(long j) {
                ...
                if (m.this.b == null || jElapsedRealtime <= 1000) {
                    m.this.c.notifyAdFailed(80001, "暂无广告");
                    return;
                }
    ...
    public void b(Context context, int i, boolean z) {
        if (context instanceof Activity) {
            ...
            SplashAD splashAD = new SplashAD(context, this.c.getAdnId(), this.f2518a, i);
            this.b = splashAD;
            if (z) {
                splashAD.preLoad();
            }
    ...
    public String i() {
        ...
        try {
            ...
            if (splashAD == null || (obj = splashAD.getExtraInfo().get(PointParamKey.REQUEST_ID)) == null) {
                return null;
            }
            return obj.toString();

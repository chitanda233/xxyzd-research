...
public class b extends MediationNativeAd {
    ...
    private NativeExpressADView f2402a;
    ...
    public b(g gVar, GdtDrawLoader gdtDrawLoader, Function<SparseArray<Object>, Object> function, NativeExpressADView nativeExpressADView, boolean z) {
        ...
        this.e = new NativeExpressMediaListener() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.b.1
            ...
            public void onVideoError(NativeExpressADView nativeExpressADView2, AdError adError) {
                ...
                if (adError != null) {
                    ...
                    bVar.notifyOnVideoError(80004, "aderror is null");
                }
            }
        ...
        this.f2402a = nativeExpressADView;
        this.c = gVar;
        this.d = z;
        b();
    }
    ...
    private void a(Object obj) {
        ...
        if (this.d) {
            n.a(new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.b.6
                ...
                public void run() {
                    b.this.f2402a.sendLossNotification(0, iA, null);
                }
            });
        } else {
            this.f2402a.sendLossNotification(0, iA, null);
        }
    }
    ...
    private void b() {
        ...
        AdData boundData = this.f2402a.getBoundData();
        ...
        this.f2402a.setMediaListener(this.e);
        i = 5;
    ...
    public String e() {
        Object obj;
        try {
            NativeExpressADView nativeExpressADView = this.f2402a;
        ...
        if (i == 6083) {
            if (this.d) {
                n.b(new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.b.3
                    @Override // java.lang.Runnable
                    public void run() {
                        if (b.this.f2402a != null) {
                            b.this.f2402a.render();
                        }
                    }
                });
            } else {
            ...
            if (i == 6081) {
                if (isServerBidding()) {
                    NativeExpressADView nativeExpressADView2 = this.f2402a;
                    nativeExpressADView2.setBidECPM(nativeExpressADView2.getECPM());
                }
                return (T) this.f2402a;
            }
            if (i == 8135) {
                return (T) true;
            }
            if (i == 8109) {
                ...
                try {
                    if (i == 8142) {
                        NativeExpressADView nativeExpressADView3 = this.f2402a;
                        if (nativeExpressADView3 != null) {
                            if (this.d) {
                                n.a(new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.b.5
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        b.this.f2402a.sendWinNotification((int) b.this.getCpm());
                                    }
                                });
                            } else {

...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    private String finderShareVideoJumpInfoToString(IWXChannelJumpInfo iWXChannelJumpInfo) {
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                jSONObject.put(BaseConstants.EVENT_LABEL_EXTRA, ((WXChannelBaseJumpInfo) iWXChannelJumpInfo).extra);
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        try {
            ...
            if (queryParameter.equals("subscribemessage")) {
                ...
                resp.openId = uri.getQueryParameter(Scopes.OPEN_ID);
            ...
            resp5.openId = uri.getQueryParameter(Scopes.OPEN_ID);
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0573a.f3817a = "com.tencent.mm";
        c0573a.action = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0573a.content = "weixin://registerapp?appid=" + this.appId;
        c0573a.b = j;
        return a.a(this.context, c0573a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0573a c0573a = new a.C0573a();
        c0573a.f3817a = "com.tencent.mm";
        c0573a.action = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0573a.content = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0573a);
    }
}

...
public final class ag {
    ...
    private final SimpleDateFormat f3731a;
    private final ad b;
    ...
    private ag() {
        this.f3731a = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS", Locale.US);
        this.b = new ad();
    }
    ...
    private static void e(List<b> list) {
        for (b bVar : list) {
            al.c("sla save id:%s time:%s msg:%s", bVar.f3734a, Long.valueOf(bVar.b), bVar.c);
            try {
                ContentValues contentValues = new ContentValues();
                contentValues.put("_id", bVar.f3734a);
    ...
    private static String a(String str, Iterable<b> iterable) {
        ...
        sb.append(it.next().f3734a).append("'");
        while (it.hasNext()) {
            sb.append(str);
            sb.append("'").append(it.next().f3734a).append("'");
        }
        return sb.toString();
    }
    ...
    public static List<b> a() {
        ...
        while (cursorA.moveToNext()) {
            try {
                b bVar = new b();
                bVar.f3734a = cursorA.getString(cursorA.getColumnIndex("_id"));
    ...
    public static class b {
        ...
        public final String toString() {
            return "SLAData{uuid='" + this.f3734a + "', time=" + this.b + ", data='" + this.c + "'}";
        }
    }
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final ag f3733a = new ag(0);
    }
    ...
    private b b(c cVar) {
        ...
        String str = "&app_version=" + aaVarB.o + "&app_name=" + aaVarB.q + "&app_bundle_id=" + aaVarB.c + "&client_type=android&user_id=" + aaVarB.f() + "&sdk_version=" + aaVarB.h + "&event_code=" + cVar.b + "&event_result=" + (cVar.d ? 1 : 0) + "&event_time=" + this.f3731a.format(new Date(cVar.c)) + "&event_cost=" + cVar.e + "&device_id=" + aaVarB.g() + "&debug=" + (aaVarB.D ? 1 : 0) + "&param_0=" + cVar.f + "&param_1=" + cVar.f3735a + "&param_2=" + (aaVarB.M ? "rqd" : com.sigmob.sdk.base.n.m) + "&param_4=" + aaVarB.e();
        if (!TextUtils.isEmpty(cVar.g)) {
            str = str + "&param_3=" + cVar.g;
        }
        al.c("sla convert eventId:%s eventType:%s, eventTime:%s success:%s cost:%s from:%s uploadMsg:", cVar.f3735a, cVar.b, Long.valueOf(cVar.c), Boolean.valueOf(cVar.d), Long.valueOf(cVar.e), cVar.f, cVar.g);
        String str2 = cVar.f3735a + "-" + cVar.b;
        b bVar = new b();
        bVar.f3734a = str2;
        bVar.b = cVar.c;
        bVar.c = str;

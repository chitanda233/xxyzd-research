...
class c {
    ...
    protected HashMap<String, HashMap<String, byte[]>> f3791a = new HashMap<>();
    ...
    public byte[] a() {
        l lVar = new l(0);
        lVar.a(this.c);
        lVar.a((Map) this.f3791a, 0);
        return n.a(lVar.f3797a);
    }
    ...
    public void a(byte[] bArr) {
        ...
        map2.put("", new byte[0]);
        map.put("", map2);
        this.f3791a = this.d.a((Map) map, 0, false);
    }
}

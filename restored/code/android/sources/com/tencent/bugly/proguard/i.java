...
public final class i {
    ...
    public final i a(boolean z, String str) {
        a(str);
        this.f3794a.append(z ? 'T' : 'F').append('\n');
        return this;
    }

    public final i a(byte b, String str) {
        a(str);
        this.f3794a.append((int) b).append('\n');
        return this;
    }

    private i a(char c, String str) {
        a(str);
        this.f3794a.append(c).append('\n');
        return this;
    }

    public final i a(short s, String str) {
        a(str);
        this.f3794a.append((int) s).append('\n');
        return this;
    }

    public final i a(int i, String str) {
        a(str);
        this.f3794a.append(i).append('\n');
        return this;
    }

    public final i a(long j, String str) {
        a(str);
        this.f3794a.append(j).append('\n');
        return this;
    }

    private i a(float f, String str) {
        a(str);
        this.f3794a.append(f).append('\n');
        return this;
    }

    private i a(double d, String str) {
        a(str);
        this.f3794a.append(d).append('\n');
        return this;
    }
    ...
    public final i a(byte[] bArr, String str) {
        ...
        if (bArr.length == 0) {
            this.f3794a.append(bArr.length).append(", []\n");
            return this;
        }
        this.f3794a.append(bArr.length).append(", [\n");
        i iVar = new i(this.f3794a, this.b + 1);
        for (byte b : bArr) {
    ...
    private i a(short[] sArr, String str) {
        ...
        if (sArr.length == 0) {
            this.f3794a.append(sArr.length).append(", []\n");
            return this;
        }
        this.f3794a.append(sArr.length).append(", [\n");
        i iVar = new i(this.f3794a, this.b + 1);
    ...
    private i a(int[] iArr, String str) {
        ...
        if (iArr.length == 0) {
            this.f3794a.append(iArr.length).append(", []\n");
            return this;
        }
        this.f3794a.append(iArr.length).append(", [\n");
        i iVar = new i(this.f3794a, this.b + 1);
    ...
    private i a(long[] jArr, String str) {
        ...
        if (jArr.length == 0) {
            this.f3794a.append(jArr.length).append(", []\n");
            return this;
        }
        this.f3794a.append(jArr.length).append(", [\n");
        i iVar = new i(this.f3794a, this.b + 1);
    ...
    private i a(float[] fArr, String str) {
        ...
        if (fArr.length == 0) {
            this.f3794a.append(fArr.length).append(", []\n");
            return this;
        }
        this.f3794a.append(fArr.length).append(", [\n");
        i iVar = new i(this.f3794a, this.b + 1);
    ...
    private i a(double[] dArr, String str) {
        ...
        if (dArr.length == 0) {
            this.f3794a.append(dArr.length).append(", []\n");
            return this;
        }
        this.f3794a.append(dArr.length).append(", [\n");
        i iVar = new i(this.f3794a, this.b + 1);
    ...
    public final <K, V> i a(Map<K, V> map, String str) {
        ...
        if (map.isEmpty()) {
            this.f3794a.append(map.size()).append(", {}\n");
            return this;
        }
        this.f3794a.append(map.size()).append(", {\n");
        i iVar = new i(this.f3794a, this.b + 1);
        i iVar2 = new i(this.f3794a, this.b + 2);
    ...
    private <T> i a(T[] tArr, String str) {
        ...
        if (tArr.length == 0) {
            this.f3794a.append(tArr.length).append(", []\n");
            return this;
        }
        this.f3794a.append(tArr.length).append(", [\n");
        i iVar = new i(this.f3794a, this.b + 1);
    ...
    public final i a(m mVar, String str) {
        a('{', str);
        if (mVar == null) {
            this.f3794a.append('\t').append("null");
        } else {
            mVar.a(this.f3794a, this.b + 1);
        }
        a('}', (String) null);
        return this;
    }

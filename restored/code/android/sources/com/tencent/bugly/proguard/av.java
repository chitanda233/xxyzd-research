...
public final class av implements Thread.UncaughtExceptionHandler {
    ...
    /* JADX WARN: Code duplicated, block: B:33:0x011b A[Catch: all -> 0x014c, TryCatch #0 {all -> 0x014c, blocks: (B:23:0x0108, B:28:0x0113, B:33:0x011b, B:35:0x012b, B:36:0x012d), top: B:41:0x0108 }] */
    /* JADX WARN: Code duplicated, block: B:35:0x012b A[Catch: all -> 0x014c, TryCatch #0 {all -> 0x014c, blocks: (B:23:0x0108, B:28:0x0113, B:33:0x011b, B:35:0x012b, B:36:0x012d), top: B:41:0x0108 }] */
    private CrashDetailBean b(Thread thread, Throwable th, boolean z, String str, byte[] bArr, boolean z2) {
        ...
        if (!z && aa.B() >= 31) {
            ...
            crashDetailBean.I = ab.b(this.f3764a);
        }
        ...
        crashDetailBean.Q = this.d.f3726a;

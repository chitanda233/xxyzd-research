...
public final class ay {
    ...
    public final AtomicBoolean f3766a = new AtomicBoolean(false);
    ...
    public ay(Context context, ac acVar, aa aaVar, ak akVar, as asVar) {
        ...
        this.g = contextA;
        this.b = (ActivityManager) contextA.getSystemService(TTDownloadField.TT_ACTIVITY);
    ...
    private CrashDetailBean a(ax axVar) {
        ...
        try {
            ...
            crashDetailBean.A = axVar.f3765a;
    ...
    private static String a(List<ba> list, long j) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ba baVar = list.get(i);
            sb.append("Thread name:").append(baVar.f3772a).append("\n");
            long j2 = baVar.b - j;
    ...
    public final boolean a(boolean z) {
        boolean zCompareAndSet = this.f3766a.compareAndSet(!z, z);
        ...
        try {
            ...
            if (TextUtils.isEmpty(str) || !new File(str).exists()) {
                ...
                if (str.startsWith("/data/anr/")) {
                    al.a("backup trace isOK:%s", Boolean.valueOf(a(str, file.getAbsolutePath(), axVar.f3765a)));
                } else {
                    al.a("trace file rename :%s", Boolean.valueOf(new File(str).renameTo(file)));
                }
                synchronized (this.j) {
                    bg bgVar = this.m;
                    listC = bgVar != null ? bgVar.f3778a.c() : null;
                }
                if (listC != null) {
            ...
            if (crashDetailBeanA.f3718a >= 0) {
                al.a("backup anr record success!", new Object[0]);
            } else {
                al.d("backup anr record fail!", new Object[0]);
            }
            as.a("ANR", ap.a(j), axVar.f3765a, "main", axVar.g, crashDetailBeanA);
        ...
        FileObserver fileObserver = new FileObserver(this.e) { // from class: com.tencent.bugly.proguard.ay.3
            ...
            public final void onEvent(int i2, String str) {
                ...
                if (ay.this.c.a()) {
                    ...
                    ay.this.a(am.a(str, "manual_bugly_trace_", ".txt"), ay.this.e + "/" + str);
    ...
    public final boolean a(long j) {
        if (Math.abs(j - this.o) < ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT) {

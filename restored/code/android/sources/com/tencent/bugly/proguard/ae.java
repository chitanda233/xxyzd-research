...
public final class ae {
    ...
    public static byte[] a(m mVar) {
        try {
            ...
            lVar.a("utf-8");
            mVar.a(lVar);
            byte[] bArr = new byte[lVar.f3797a.position()];
            System.arraycopy(lVar.f3797a.array(), 0, bArr, 0, lVar.f3797a.position());
            return bArr;
        } catch (Throwable th) {
            if (al.b(th)) {
                return null;

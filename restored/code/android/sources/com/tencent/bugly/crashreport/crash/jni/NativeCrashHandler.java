...
public class NativeCrashHandler implements q {
    ...
    private synchronized void a(boolean z) {
        ...
        if (this.j) {
            try {
                String strRegist = regist(f3723a, z, c);
                if (strRegist != null) {
            ...
            try {
                ...
                if (str == null) {
                    ...
                    aa.b();
                    str = (String) ap.a("com.tencent.feedback.eup.jni.NativeExceptionUpload", "registNativeExceptionHandler", clsArr2, new Object[]{f3723a, ab.d(), Integer.valueOf(aa.B())});
                }
                if (str != null) {
                    this.k = true;
                    this.e.u = str;
    ...
    public synchronized void startNativeMonitor() {
        if (!this.j && !this.i) {
            ...
            if (this.j || this.i) {
                ...
                setNativeLaunchTime(this.e.f3726a);
                return;
            }
            return;
        }
        ...
        this.f.a(new Runnable() { // from class: com.tencent.bugly.crashreport.crash.jni.NativeCrashHandler.1
            ...
            public final void run() {
                ...
                if (ap.a(NativeCrashHandler.this.d, "native_record_lock")) {
                    ...
                    CrashDetailBean crashDetailBeanA = be.a(NativeCrashHandler.this.d, NativeCrashHandler.f3723a, NativeCrashHandler.this.g);
    ...
    /* JADX WARN: Code duplicated, block: B:16:0x0031 A[Catch: all -> 0x0043, TRY_LEAVE, TryCatch #0 {, blocks: (B:5:0x0005, B:7:0x000b, B:8:0x001a, B:10:0x0026, B:14:0x002d, B:16:0x0031), top: B:22:0x0005 }] */

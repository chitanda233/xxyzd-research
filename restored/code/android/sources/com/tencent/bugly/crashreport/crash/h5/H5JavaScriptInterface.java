...
public class H5JavaScriptInterface {
    ...
    private static HashSet<Integer> f3722a = new HashSet<>();
    ...
    public static H5JavaScriptInterface getInstance(CrashReport.a aVar) {
        String string = null;
        if (aVar == null || f3722a.contains(Integer.valueOf(aVar.hashCode()))) {
            return null;
        }
        H5JavaScriptInterface h5JavaScriptInterface = new H5JavaScriptInterface();
        f3722a.add(Integer.valueOf(aVar.hashCode()));
    ...
    private static bb a(String str) {
        ...
        if (str != null && str.length() > 0) {
            try {
                ...
                bb bbVar = new bb();
                bbVar.f3773a = jSONObject.getString("projectRoot");
                if (bbVar.f3773a == null) {
                    return null;
                }
                ...
                bbVar.e = jSONObject.getString(MediaFormat.KEY_LANGUAGE);
                if (bbVar.e == null) {
                    return null;
                }
                bbVar.f = jSONObject.getString(c.e);
                ...
                bbVar.i = jSONObject.getString(n.z);
                if (bbVar.f == null) {
                    return null;
                }
                ...
                al.a("[projectRoot]: " + bbVar.f3773a, new Object[0]);
    ...
    public void reportJSException(String str) {
        ...
        if (bbVarA.f3773a != null) {
            linkedHashMap2.put("[JS] projectRoot", bbVarA.f3773a);
        }
        if (bbVarA.b != null) {

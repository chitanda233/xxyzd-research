...
public class j {
    ...
    private static final String f2124a = "j";
    private static j d;
    ...
    public String a(byte[] bArr) {
        if (this.b == null) {
            c.a(f2124a, "mServerPublicKey == null");
            return "";
        }
        try {
    ...
    private void b() throws Exception {
        try {
            this.b = KeyFactory.getInstance(com.alipay.sdk.m.p.d.f334a).generatePublic(new X509EncodedKeySpec(Base64.decode("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDNFGdEpQ1d8cPqekvvEDQyBGnI\nKwvjX9o3OmnnqWMGbIiFYIpc21QeG7aqizuWdXlgS5M9rstDfHQfG/AaPElJ7Yix\nBCau4hdVwFpRmb9NIuqavDeHKP9BKPZ01Ra5/666NGKBqmkRRer3lBCe6EKNUc2U\n/DZg6U/Q3CTPiORt/wIDAQAB", 0)));

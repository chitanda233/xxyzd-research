...
public class GenAuthnHelper extends c {
    ...
    public void loginPageInCallBack(String str) {
        GenLoginPageInListener genLoginPageInListener = this.h;
        if (genLoginPageInListener != null) {
            genLoginPageInListener.onLoginPageInComplete(str);
        }
    }
    ...
    public void getPhoneInfo(final String str, final String str2, final GenTokenListener genTokenListener, int i) {
        ...
        aVarA.a("methodChain", "100001");
        aVarA.a("methodCostTimePre", System.currentTimeMillis());
        b(aVarA);
        o.a(new o.a(this.b, aVarA) { // from class: com.cmic.gen.sdk.auth.GenAuthnHelper.1
    ...
    public void loginAuth(final String str, final String str2, final GenTokenListener genTokenListener, int i) {
        ...
        aVarA.a("methodChain", "100001");
        aVarA.a("methodCostTimePre", System.currentTimeMillis());
        aVarA.a("displayLogo", this.g.isDisplayLogo() ? "1" : "0");
        b(aVarA);
        o.a(new o.a(this.b, aVarA) { // from class: com.cmic.gen.sdk.auth.GenAuthnHelper.2
            @Override // com.cmic.gen.sdk.f.o.a
            protected void a() {
                if (GenAuthnHelper.this.a(aVarA, str, str2, "loginAuth", 3, genTokenListener)) {
                    String strA = i.a(GenAuthnHelper.this.b);
    ...
    public void mobileAuth(final String str, final String str2, final GenTokenListener genTokenListener, int i) {
        ...
        aVarA.a("methodCostTimePre", System.currentTimeMillis());
        b(aVarA);
        o.a(new o.a(this.b, aVarA) { // from class: com.cmic.gen.sdk.auth.GenAuthnHelper.3
            @Override // com.cmic.gen.sdk.f.o.a
            protected void a() {
    ...
    private void b(com.cmic.gen.sdk.a aVar) {
        try {
            ...
            aVar.a("pathOfCallingMethod", sb.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void a(com.cmic.gen.sdk.a aVar) {
        ...
        this.f2053a.a(aVar, new b() { // from class: com.cmic.gen.sdk.auth.GenAuthnHelper.4
            ...
            public void a(String str, String str2, com.cmic.gen.sdk.a aVar3, JSONObject jSONObject) {
                ...
                if ("103000".equals(str) && !f.a(aVar3.b("traceId"))) {

...
public class e {
    ...
    private static ArrayList<WeakReference<Activity>> f2164a;
    ...
    public static SpannableString a(final Context context, String str, final String str2, final String str3, final d dVar, final ArrayList<d> arrayList, final ArrayList<String> arrayList2) {
        int iIndexOf;
        com.cmic.gen.sdk.f.c.b("getClauseSpannableString", str);
        ...
        try {
            ...
            ClickableSpan clickableSpan2 = arrayList.size() >= 1 ? new ClickableSpan() { // from class: com.cmic.gen.sdk.view.e.2
                ...
                @Override // android.text.style.ClickableSpan
                public void onClick(View view) {
                    e.b(authThemeConfig, (String) arrayList2.get(0), authThemeConfig.getClauseUrl());
            ...
            ClickableSpan clickableSpan3 = arrayList.size() >= 2 ? new ClickableSpan() { // from class: com.cmic.gen.sdk.view.e.3
                ...
                @Override // android.text.style.ClickableSpan
                public void onClick(View view) {
                    e.b(authThemeConfig, (String) arrayList2.get(1), authThemeConfig.getClauseUrl2());
            ...
            ClickableSpan clickableSpan4 = arrayList.size() >= 3 ? new ClickableSpan() { // from class: com.cmic.gen.sdk.view.e.4
                ...
                @Override // android.text.style.ClickableSpan
                public void onClick(View view) {
                    e.b(authThemeConfig, (String) arrayList2.get(2), authThemeConfig.getClauseUrl3());
            ...
            ClickableSpan clickableSpan5 = arrayList.size() == 4 ? new ClickableSpan() { // from class: com.cmic.gen.sdk.view.e.5
                ...
                @Override // android.text.style.ClickableSpan
                public void onClick(View view) {
                    e.b(authThemeConfig, (String) arrayList2.get(3), authThemeConfig.getClauseUrl4());
            ...
            if (arrayList.size() >= 1) {
                ...
                spannableString.setSpan(clickableSpan2, iIndexOf, str4.length() + iIndexOf, 34);
            } else {
                iIndexOf = 0;
            }
            if (arrayList.size() >= 2) {
                ...
                spannableString.setSpan(clickableSpan3, iIndexOf, str5.length() + iIndexOf, 34);
            }
            if (arrayList.size() >= 3) {
                int length2 = arrayList2.get(1).length() + iIndexOf;
                String str6 = arrayList2.get(2);
                int iIndexOf3 = str.indexOf(str6, length2);
                spannableString.setSpan(clickableSpan4, iIndexOf3, str6.length() + iIndexOf3, 34);
            }
            if (arrayList.size() == 4) {

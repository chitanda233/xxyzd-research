...
public class d {
    ...
    private com.cmic.gen.sdk.a f2095a;
    ...
    private static void a(b bVar, com.cmic.gen.sdk.a aVar) {
        ...
        bVar.o(n.b());
        bVar.p(n.c());
        bVar.v(String.valueOf(aVar.b("networktype", 0)));
        ...
        bVar.w(l.b("AID", ""));
        bVar.x(aVar.b("operatortype"));
        bVar.z(aVar.b("scripType"));
        bVar.A(aVar.b("networkTypeByAPI"));
        com.cmic.gen.sdk.f.c.a("SendLog", "traceId" + aVar.b("traceId"));
    }
    ...
    public void a(Context context, String str, com.cmic.gen.sdk.a aVar) {
        ...
        try {
            ...
            bVarA.j(str2);
            a(bVarA, aVar);
            if (bVarA.f2094a.size() > 0) {
                jSONArray = new JSONArray();
                for (Throwable th : bVarA.f2094a) {
            ...
            com.cmic.gen.sdk.f.c.a("SendLog", "登录日志");
            a(bVarA.b(), aVar);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void a(JSONObject jSONObject) {
        com.cmic.gen.sdk.c.c.a.a().a(jSONObject, this.f2095a, new com.cmic.gen.sdk.c.c.d() { // from class: com.cmic.gen.sdk.d.d.1
            @Override // com.cmic.gen.sdk.c.c.d
            public void a(String str, String str2, JSONObject jSONObject2) {
                com.cmic.gen.sdk.a.a aVarB = d.this.f2095a.b();
                HashMap map = new HashMap();
                if (!str.equals("103000")) {
                    if (aVarB.m() != 0 && aVarB.l() != 0) {
                        int iA = l.a("logFailTimes", 0) + 1;
                        if (iA >= aVarB.l()) {

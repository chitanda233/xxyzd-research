...
final class U extends Dialog implements View.OnClickListener {
    ...
    public final void a(S s, boolean z, boolean z2) {
        ...
        this.e = D.a(this, 1000000, new T(this));
    }
    ...
    public final void a(boolean z) {
        ...
        if (z) {
            ...
            RelativeLayout.LayoutParams layoutParams2 = (RelativeLayout.LayoutParams) p.f4005a.getLayoutParams();
            layoutParams2.height = 1;
            p.f4005a.setLayoutParams(layoutParams2);
            Rect rect = p.e;
            ...
            RelativeLayout.LayoutParams layoutParams4 = (RelativeLayout.LayoutParams) p.f4005a.getLayoutParams();
            layoutParams4.height = -2;
            p.f4005a.setLayoutParams(layoutParams4);
        }
        p.invalidate();
        p.requestLayout();
    }
    ...
    protected P createSoftInputView(EditText editText) {
        P p = new P(this.f4016a, editText);
        p.f4005a.setOnClickListener(this);
        setContentView(p);
        return p;
    }
    ...
    public final void onBackPressed() {
        ...
        C c = this.e;
        if (c != null) {
            com.unity3d.player.a.c cVar = c.f3979a;
            if (!(cVar != null) || (runnable = ((B) cVar).f3977a) == null) {
                return;
            }
            runnable.run();
        }

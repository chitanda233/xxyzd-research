...
public class UnityPlayer extends FrameLayout implements IUnityPlayerLifecycleEvents {
    ...
    public UnityPlayer(Context context, IUnityPlayerLifecycleEvents iUnityPlayerLifecycleEvents) {
        ...
        C0714g0.a(getUnityNativeLibraryPath(context));
        ...
        if (!W0.d()) {
            AbstractC0751z.Log(6, "Your hardware does not support this application.");
            AlertDialog alertDialogCreate = new AlertDialog.Builder(this.mContext).setTitle("Failure to initialize!").setPositiveButton(cb.k, new DialogInterfaceOnClickListenerC0746w0(this)).setMessage("Your hardware does not support this application.\n\n" + strLoadNative + "\n\n Press OK to quit.").create();
        ...
        initJni(context);
        this.mState.d(true);
        C0718i0 c0718i0 = new C0718i0(context, this);
        this.mGlView = c0718i0;
        addView(c0718i0);
    ...
    private void EarlyEnableFullScreenIfEnabled() {
        ...
        AbstractC0747x.a(this.mActivity);
    }
    ...
    public static void UnitySendMessage(String str, String str2, String str3) {
        if (!W0.d()) {
            AbstractC0751z.Log(5, "Native libraries not loaded - dropping message for " + str + TRouterMap.DOT + str2);
        } else {
            try {
    ...
    private void checkResumePlayer() {
        ...
        if (this.mState.a(activity != null ? MultiWindowSupport.isInMultiWindowMode(activity) : false)) {
            this.mState.c(true);
            queueGLThreadEvent(new RunnableC0722k0(this));
    ...
    private void hidePreservedContent() {
        runOnUiThread(new RunnableC0728n0(this));
    }
    ...
    private static String loadNative(String str) {
        ...
        AbstractC0751z.Log(6, "NativeLoader.load failure, Unity libraries were not loaded.");
    ...
    private void pauseUnity() {
        ...
        if (W0.d()) {
            ...
            if (u0.f4017a != null) {
                u0.a(S0.f4013a);
                Message.obtain(u0.f4017a, o0).sendToTarget();
            }
            try {
                ...
                if (!semaphore.tryAcquire(synchronizationTimeout.getTimeout(), TimeUnit.MILLISECONDS)) {
                    AbstractC0751z.Log(5, "Timeout (" + synchronizationTimeout.getTimeout() + " ms) while trying to pause the Unity Engine.");
                }
            } catch (InterruptedException unused) {
                AbstractC0751z.Log(5, "UI thread got interrupted while trying to pause the Unity Engine.");
            }
        }
        this.mState.c(false);
        this.mState.e(true);
    ...
    private static void preloadJavaPlugins() {
        try {
            ...
            AbstractC0751z.Log(6, "Java class preloading failed: " + e.getMessage());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void queueDestroy() {
        AbstractC0751z.Log(4, "Queue Destroy");
    ...
    private void raiseFocusListener(boolean z) {
        ...
        if (e != null) {
            RunnableC0734q0 runnableC0734q0 = ((C0730o0) e).f4060a;
            runnableC0734q0.b = true;
            if (runnableC0734q0.f4063a) {
    ...
    private boolean updateDisplayInternal(int i, Surface surface) {
        ...
        if (i == 0) {
            U0 u0 = this.m_MainThread;
            Handler handler = u0.f4017a;
            if (surface == null) {
                if (handler != null) {
                    u0.a(S0.d);
                    Message.obtain(u0.f4017a, l0).sendToTarget();
                }
        ...
        try {
            ...
            AbstractC0751z.Log(5, "Timeout (" + synchronizationTimeout.getTimeout() + " ms) while trying detaching primary window.");
            return true;
        } catch (InterruptedException unused) {
            AbstractC0751z.Log(5, "UI thread got interrupted while trying to detach the primary window from the Unity Engine.");
            return true;
        }
    }
    ...
    public boolean addViewToPlayer(View view, boolean z) {
        ...
        if (!z2) {
            if (!z3) {
                AbstractC0751z.Log(6, "addViewToPlayer: Failure adding view to hierarchy");
            }
            if (!z4 && !z5) {
                AbstractC0751z.Log(6, "addViewToPlayer: Failure removing old view from hierarchy");
            }
        }
        return z2;
    }
    ...
    protected void hideSoftInput() {
        ...
        Semaphore semaphore = new Semaphore(0);
        postOnUiThread(new RunnableC0734q0(this, semaphore, this));
        try {
            try {
                if (!semaphore.tryAcquire(getSoftInputTimeout(), TimeUnit.MILLISECONDS)) {
                    AbstractC0751z.Log(6, "Timeout (" + getSoftInputTimeout() + " ms) while waiting softinput hiding operation.");
                }
            } catch (InterruptedException unused) {
                AbstractC0751z.Log(6, "UI thread got interrupted while waiting softinput hiding operation.");
            }
        } finally {
            this.mSoftInput = null;
        }
    ...
    public void lowMemory() {
        if (W0.d()) {
            queueGLThreadEvent(new RunnableC0720j0(this));
        }
    }
    ...
    public void removeViewFromPlayer(View view) {
        ...
        if (!z) {
            AbstractC0751z.Log(6, "removeViewFromPlayer: Failure removing view from hierarchy");
        }
        if (z2) {
            return;
        }
        AbstractC0751z.Log(6, "removeVireFromPlayer: Failure agging old view to hierarchy");
    }

    public void reportError(String str, String str2) {
        AbstractC0751z.Log(6, str + ": " + str2);
    }

    protected void reportSoftInputArea(Rect rect) {
        queueGLThreadEvent((V0) new C0750y0(this, rect));
    }

    protected void reportSoftInputIsVisible(boolean z) {
        queueGLThreadEvent((V0) new C0752z0(this, z));
    }

    protected void reportSoftInputSelection(int i, int i2) {
        queueGLThreadEvent((V0) new C0748x0(this, i, i2));
    }
    ...
    protected void reportSoftInputStr(String str, int i, boolean z) {
        ...
        queueGLThreadEvent((V0) new C0744v0(this, z, str, i));
    }
    ...
    void sendSurfaceChangedEvent() {
        if (W0.d() && this.mState.a()) {
            K0 k0 = new K0(this);
            Handler handler = this.m_MainThread.f4017a;
            if (handler != null) {
    ...
    protected void setCharacterLimit(int i) {
        runOnUiThread(new RunnableC0738s0(this, i));
    }
    ...
    protected void setHideInputField(boolean z) {
        runOnUiThread(new RunnableC0740t0(this, z));
    }
    ...
    public void setScreenBrightness(float f) {
        ...
        runOnUiThread(new F0(this, fMax));
    }

    protected void setSelection(int i, int i2) {
        runOnUiThread(new RunnableC0742u0(this, i, i2));
    }

    protected void setSoftInputStr(String str) {
        runOnUiThread(new RunnableC0736r0(this, str));
    }
    ...
    protected void showSoftInput(String str, int i, boolean z, boolean z2, boolean z3, boolean z4, String str2, int i2, boolean z5, boolean z6) {
        Semaphore semaphore = new Semaphore(0);
        postOnUiThread(new RunnableC0726m0(this, this, str, i, z, z2, z3, z4, str2, i2, z5, z6, semaphore));
        try {
            if (semaphore.tryAcquire(getSoftInputTimeout(), TimeUnit.MILLISECONDS)) {
                return;
            }
            AbstractC0751z.Log(6, "Timeout (" + getSoftInputTimeout() + " ms) while waiting softinput showing operation.");
        } catch (InterruptedException unused) {
            AbstractC0751z.Log(6, "UI thread got interrupted while waiting softinput showing operation.");
        }
    }
    ...
    protected boolean showVideoPlayer(String str, int i, int i2, int i3, boolean z, int i4, int i5) {
        ...
        boolean zA = this.mVideoPlayerProxy.a(this.mContext, str, i, i2, i3, z, i4, i5, new A0(this));
        if (zA) {
    ...
    public boolean stopOrientationListener() {
        ...
        if (orientationEventListener == null) {
            AbstractC0751z.Log(5, "Orientation Listener was not started.");
            return false;
        }

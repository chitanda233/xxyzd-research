...
abstract class S implements TextWatcher {
    ...
    public final String a() {
        InputMethodSubtype currentInputMethodSubtype = ((InputMethodManager) this.f4012a.getSystemService("input_method")).getCurrentInputMethodSubtype();
        if (currentInputMethodSubtype == null) {
            return null;
        }
        String strA = AbstractC0749y.a(currentInputMethodSubtype);
    ...
    public final void f() {
        ((InputMethodManager) this.f4012a.getSystemService("input_method")).showSoftInput(this.c, 0);
    }

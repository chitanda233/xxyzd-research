...
abstract class AbstractC0705c {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static final int[] f4032a = {android.R.attr.progressBarStyleLarge, android.R.attr.progressBarStyleLargeInverse, android.R.attr.progressBarStyleSmall, android.R.attr.progressBarStyleSmallInverse};
    ...
    public static void a(Activity activity, UnityPlayer unityPlayer, int i) {
        if (i >= 0) {
            ...
            view.setOnKeyListener(new ViewOnKeyListenerC0703b());
            c = view;

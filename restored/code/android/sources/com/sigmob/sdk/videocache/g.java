...
class g extends o {
    ...
    private static final float f3667a = 0.2f;
    private final t b;
    private final com.sigmob.sdk.videocache.file.b c;
    private d d;

    public g(t source, com.sigmob.sdk.videocache.file.b cache) {
        super(source, cache);
        this.c = cache;
        this.b = source;
    }
    ...
    private void a(OutputStream out, long offset) throws p, IOException {
    ...
    private boolean a(f request) throws p {
        long jA = this.b.a();
        return (((jA > 0L ? 1 : (jA == 0L ? 0 : -1)) > 0) && request.c && ((float) request.b) > ((float) this.c.a()) + (((float) jA) * f3667a)) ? false : true;
    }

    private String b(f request) throws p, IOException {
    ...
    private void b(OutputStream out, long offset) throws p, IOException {
        t tVarA = s.a(this.b);
        try {
            tVarA.a((int) offset);
            byte[] bArr = new byte[8192];
    ...
    protected void a(int percents) {
        d dVar = this.d;
        if (dVar != null) {
            dVar.a(this.c.f3661a, this.b.g(), percents);
        }
    }

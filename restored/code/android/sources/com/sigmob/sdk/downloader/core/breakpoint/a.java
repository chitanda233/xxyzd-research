...
public class a {
    ...
    public a g() {
        return new a(this.f3379a, this.b, this.c.get());
    }

    public String toString() {
        return "[" + this.f3379a + ", " + e() + ")-current:" + this.c;
    }
}

...
public class d {
    ...
    public d(Cursor cursor) {
        ...
        boolean z = false;
        this.f3382a = columnIndex >= 0 ? cursor.getInt(columnIndex) : 0;
        int columnIndex2 = cursor.getColumnIndex("url");
        this.b = columnIndex2 >= 0 ? cursor.getString(columnIndex2) : "";
        int columnIndex3 = cursor.getColumnIndex(f.c);
        ...
        int columnIndex5 = cursor.getColumnIndex(f.e);
    ...
    public c h() {
        c cVar = new c(this.f3382a, this.b, new File(this.d), this.e, this.f);
        cVar.a(this.c);
        cVar.a(this.g);
        return cVar;
    }

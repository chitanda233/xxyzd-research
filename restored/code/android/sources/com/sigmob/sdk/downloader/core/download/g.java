...
public class g {
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private volatile String f3427a;
        ...
        public boolean equals(Object obj) {
            ...
            if (this.f3427a == null) {
                return ((a) obj).f3427a == null;
            }
            return this.f3427a.equals(((a) obj).f3427a);
        }
    ...
    public static class b {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private com.sigmob.sdk.downloader.core.connection.a.InterfaceC0560a f3428a;
        private com.sigmob.sdk.downloader.core.breakpoint.c b;
        private int c;

        protected b(com.sigmob.sdk.downloader.core.connection.a.InterfaceC0560a connected, int blockIndex, com.sigmob.sdk.downloader.core.breakpoint.c info) {
            this.f3428a = connected;
            this.b = info;
            this.c = blockIndex;
        }
        ...
        public void a() throws IOException {
            ...
            int iD = this.f3428a.d();
            com.sigmob.sdk.downloader.core.cause.b bVarA = com.sigmob.sdk.downloader.g.j().g().a(iD, aVarB.a() != 0, this.b, this.f3428a.c(com.sigmob.sdk.downloader.core.c.g));
            if (bVarA != null) {
    ...
    public b a(com.sigmob.sdk.downloader.core.connection.a.InterfaceC0560a connected, int blockIndex, com.sigmob.sdk.downloader.core.breakpoint.c info) {
    ...
    public void a(com.sigmob.sdk.downloader.f task, j store) {
        ...
        com.sigmob.sdk.downloader.f.c.a(task, cVarE);
    }
    ...
    public void b() throws UnknownHostException {
        if (this.f3426a == null) {
            this.f3426a = Boolean.valueOf(com.sigmob.sdk.downloader.core.c.c(com.kuaishou.weapon.p0.g.b));
        }
        if (this.f3426a.booleanValue()) {
            if (this.h == null) {

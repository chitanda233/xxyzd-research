...
public class h implements j {
    ...
    public h(SparseArray<c> storedInfos, List<Integer> fileDirtyList, HashMap<String, String> responseFilenameMap) {
        ...
        for (int i = 0; i < size; i++) {
            this.f.add(Integer.valueOf(storedInfos.valueAt(i).f3381a));
        }
    ...
    public boolean a(c breakpointInfo) {
        ...
        c cVar = this.b.get(breakpointInfo.f3381a);
        if (cVar == null) {
            return false;
        }
        ...
        synchronized (this) {
            this.b.put(breakpointInfo.f3381a, breakpointInfo.p());
        }
        return true;
    }

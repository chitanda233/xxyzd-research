...
public class b {
    ...
    com.sigmob.sdk.downloader.core.cause.b f3421a;
    private boolean b;
    private boolean c;
    private long d;
    ...
    public com.sigmob.sdk.downloader.core.cause.b b() {
        com.sigmob.sdk.downloader.core.cause.b bVar = this.f3421a;
        if (bVar != null) {
            return bVar;
        }
    ...
    public void f() throws IOException {
        ...
        if (com.sigmob.sdk.downloader.g.j().a().g(this.e)) {
            throw com.sigmob.sdk.downloader.core.exception.b.f3429a;
        }
    ...
    public String toString() {
        return "acceptRange[" + this.b + "] resumable[" + this.c + "] failedCause[" + this.f3421a + "] instanceLength[" + this.d + "] " + super.toString();
    }
}

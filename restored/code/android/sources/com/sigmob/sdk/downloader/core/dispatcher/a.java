...
public class a {
    ...
    private static final String f3403a = "CallbackDispatcher";
    private final c b;
    private final Handler c;

    /* JADX INFO: renamed from: com.sigmob.sdk.downloader.core.dispatcher.a$a, reason: collision with other inner class name */
    static class C0562a implements c {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final Handler f3407a;

        C0562a(Handler uiHandler) {
            this.f3407a = uiHandler;
        }
        ...
        public void a(final f task, final int blockIndex, final int responseCode, final Map<String, List<String>> requestHeaderFields) {
            com.sigmob.sdk.downloader.core.c.b(a.f3403a, "<----- finish connection task(" + task.c() + ") block(" + blockIndex + ") code[" + responseCode + "]" + requestHeaderFields);
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.9
        ...
        public void a(final f task, final int blockIndex, final long contentLength) {
            com.sigmob.sdk.downloader.core.c.b(a.f3403a, "fetchStart: " + task.c());
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.10
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
        ...
        public void a(final f task, final int responseCode, final Map<String, List<String>> headerFields) {
            com.sigmob.sdk.downloader.core.c.b(a.f3403a, "<----- finish trial task(" + task.c() + ") code[" + responseCode + "]" + headerFields);
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.5
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
        ...
        public void a(final f task, final com.sigmob.sdk.downloader.core.breakpoint.c info) {
            com.sigmob.sdk.downloader.core.c.b(a.f3403a, "downloadFromBreakpoint: " + task.c());
            b(task, info);
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.7
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
        ...
        public void a(final f task, final com.sigmob.sdk.downloader.core.breakpoint.c info, final com.sigmob.sdk.downloader.core.cause.b cause) {
            com.sigmob.sdk.downloader.core.c.b(a.f3403a, "downloadFromBeginning: " + task.c());
            b(task, info, cause);
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.6
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
        ...
        public void a(final f task, final com.sigmob.sdk.downloader.core.cause.a cause, final Exception realCause) {
            if (cause == com.sigmob.sdk.downloader.core.cause.a.ERROR) {
                com.sigmob.sdk.downloader.core.c.b(a.f3403a, "taskEnd: " + task.c() + " " + cause + " " + realCause);
            }
            b(task, cause, realCause);
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.3
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
        ...
        public void a(final f task, final Map<String, List<String>> headerFields) {
            com.sigmob.sdk.downloader.core.c.b(a.f3403a, "-----> start trial task(" + task.c() + ") " + headerFields);
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.4
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
        ...
        public void a_(final f task) {
            com.sigmob.sdk.downloader.core.c.b(a.f3403a, "taskStart: " + task.c());
            b(task);
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.1
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
        ...
        public void b(final f task, final int blockIndex, final long increaseBytes) {
            ...
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.11
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
        ...
        public void b(final f task, final int blockIndex, final Map<String, List<String>> requestHeaderFields) {
            com.sigmob.sdk.downloader.core.c.b(a.f3403a, "-----> start connection task(" + task.c() + ") block(" + blockIndex + ") " + requestHeaderFields);
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.8
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
        ...
        public void c(final f task, final int blockIndex, final long contentLength) {
            com.sigmob.sdk.downloader.core.c.b(a.f3403a, "fetchEnd: " + task.c());
            if (task.s()) {
                this.f3407a.post(new Runnable() { // from class: com.sigmob.sdk.downloader.core.dispatcher.a.a.2
                    @Override // java.lang.Runnable
                    public void run() {
                        c cVarF = task.F();
                        if (cVarF != null) {
    ...
    public void a(final Collection<f> canceledCollection) {
        ...
        com.sigmob.sdk.downloader.core.c.b(f3403a, "endTasksWithCanceled canceled[" + canceledCollection.size() + "]");
    ...
    public void a(final Collection<f> errorCollection, final Exception realCause) {
        ...
        com.sigmob.sdk.downloader.core.c.b(f3403a, "endTasksWithError error[" + errorCollection.size() + "] realCause: " + realCause);
    ...
    public void a(final Collection<f> completedTaskCollection, final Collection<f> sameTaskConflictCollection, final Collection<f> fileBusyCollection) {
        ...
        com.sigmob.sdk.downloader.core.c.b(f3403a, "endTasks completed[" + completedTaskCollection.size() + "] sameTask[" + sameTaskConflictCollection.size() + "] fileBusy[" + fileBusyCollection.size() + "]");

...
public class q {
    ...
    public q(Context context, float density) {
        this.f3507a = context.getApplicationContext();
        this.j = density;
    }

    private void a(Rect sourceRect, Rect outRect) {
        outRect.set(Dips.pixelsToIntDips(sourceRect.left, this.f3507a), Dips.pixelsToIntDips(sourceRect.top, this.f3507a), Dips.pixelsToIntDips(sourceRect.right, this.f3507a), Dips.pixelsToIntDips(sourceRect.bottom, this.f3507a));
    }

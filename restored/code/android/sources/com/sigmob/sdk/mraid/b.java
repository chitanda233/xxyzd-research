...
public class b extends FrameLayout {
    ...
    static final float f3479a = 30.0f;
    static final float b = 50.0f;
    static final float c = 8.0f;
    private final int d;
    private InterfaceC0566b e;
    ...
    public b(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.i = Dips.asIntPixels(f3479a, context);
        this.j = Dips.asIntPixels(8.0f, context);
        setWillNotDraw(false);
        this.p = true;
    }

    private void a(a closePosition, final int size, Rect bounds, Rect outBounds) {
        Gravity.apply(closePosition.a(), size, size, bounds, outBounds);
    }

    private void b(a closePosition, Rect bounds, Rect outBounds) {
        a(closePosition, this.i, bounds, outBounds);
    }

    private void c() {
        playSoundEffect(0);
        InterfaceC0566b interfaceC0566b = this.e;
    ...
    public void a(a closePosition, Rect bounds, Rect closeBounds) {
    ...
    public void setClosePosition(a closePosition) {
    ...
    public void setOnCloseListener(InterfaceC0566b onCloseListener) {

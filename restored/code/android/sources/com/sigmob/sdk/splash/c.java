...
public class c extends b {
    ...
    public /* synthetic */ Bitmap c(Bitmap bitmap) {
        if (!this.e) {
            ...
            if (height > 0 && width > 0) {
                if ((((double) width) * 1.0d) / ((double) height) < this.d) {
        ...
        if (this.b == null) {
            ...
            if (splashFilePath != null) {
                ...
                if (fileType.equals("gif")) {
                    ...
                    this.b.setOnFrameAvailable(new com.sigmob.sdk.base.views.gif.e.c() { // from class: com.sigmob.sdk.splash.c$$ExternalSyntheticLambda0

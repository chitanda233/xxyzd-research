...
public class n {
    ...
    private static final String f3543a = "mraid_storage";

    public static String a(Context context, String key) {
        SharedPreferences sharedPreferences;
        if (context == null || (sharedPreferences = context.getSharedPreferences(f3543a, 0)) == null) {
            return null;
        }
    ...
    public static Map<String, ?> a(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(f3543a, 0);

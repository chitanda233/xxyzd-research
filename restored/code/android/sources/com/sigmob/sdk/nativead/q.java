...
public class q extends ViewGroup {
    ...
    class a implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (q.this.l) {
                b bVar = (b) v;
                b selectedItem = q.this.getSelectedItem();
                int i = 0;
                if (q.this.t) {
                    bVar.a(!bVar.b);
                    ...
                    bVar.a(true);
                    selectedIndex = q.this.getSelectedIndex();
                }
                if (q.this.w != null) {
                    q.this.w.onItemClick(selectedIndex, bVar.getText().toString());
                }
            }
        }
    }
    ...
    class b extends TextView {
        ...
        public b(Context context, CharSequence text) {
            ...
            setPadding(q.this.r, q.this.s, q.this.r, q.this.s);
            setLayoutParams(new c(q.this.y, -2));
            setGravity(17);
            setTextSize(0, q.this.o);
            setSingleLine(true);
        ...
        private void a() {
            ...
            q.this.u = false;
            if (this.b) {
                this.c.setColor(q.this.n);
                i = q.this.m;
            } else {
                this.c.setColor(q.this.k);
                i = q.this.j;
            }
            setTextColor(i);
        }
        ...
        private void b() {
            int i = this.b ? q.this.n : q.this.k;
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setCornerRadii(q.this.v);
    ...
    public q(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.f3582a = -16777216;

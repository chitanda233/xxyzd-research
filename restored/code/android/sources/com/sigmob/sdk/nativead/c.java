...
public class c extends Dialog {
    ...
    public c(Context context, String textToShow) {
        super(context, com.sigmob.sdk.base.k.e());
        this.f3574a = textToShow;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCancelable(true);
        findViewById(R.id.dialog_root).setOnClickListener(new View.OnClickListener() { // from class: com.sigmob.sdk.nativead.c$$ExternalSyntheticLambda0
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.sigmob.sdk.nativead.c$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.a(view);
            }
        });
        textView.setText(this.f3574a);

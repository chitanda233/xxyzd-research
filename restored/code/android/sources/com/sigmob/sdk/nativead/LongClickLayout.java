...
public class LongClickLayout extends LinearLayout {
    ...
    private void a(final Context context) {
        this.f3560a = new Runnable() { // from class: com.sigmob.sdk.nativead.LongClickLayout$$ExternalSyntheticLambda0
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (ev.getAction() == 0) {
            this.b = false;
            postDelayed(this.f3560a, 2000);
        } else if (ev.getAction() == 1 || ev.getAction() == 3) {
            removeCallbacks(this.f3560a);
            if (this.b) {
                return true;
            }
        }

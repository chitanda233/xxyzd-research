...
public class f extends RelativeLayout implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, h {
    ...
    public static final String f3691a = "VideoPlayerView";
    ...
    private com.sigmob.sdk.nativead.l ak;
    private boolean al;
    ...
    /* JADX INFO: renamed from: com.sigmob.sdk.videoplayer.f$2, reason: invalid class name */
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f3693a[e.RETRY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3693a[e.VOLUME.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3693a[e.FULLSCREEN.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3693a[e.BIGRETRY.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3693a[e.BACK.ordinal()] = 6;
    ...
    private class c extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            int streamVolume;
            if (!f.V.equals(intent.getAction()) || intent.getIntExtra(f.W, -1) != 3 || this.f3695a == null || (streamVolume = ((AudioManager) f.this.getApplicationContext().getSystemService(MediaFormat.KEY_AUDIO)).getStreamVolume(3)) < 0) {
                return;
            }
            this.f3695a.onVolumeChanged(streamVolume);
        }
    }
    ...
    public f(Context context) {
        ...
        this.U = new AudioManager.OnAudioFocusChangeListener() { // from class: com.sigmob.sdk.videoplayer.f.1
            ...
            public void onAudioFocusChange(int focusChange) {
                ...
                SigmobLog.i(sb.append(hashCode()).append("]").toString());
            }
        };
        this.al = true;
        this.ar = false;
    ...
    public void C() {
        ...
        if (i2 == 5) {
            com.sigmob.sdk.nativead.l lVar = this.ak;
            if (lVar != null) {
                lVar.onVideoResume();
            }
            this.v.f();
        ...
        if (i2 == 3) {
            com.sigmob.sdk.nativead.l lVar2 = this.ak;
            if (lVar2 != null) {
                lVar2.onVideoStart();
            }
            this.v.D.a();
    ...
    public void a(int what, int extra) {
        SigmobLog.e("onError: what = " + what + ", extra = " + extra);
        if (this.ak != null) {
            WindAdError windAdError = WindAdError.ERROR_SIGMOB_PLAY_VIDEO;
            windAdError.setMessage("what = " + what + ", extra = " + extra);
    ...
    public void a(Context context) {
        ...
        this.aq = new c(new b() { // from class: com.sigmob.sdk.videoplayer.f$$ExternalSyntheticLambda0
    ...
    public void a(e button, boolean isShow) {
        ViewGroup viewGroup;
        int i2 = 0;
        switch (AnonymousClass2.f3693a[button.ordinal()]) {
            case 1:
                viewGroup = this.ab;
                if (!isShow) {
                }
    ...
    public ViewGroup getSigAdView() {
        ...
        while (!(viewGroup instanceof m) && (viewGroup = (ViewGroup) getParent()) != null) {
        }
        return viewGroup;
    }
    ...
    public void o() {
        ...
        String lowerCase = this.y.a().toString().toLowerCase();
        ...
        if (i3 != 0) {
            if (i3 == 4) {
                ...
                if (i3 == 3) {
                    this.D.a();
                    f();
                    com.sigmob.sdk.nativead.l lVar3 = this.ak;
                    if (lVar3 != null) {
                        lVar3.onVideoStart();
                    }
                }
    ...
    public void setSoundChange(boolean isMute) {
        ...
        this.al = isMute;
        if (isMute) {
            com.sigmob.sdk.videoplayer.c.g(contextE);
            i iVar = this.D;
            if (iVar != null) {
                iVar.a(0.0f);
            }
            ...
            com.sigmob.sdk.videoplayer.c.f(contextE);
            i iVar2 = this.D;
            if (iVar2 != null) {
                iVar2.a(1.0f);
            }
    ...
    public void setVideoAdStatusListener(com.sigmob.sdk.nativead.l adVideoStatusListener) {

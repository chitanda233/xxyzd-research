...
public class ai extends View {
    ...
    private void b() {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.sigmob.sdk.base.views.ai.1
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ai.this.i = ((Integer) valueAnimator2.getAnimatedValue()).intValue();
                ai.this.d();
                ai.this.invalidate();
            }
        });
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.sigmob.sdk.base.views.ai.2
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator3) {
                ai.this.l = ((Float) valueAnimator3.getAnimatedValue()).floatValue();
            }
        });
    ...
    protected void onDraw(Canvas canvas) {
        float f;
        super.onDraw(canvas);
        this.f3287a.setStyle(Paint.Style.STROKE);
        this.f3287a.setColor(-1);
        this.f3287a.setAlpha(204);
        this.f3287a.setStrokeWidth(this.c);
        RectF rectF = this.b;
        float f2 = this.c;
        ...
        canvas.drawPath(this.h, this.f3287a);
        this.f3287a.setStyle(Paint.Style.FILL);
        this.f3287a.setColor(-16777216);
        this.f3287a.setAlpha(76);
        this.h.reset();
        Path path2 = this.h;
        RectF rectF3 = this.b;
        ...
        this.f3287a.setColor(-1);
        this.f3287a.setStyle(Paint.Style.FILL);
        canvas.drawCircle(f4, this.n / 2.0f, f3, this.f3287a);
        this.f3287a.setColor(-16777216);
        this.f3287a.setTextSize(TypedValue.applyDimension(2, this.l * 16.0f, getResources().getDisplayMetrics()));
        this.f3287a.setTypeface(Typeface.DEFAULT_BOLD);
        float fMeasureText = f4 - (this.f3287a.measureText("GO") / 1.5f);
        canvas.drawText("GO", fMeasureText, ((this.n / 2.0f) + ((this.f3287a.getFontMetrics().bottom - this.f3287a.getFontMetrics().top) / 2.0f)) - this.f3287a.getFontMetrics().bottom, this.f3287a);
        float fMeasureText2 = this.f3287a.measureText("GO") * 0.4f;
        Path path3 = new Path();
        float f5 = fMeasureText2 / 4.0f;
        float f6 = fMeasureText2 / 2.0f;
        path3.moveTo(this.f3287a.measureText("GO") + fMeasureText + f5, (this.n / 2.0f) - f6);
        path3.lineTo(this.f3287a.measureText("GO") + fMeasureText + fMeasureText2, this.n / 2.0f);
        path3.lineTo(fMeasureText + this.f3287a.measureText("GO") + f5, (this.n / 2.0f) + f6);
        path3.close();
        canvas.drawPath(path3, this.f3287a);
        ...
        if (TextUtils.isEmpty(this.title)) {
            ...
            for (int i3 = 5; i3 < this.title.length(); i3++) {
        ...
        if (!TextUtils.isEmpty(this.d)) {
            ...
            String str2 = this.d;
            for (int i4 = 5; i4 < this.d.length(); i4++) {

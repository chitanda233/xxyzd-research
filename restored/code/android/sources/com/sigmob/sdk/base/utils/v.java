...
public class v {
    ...
    private static final String f3265a = "^((?!^10\\.)((?!^127\\.)((?!^192\\.168\\.)((?!^172\\.1[6-9]\\.)((?!^172\\.2[0-9]\\.)((?!^172\\.3[0-1]\\.)[0-9]{1,3}\\.){3}[0-9]{1,3}|^::1$|^([0-9a-f]{1,4}:){7}([0-9a-f]){1,4}$)))))";
    ...
    public static boolean a(String ipAddress) {
        ...
        return Pattern.compile(f3265a).matcher(ipAddress).matches();
    }
    ...
    public static boolean c(Object value) {
        return value == null || ((value instanceof String) && s.a((CharSequence) value));
    }

...
public final class BidResponse extends AndroidMessage<BidResponse, Builder> {
    ...
    public final Map<String, String> saas_options;
    ...
    public static final class Builder extends Message.Builder<BidResponse, Builder> {
        ...
        public Map<String, String> saas_options = Internal.newMutableMap();
        ...
        public Builder saas_options(Map<String, String> saas_options) {
            Internal.checkElementsNotNull(saas_options);
            this.saas_options = saas_options;
            return this;
        }
    ...
    private static final class ProtoAdapter_BidResponse extends ProtoAdapter<BidResponse> {
        private final ProtoAdapter<Map<String, String>> saas_options;

        public ProtoAdapter_BidResponse() {
            super(FieldEncoding.LENGTH_DELIMITED, BidResponse.class);
            this.saas_options = ProtoAdapter.newMapAdapter(ProtoAdapter.STRING, ProtoAdapter.STRING);
        }
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    case 1:
                        ...
                        break;
                    case 2:
                        builder.ads.add(Ad.ADAPTER.decode(reader));
                        break;
                    case 3:
                        builder.error_code(ProtoAdapter.UINT64.decode(reader));
                        break;
                    case 4:
                        builder.process_time_ms_dsp(ProtoAdapter.UINT64.decode(reader));
                        break;
                    case 5:
                        builder.process_time_ms_ssp(ProtoAdapter.UINT64.decode(reader));
                        break;
                    case 6:
                        builder.pctr_valid_check(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 7:
                        builder.pctr_version(ProtoAdapter.STRING.decode(reader));
                        break;
                    case 8:
                        builder.uid(ProtoAdapter.STRING.decode(reader));
                        break;
                    case 9:
                        builder.expiration_time(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 10:
                        builder.ad_ua(ProtoAdapter.STRING.decode(reader));
                        break;
                    case 11:
                        builder.slot_ad_setting(SlotAdSetting.ADAPTER.decode(reader));
                        break;
                    case 12:
                        builder.error_message(ProtoAdapter.STRING.decode(reader));
                        break;
                    case 13:
                        builder.scene(Template.ADAPTER.decode(reader));
                        break;
                    case 14:
                        builder.bidding_response(BiddingResponse.ADAPTER.decode(reader));
                        break;
                    case 15:
                        builder.rv_callback_url(ProtoAdapter.STRING.decode(reader));
                        break;
                    case 16:
                        builder.adx_id(ProtoAdapter.STRING.decode(reader));
                        break;
                    case 17:
                        builder.noncompliance_mark(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 18:
                        builder.saas_options.putAll(this.saas_options.decode(reader));
                        break;
                    default:
    ...
    public BidResponse(String request_id, List<Ad> ads, Long error_code, Long process_time_ms_dsp, Long process_time_ms_ssp, Integer pctr_valid_check, String pctr_version, String uid, Integer expiration_time, String ad_ua, SlotAdSetting slot_ad_setting, String error_message, Template scene, BiddingResponse bidding_response, String rv_callback_url, String adx_id, Boolean noncompliance_mark, Map<String, String> saas_options) {
        this(request_id, ads, error_code, process_time_ms_dsp, process_time_ms_ssp, pctr_valid_check, pctr_version, uid, expiration_time, ad_ua, slot_ad_setting, error_message, scene, bidding_response, rv_callback_url, adx_id, noncompliance_mark, saas_options, ByteString.EMPTY);
    }

    public BidResponse(String request_id, List<Ad> ads, Long error_code, Long process_time_ms_dsp, Long process_time_ms_ssp, Integer pctr_valid_check, String pctr_version, String uid, Integer expiration_time, String ad_ua, SlotAdSetting slot_ad_setting, String error_message, Template scene, BiddingResponse bidding_response, String rv_callback_url, String adx_id, Boolean noncompliance_mark, Map<String, String> saas_options, ByteString unknownFields) {
        super(ADAPTER, unknownFields);
        this.request_id = request_id;
        this.ads = Internal.immutableCopyOf(a.f3209a, ads);
        this.error_code = error_code;
        this.process_time_ms_dsp = process_time_ms_dsp;
        this.process_time_ms_ssp = process_time_ms_ssp;
        this.pctr_valid_check = pctr_valid_check;
        ...
        this.adx_id = adx_id;
        this.noncompliance_mark = noncompliance_mark;
        this.saas_options = Internal.immutableCopyOf(WindAds.SAAS_OPTIONS, saas_options);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode17 = ((iHashCode16 + (bool != null ? bool.hashCode() : 0)) * 37) + this.saas_options.hashCode();
    ...
    public Builder newBuilder() {
        ...
        builder.ads = Internal.copyOf(a.f3209a, this.ads);
        ...
        builder.saas_options = Internal.copyOf(WindAds.SAAS_OPTIONS, this.saas_options);
    ...
    public String toString() {
        ...
        if (!this.saas_options.isEmpty()) {
            sb.append(", saas_options=").append(this.saas_options);
        }

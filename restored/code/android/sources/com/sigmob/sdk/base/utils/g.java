...
public final class g {
    ...
    private static class a extends AsyncTask<String, Void, Boolean> {
        ...
        a(File inputFile, File outputDir, b listener) {
            this.f3254a = outputDir;
            this.b = inputFile;
            this.c = listener;
        }
    ...
    public static List<File> a(File inputFile, File outputDir) throws com.sigmob.sdk.archives.b, IOException {
        GZIPInputStream gZIPInputStream;
        com.sigmob.sdk.archives.d dVar;
        com.sigmob.sdk.archives.c cVarA;
        com.sigmob.sdk.archives.tar.b bVar;
        ...
        bVar = (com.sigmob.sdk.archives.tar.b) cVarA;
        if (!outputDir.exists()) {
            outputDir.mkdirs();
        }
    }
    ...
    public static String b(String str) throws IOException {
        return (str == null || str.isEmpty()) ? str : new String(b(str.getBytes("utf-8")));
    }

...
public final class InterstitialSetting extends AndroidMessage<InterstitialSetting, Builder> {
    ...
    public static final Integer DEFAULT_SKIP_SECONDS_BTN_PIC_SHOW;
    public static final Integer DEFAULT_SKIP_SECONDS_BTN_VIDEO_SHOW;
    ...
    public final Integer skip_seconds_btn_pic_show;

    @WireField(adapter = "com.squareup.wire.ProtoAdapter#UINT32", tag = 13)
    public final Integer skip_seconds_btn_video_show;
    ...
    public static final class Builder extends Message.Builder<InterstitialSetting, Builder> {
        ...
        public Integer skip_seconds_btn_pic_show = InterstitialSetting.DEFAULT_SKIP_SECONDS_BTN_PIC_SHOW;
        public Integer skip_seconds_btn_video_show = InterstitialSetting.DEFAULT_SKIP_SECONDS_BTN_VIDEO_SHOW;

        @Override // com.czhj.wire.Message.Builder
        public InterstitialSetting build() {
            return new InterstitialSetting(this.if_mute, this.show_skip_seconds, this.skip_close_ad, this.skip_position, this.endcard_close_position, this.mute_position, this.shake_level, this.charge_time, this.disable_auto_load, this.click_close_ad, this.seconds_close_ad, this.skip_seconds_btn_pic_show, this.skip_seconds_btn_video_show, super.buildUnknownFields());
        }
        ...
        public Builder skip_seconds_btn_pic_show(Integer skip_seconds_btn_pic_show) {
            this.skip_seconds_btn_pic_show = skip_seconds_btn_pic_show;
            return this;
        }

        public Builder skip_seconds_btn_video_show(Integer skip_seconds_btn_video_show) {
            this.skip_seconds_btn_video_show = skip_seconds_btn_video_show;
            return this;
        }
    }
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        builder.click_close_ad(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 11:
                        builder.seconds_close_ad(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 12:
                        builder.skip_seconds_btn_pic_show(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 13:
                        builder.skip_seconds_btn_video_show(ProtoAdapter.UINT32.decode(reader));
                        break;
                    default:
    ...
    static {
        ...
        DEFAULT_SKIP_SECONDS_BTN_PIC_SHOW = 0;
        DEFAULT_SKIP_SECONDS_BTN_VIDEO_SHOW = 0;
    }

    public InterstitialSetting(Integer if_mute, Integer show_skip_seconds, Boolean skip_close_ad, Integer skip_position, Integer endcard_close_position, Integer mute_position, Integer shake_level, Integer charge_time, Boolean disable_auto_load, Boolean click_close_ad, Integer seconds_close_ad, Integer skip_seconds_btn_pic_show, Integer skip_seconds_btn_video_show) {
        this(if_mute, show_skip_seconds, skip_close_ad, skip_position, endcard_close_position, mute_position, shake_level, charge_time, disable_auto_load, click_close_ad, seconds_close_ad, skip_seconds_btn_pic_show, skip_seconds_btn_video_show, ByteString.EMPTY);
    }

    public InterstitialSetting(Integer if_mute, Integer show_skip_seconds, Boolean skip_close_ad, Integer skip_position, Integer endcard_close_position, Integer mute_position, Integer shake_level, Integer charge_time, Boolean disable_auto_load, Boolean click_close_ad, Integer seconds_close_ad, Integer skip_seconds_btn_pic_show, Integer skip_seconds_btn_video_show, ByteString unknownFields) {
    ...
    public int hashCode() {
        ...
        Integer num9 = this.skip_seconds_btn_pic_show;
        int iHashCode13 = (iHashCode12 + (num9 != null ? num9.hashCode() : 0)) * 37;
        Integer num10 = this.skip_seconds_btn_video_show;
        int iHashCode14 = iHashCode13 + (num10 != null ? num10.hashCode() : 0);
    ...
    public Builder newBuilder() {
        ...
        builder.skip_seconds_btn_pic_show = this.skip_seconds_btn_pic_show;
        builder.skip_seconds_btn_video_show = this.skip_seconds_btn_video_show;
    ...
    public String toString() {
        ...
        if (this.skip_seconds_btn_pic_show != null) {
            sb.append(", skip_seconds_btn_pic_show=").append(this.skip_seconds_btn_pic_show);
        }
        if (this.skip_seconds_btn_video_show != null) {
            sb.append(", skip_seconds_btn_video_show=").append(this.skip_seconds_btn_video_show);
        }

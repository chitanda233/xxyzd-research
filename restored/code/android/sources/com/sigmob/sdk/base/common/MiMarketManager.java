...
public class MiMarketManager {
    ...
    private static final int f3135a = 0;
    ...
    public static class DirectMailStatusReceiver extends BroadcastReceiver {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final String f3136a = "com.xiaomi.market.DIRECT_MAIL_CHECK_RESULT";
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
                case "com.xiaomi.market.DIRECT_MAIL_STATUS":
                    ...
                    ad.a("mimarket_status", String.valueOf(i2), this.d, new ad.a() { // from class: com.sigmob.sdk.base.common.MiMarketManager$DirectMailStatusReceiver$$ExternalSyntheticLambda1
                ...
                case "com.xiaomi.market.DIRECT_MAIL_DOWNLOAD_PROGRESS":
                    ...
                    ad.a("mimarket_download_progress", String.valueOf(i), this.d, new ad.a() { // from class: com.sigmob.sdk.base.common.MiMarketManager$DirectMailStatusReceiver$$ExternalSyntheticLambda2
                        @Override // com.sigmob.sdk.base.common.ad.a
                        public final void onAddExtra(Object obj) {
                            MiMarketManager.DirectMailStatusReceiver.a(string, obj);
                        }
                    });
                    sb = new StringBuilder("MiMarketManager: downloadProgress:");
                    break;
                case "com.xiaomi.market.DIRECT_MAIL_CHECK_RESULT":
                    i = extras.getInt("styleCheckResult");
                    string = extras.getString("packageName");
                    ad.a("mimarket_check_result", i == 0 ? "1" : "0", this.d, new ad.a() { // from class: com.sigmob.sdk.base.common.MiMarketManager$DirectMailStatusReceiver$$ExternalSyntheticLambda0
                        @Override // com.sigmob.sdk.base.common.ad.a
                        public final void onAddExtra(Object obj) {
                            MiMarketManager.DirectMailStatusReceiver.c(string, obj);
                        }
                    });
                    sb = new StringBuilder("MiMarketManager: styleResult:");
                    break;
                default:
                    return;
            }
            SigmobLog.d(sb.append(i).append(" packageName:").append(string).toString());
        }
    }

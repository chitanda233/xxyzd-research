...
public class aa extends View {
    ...
    /* JADX INFO: renamed from: com.sigmob.sdk.base.views.aa$3, reason: invalid class name */
    ...
    private void c() {
        ...
        this.f3272a.setStrokeWidth(this.r);
        this.f3272a.setColor(-1);
        this.n = Dips.dipsToIntPixels(20.0f, getContext());
        this.b = new Paint(this.f3272a);
        Paint paint2 = new Paint(this.f3272a);
        this.c = paint2;
        ...
        this.e = paint4;
        paint4.setColor(-1);
        this.e.setAlpha(WorkQueueKt.MASK);
    ...
    public void a() {
        Animator animatorA = a(this.f, this.f3272a, 1000, 0);
        Animator animatorA2 = a(this.g, this.b, 800, MediaPlayer.MEDIA_PLAYER_OPTION_USE_CODEC_POOL);
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        RectF rectF = this.f;
        canvas.drawRoundRect(rectF, rectF.height() / 2.0f, this.f.height() / 2.0f, this.f3272a);
        RectF rectF2 = this.g;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (!TextUtils.isEmpty(this.title)) {
            for (int i = 5; i < this.title.length(); i++) {

...
class d {
    ...
    private static final String f3329a = "GifHeaderParser";
    ...
    private int[] a(int ncolors) {
        ...
        try {
            ...
            while (i < ncolors) {
                ...
                int i5 = i4 + 1;
                int i6 = i + 1;
                iArr[i] = ((bArr[i2] & UByte.MAX_VALUE) << 16) | (-16777216) | ((bArr[i3] & UByte.MAX_VALUE) << 8) | (bArr[i4] & UByte.MAX_VALUE);
                i2 = i5;
                i = i6;
            }
    ...
    private int e() {
        try {
            return this.h.get() & UByte.MAX_VALUE;
    ...
    private void f() {
        ...
        this.g.c.f3327a = this.h.position();
        p();
        if (d()) {
            return;
        }
    ...
    private void l() {
        do {
            ...
            byte[] bArr = this.e;
            if (bArr[0] == 1) {
                this.g.j = ((bArr[2] & UByte.MAX_VALUE) << 8) | (bArr[1] & UByte.MAX_VALUE);
                if (this.g.j == 0) {
                    this.g.j = -1;
                }
            }

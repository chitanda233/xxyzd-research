...
public class i extends FrameLayout {
    ...
    private static float f3333a = 0.0f;
    ...
    private void a() {
        f3333a = Dips.dipsToIntPixels(6.0f, getContext());
        ...
        a(this.c, 0);
        a(this.d, MediaPlayer.MEIDA_PLAYER_OPTION_IGNORE_DIRECTLY_BUFFERING);
    }
    ...
    public void a(final j view, int delay) {
        ...
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(f3333a, Dips.dipsToIntPixels(1.0f, getContext()));

    ...
    private static final class ProtoAdapter_NativeAdSetting extends ProtoAdapter<NativeAdSetting> {
        ...
        public NativeAdSetting decode(ProtoReader reader) throws IOException {
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    case 1:
                        builder.video_auto_play(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 2:
                        builder.preview_page_video_mute(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 3:
                        builder.detail_page_video_mute(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 4:
                        builder.impression_percent(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 5:
                        builder.impression_time(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 6:
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        builder.ad_pool_size(ProtoAdapter.INT32.decode(reader));
                        break;
                    case 9:
                        builder.media_expected_floor(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 10:
                        builder.log_interval_time(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 11:
                        builder.enable_advanced_interaction(ProtoAdapter.BOOL.decode(reader));
                        break;
                    default:

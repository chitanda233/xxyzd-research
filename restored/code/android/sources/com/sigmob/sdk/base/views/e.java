...
public class e extends View {
    ...
    public e(Context context) {
        ...
        this.f3318a.setStyle(Paint.Style.STROKE);
    ...
    public void b() {
        ...
        this.f3318a.setStrokeWidth(this.j);
        ...
        this.o = new PointF(this.m.x - ((float) (Math.cos(this.k) * ((double) (this.i.width() / 2.0f)))), this.m.y - ((float) (Math.sin(this.k) * ((double) (this.i.height() / 2.0f)))));
        this.p = new PointF(this.m.x + ((float) (Math.cos(this.k) * ((double) (this.i.width() / 2.0f)))), this.m.y - ((float) (Math.sin(this.k) * ((double) (this.i.height() / 2.0f)))));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(this.i, (float) (degrees + 180.0d), f, false, this.f3318a);
        this.e.reset();

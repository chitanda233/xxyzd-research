...
public class g extends SigmobRequest<SigmobSdkConfigResponse> {
    ...
    public g(String url, a listener) {
        super(url, 1, listener);
        this.f3239a = listener;
    ...
    public void deliverResponse(SigmobSdkConfigResponse sigmobSdkConfigResponse) {
        this.f3239a.a(sigmobSdkConfigResponse);
    }
    ...
    protected Response<SigmobSdkConfigResponse> parseNetworkResponse(NetworkResponse networkResponse) {
        try {
            ...
            return Response.success(SigmobSdkConfigResponse.ADAPTER.decode((networkResponse.headers.containsKey(com.alipay.sdk.m.m.b.m) && "1".equals(networkResponse.headers.get(com.alipay.sdk.m.m.b.m))) ? c.a(networkResponse.data) : networkResponse.data), HttpHeaderParser.parseCacheHeaders(networkResponse));
        } catch (Throwable th) {

...
public class ak extends View {
    ...
    private AnimatorSet a(final PointF point, final Paint paint, int duration) {
        ...
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(point.y, (point.y - getHeight()) - this.f3291a);
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.sigmob.sdk.base.views.ak$$ExternalSyntheticLambda0
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.sigmob.sdk.base.views.ak$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        animatorSet.setDuration(((long) duration) * 1000);
    ...
    private void a(Path path, PointF point) {
        float fTan = (float) (((double) point.x) - (((double) this.k) * Math.tan(2.0943951023931953d)));
        float f = point.y + this.k;
        float fTan2 = (float) (((double) point.x) + (((double) this.k) * Math.tan(2.0943951023931953d)));
    ...
    private void b() {
        ...
        this.f3291a = fDipsToIntPixels;
        this.k = fDipsToIntPixels * 2.0f;
        Paint paint = new Paint(1);
        this.b = paint;
        paint.setStyle(Paint.Style.STROKE);
        this.b.setStrokeWidth(this.f3291a);
        this.b.setColor(-1);
        this.b.setAlpha(255);
        Paint paint2 = new Paint(1);
        this.c = paint2;
        paint2.setStyle(Paint.Style.STROKE);
        this.c.setStrokeWidth(this.f3291a);
        this.c.setColor(-1);
        this.c.setAlpha(WorkQueueKt.MASK);
        Paint paint3 = new Paint(1);
        this.d = paint3;
        paint3.setStyle(Paint.Style.STROKE);
        this.d.setStrokeWidth(this.f3291a);
        this.d.setColor(-1);
        this.d.setAlpha(76);
        this.e = new Path();
        this.f = new Path();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        this.h = new PointF(f, this.f3291a + f2);
        this.i = new PointF(f, this.f3291a + f2 + fDipsToIntPixels);
        this.j = new PointF(f, f2 + this.f3291a + (fDipsToIntPixels * 2.0f));
        c();
        a();
    }
}

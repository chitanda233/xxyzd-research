...
public final class SigmobAndroid extends AndroidMessage<SigmobAndroid, Builder> {
    ...
    public static final class Builder extends Message.Builder<SigmobAndroid, Builder> {
        ...
        public Builder s2s_token_timeout(Integer s2s_token_timeout) {
            this.s2s_token_timeout = s2s_token_timeout;
            return this;
        }
    ...
    private static final class ProtoAdapter_SigmobAndroid extends ProtoAdapter<SigmobAndroid> {
        ...
        public SigmobAndroid decode(ProtoReader reader) throws IOException {
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        builder.enable_okhttp3(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 11:
                        builder.enable_app_list(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 12:
                        builder.lock_play(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 13:
                        builder.screen_keep(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 14:
                        builder.open_pkg_list.add(ProtoAdapter.STRING.decode(reader));
                        break;
                    case 15:
                        builder.use_web_source_cache(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 16:
                        builder.web_source_cache_expiration_time(ProtoAdapter.UINT32.decode(reader));
                        break;
                    case 17:
                        builder.disable_install_monitor(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 18:
                        builder.enable_open_pkg_list(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 19:
                        builder.enable_open_pkg_dir_list(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 20:
                        builder.s2s_token_timeout(ProtoAdapter.UINT32.decode(reader));
                        break;
                    default:
    ...
    public String toString() {
        ...
        if (this.s2s_token_timeout != null) {
            sb.append(", s2s_token_timeout=").append(this.s2s_token_timeout);
        }

...
public final class PointCategory {
    ...
    public static final String APK_CLICK = "apk_click";
    ...
    public static final String CAN_DP = "can_dp";
    ...
    public static final String EXIT_APK_INSTALL = "exit_apk_install";
    ...
    public static final String LOAD_READY = "load_ready";
    public static final String LOCKED = "locked";
    public static final String LOSE = "lose";
    public static final String NOINTEREST_CLICK = "nointerest_click";
    public static final String NO_CAN_DP = "no_can_dp";
    public static final String OBJECT_EXPIRE = "object_expire";
    ...
    public static final String OPEN_PKG = "open_pkg";
    ...
    public static final String SUBJECT_EXPIRE = "subject_expire";

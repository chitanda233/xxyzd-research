...
public final class y {
    ...
    private static final String f3269a = "y";
    private static final String b = "com.wind.Settings";
    private static final int c = 4;
    private static final Map<String, SharedPreferences> d = new ConcurrentHashMap();
    ...
    public static float a(Context ctx, String name, String key, float defValue) {
        ...
        SigmobLogger.e(f3269a, "getFloat: sp is unavailable.", new Object[0]);
        return defValue;
    }
    ...
    public static int a(Context ctx, String name, String key, int defValue) {
        ...
        SigmobLogger.e(f3269a, "getInt: sp is unavailable.", new Object[0]);
        return defValue;
    }
    ...
    public static long a(Context ctx, String name, String key, long defValue) {
        ...
        SigmobLogger.e(f3269a, "getLong: sp is unavailable.", new Object[0]);
        return defValue;
    }

    public static SharedPreferences a(Context ctx, String name) {
        if (ctx == null) {
            SigmobLogger.e(f3269a, "getPrefs: ctx is unavailable.", new Object[0]);
            return null;
        }
        ...
        SharedPreferences sharedPreferences2 = ctx.getSharedPreferences(name, 4);
        map.put(name, sharedPreferences2);
    ...
    public static String a(Context ctx, String name, String key, String defValue) {
        ...
        SigmobLogger.e(f3269a, "getString: sp is unavailable.", new Object[0]);
        return defValue;
    }
    ...
    public static void a(Context ctx, String name, Map<String, Object> map) {
        ...
        if (sharedPreferencesA == null || map == null || map.isEmpty()) {
            SigmobLogger.e(f3269a, "apply: sp or map is unavailable.", new Object[0]);
            return;
        }
    ...
    public static void a(Context ctx, String name, Object[] pairs) {
        ...
        if (sharedPreferencesA == null || pairs == null) {
            SigmobLogger.e(f3269a, "apply: sp or pairs is unavailable.", new Object[0]);
            return;
        }
        SharedPreferences.Editor editorEdit = sharedPreferencesA.edit();
    ...
    public static boolean a(Context ctx, String name, String key, boolean defValue) {
        ...
        SigmobLogger.e(f3269a, "getBoolean: sp is unavailable.", new Object[0]);
        return defValue;
    }
    ...
    public static void b(Context ctx, String name, String key, float value) {
        SharedPreferences sharedPreferencesA = a(ctx, name);
        if (sharedPreferencesA == null) {
            SigmobLogger.e(f3269a, "saveFloat: sp is unavailable.", new Object[0]);
        } else {
    ...
    public static void b(Context ctx, String name, String key, int value) {
        SharedPreferences sharedPreferencesA = a(ctx, name);
        if (sharedPreferencesA == null) {
            SigmobLogger.e(f3269a, "saveInt: sp is unavailable.", new Object[0]);
        } else {
    ...
    public static void b(Context ctx, String name, String key, long value) {
        SharedPreferences sharedPreferencesA = a(ctx, name);
        if (sharedPreferencesA == null) {
            SigmobLogger.e(f3269a, "saveLong: sp is unavailable.", new Object[0]);
        } else {
    ...
    public static void b(Context ctx, String name, String key, String value) {
        SharedPreferences sharedPreferencesA = a(ctx, name);
        if (sharedPreferencesA == null) {
            SigmobLogger.e(f3269a, "saveString: sp is unavailable.", new Object[0]);
        } else {
    ...
    public static void b(Context ctx, String name, String key, boolean value) {
        SharedPreferences sharedPreferencesA = a(ctx, name);
        if (sharedPreferencesA == null) {
            SigmobLogger.e(f3269a, "saveBoolean: sp is unavailable.", new Object[0]);
        } else {

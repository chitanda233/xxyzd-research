...
public class m extends RelativeLayout {
    ...
    public m(Context context, BaseAdUnit adUnit, final String title, String actionStr, float rating, String desc, int animType, int styleType, final String iconUrl, final int buttonColor, final int buttonTextColor, int click_type, final int barColor, final int barAlp, final float height) {
        super(context);
        this.f3339a = Dips.asIntPixels(height, context);
        ...
        float f = iAsIntPixels * 2;
        circleImageView.f3270a = f;
        textView2.setBackground(gradientDrawable);
        textView2.setId(ClientMetadata.generateViewId());
        GradientDrawable gradientDrawable2 = new GradientDrawable();
        gradientDrawable2.setCornerRadius(f);
        gradientDrawable2.setColor(barColor);
        gradientDrawable2.setAlpha(barAlp);
    ...
    private void d() {
        ...
        objectAnimatorOfPropertyValuesHolder.setInterpolator(new Interpolator() { // from class: com.sigmob.sdk.base.views.m$$ExternalSyntheticLambda0
    ...
    public void a(Context context, float rating) {
        TextView textView = new TextView(context);
        this.f = textView;
        ...
        if (rating > 0.0f) {
            this.f.setText(String.format("%.1f", Float.valueOf(rating)));
        }
        this.h = new t(context, rating);
    }

    public void a(Context context, String desc) {
        TextView textView = new TextView(context);
        this.g = textView;
        textView.setId(ClientMetadata.generateViewId());
    ...
    public void a(String logoUrl) {
        if (TextUtils.isEmpty(logoUrl)) {
            return;
        }
        com.sigmob.sdk.base.common.h.a().getBitmap(logoUrl, new ImageManager.BitmapLoadedListener() { // from class: com.sigmob.sdk.base.views.m.4

...
public class k {
    ...
    private static final String f3218a = "sig_ad";
    ...
    public static String a(Object... formatArgs) {
        return ClientMetadata.getInstance().getStringResources(d, "跳过 %d", formatArgs);
    }
    ...
    public static String b(Object... formatArgs) {
        return ClientMetadata.getInstance().getStringResources(e, "%d 跳过", formatArgs);
    }
    ...
    public static String c(Object... formatArgs) {
        return ClientMetadata.getInstance().getStringResources(f, "跳过广告 %d", formatArgs);
    }
    ...
    public static String d(Object... formatArgs) {
        return ClientMetadata.getInstance().getStringResources(g, "%s 跳过", formatArgs);
    }
    ...
    public static int f() {
        ...
        return clientMetadata.getStyleResources(clientMetadata.getDisplayMetrics().widthPixels > clientMetadata.getDisplayMetrics().heightPixels ? r : l);
    }
    ...
    public static String h() {
        return ClientMetadata.getInstance().getStringResources(f3218a, "广告");
    }

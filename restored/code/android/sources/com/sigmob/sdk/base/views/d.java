...
public class d extends RelativeLayout {
    ...
    private int k;
    private TextView l;
    private final com.sigmob.sdk.videoAd.c m;
    ...
    public d(Context context, com.sigmob.sdk.videoAd.c dialogConfig) {
        super(context);
        this.m = dialogConfig;
        this.f3315a = Dips.dipsToIntPixels(10.0f, context);
        int iDipsToIntPixels = Dips.dipsToIntPixels(16.0f, context);
        this.b = iDipsToIntPixels;
        int iDipsToIntPixels2 = Dips.dipsToIntPixels(227.0f, context);
        this.c = iDipsToIntPixels2;
        this.f = (int) (((double) (iDipsToIntPixels2 * 16.0f)) / 9.0d);
        int iDipsToIntPixels3 = Dips.dipsToIntPixels(25.0f, context);
        this.d = iDipsToIntPixels3;
        this.h = Dips.dipsToIntPixels(25.0f, context);
        this.e = Dips.dipsToIntPixels(100.0f, context);
        this.g = iDipsToIntPixels3 + iDipsToIntPixels;
    ...
    private Button d(Context context) {
        ...
        ab.a(button, r.f3355a, this.g / 2, Color.parseColor("#66000000"), 0, 0, 0);
        return button;
    }
    ...
    private void e(Context context) {
        ...
        int i = this.b;
        layoutParams.setMargins(i, this.f3315a * 2, i, 0);
        ...
        int i2 = this.b;
        layoutParams2.setMargins(i2, this.f3315a, i2, 0);
        linearLayout.addView(b(context), layoutParams2);
        ab.a(linearLayout, Color.parseColor("#FFFFFF"), this.f3315a, Color.parseColor("#66000000"), 0, 0, 0);

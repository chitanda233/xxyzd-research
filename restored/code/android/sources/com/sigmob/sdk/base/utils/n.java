...
public final class n {
    ...
    public static String f3260a = "SigHtmlResource";
    ...
    public static File a(Object name) {
        return new File(g(), name + ".log");
    }
    ...
    public static String a(String fileName) {
        int iLastIndexOf = fileName.lastIndexOf(TRouterMap.DOT);
    ...
    public static String d() {
        if (f == null) {
            ...
            if (externalCacheDir != null && h != null) {
    ...
    public static synchronized String h() {
        return a() + File.separator + bv.f452a + File.separator + "sdkLog.log";
    }

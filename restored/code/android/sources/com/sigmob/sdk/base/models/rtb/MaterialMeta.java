...
public final class MaterialMeta extends AndroidMessage<MaterialMeta, Builder> {
    ...
    public static final class Builder extends Message.Builder<MaterialMeta, Builder> {
        ...
        public Builder app_desc(String app_desc) {
        ...
        public Builder component_library(String component_library) {
            this.component_library = component_library;
            return this;
        }

        public Builder creative_desc(String creative_desc) {
            this.creative_desc = creative_desc;
            return this;
        }
        ...
        public Builder render_mode(Integer render_mode) {
        ...
        public MaterialMeta decode(ProtoReader reader) throws IOException {
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    ...
                    case 44:
                        list = builder.asset;
                        parcelable = (ResponseAsset) ResponseAsset.ADAPTER.decode(reader);
                        break;
                    case 45:
                    ...
                    case 51:
                        ...
                        parcelable = (Widget) Widget.ADAPTER.decode(reader);
                        break;
                    case 52:
                    ...
                    default:
                        ...
                        continue;
                    case 57:
                        builder.render_mode(ProtoAdapter.UINT32.decode(reader));
                        continue;
                    case 58:
                        builder.component_library(ProtoAdapter.STRING.decode(reader));
                        continue;
                    case 59:
                        builder.app_desc(ProtoAdapter.STRING.decode(reader));
                        continue;
                    case 60:
                        builder.creative_desc(ProtoAdapter.STRING.decode(reader));
                        continue;
                }
                list.add(parcelable);
            }
    ...
    public String toString() {
        ...
        if (this.render_mode != null) {
            sb.append(", render_mode=").append(this.render_mode);
        }
        if (this.component_library != null) {
            sb.append(", component_library=").append(this.component_library);
        }
        if (this.app_desc != null) {
            sb.append(", app_desc=").append(this.app_desc);
        }
        if (this.creative_desc != null) {
            sb.append(", creative_desc=").append(this.creative_desc);
        }

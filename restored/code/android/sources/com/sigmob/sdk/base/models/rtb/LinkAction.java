...
public final class LinkAction extends AndroidMessage<LinkAction, Builder> {
    ...
    private static final class ProtoAdapter_LinkAction extends ProtoAdapter<LinkAction> {
        ...
        public LinkAction decode(ProtoReader reader) throws IOException {
            ...
            while (true) {
                ...
                if (iNextTag == 1) {
                    builder.scheme(ProtoAdapter.STRING.decode(reader));
                } else if (iNextTag == 2) {
                    builder.host(ProtoAdapter.STRING.decode(reader));
                } else if (iNextTag != 3) {
                    ...
                    builder.redirect_count(ProtoAdapter.INT32.decode(reader));
                }
            }
        }

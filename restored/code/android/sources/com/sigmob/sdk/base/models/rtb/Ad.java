        ...
        public Ad decode(ProtoReader reader) throws IOException {
            ...
            while (true) {
                ...
                if (iNextTag == 24) {
                    ...
                    builder.wx_program_res(WXProgramRes.ADAPTER.decode(reader));
                } else if (iNextTag != 29) {
                    if (iNextTag == 31) {
                        list = builder.frequency_control;
                        parcelable = (FrequencyControl) FrequencyControl.ADAPTER.decode(reader);
                    } else if (iNextTag != 32) {
                        switch (iNextTag) {
                            case 1:
                            ...
                            case 6:
                                ...
                                parcelable = (MaterialMeta) MaterialMeta.ADAPTER.decode(reader);
                                break;
                            case 7:
                                list = builder.ad_tracking;
                                parcelable = (Tracking) Tracking.ADAPTER.decode(reader);
                                break;
                            case 8:
                                builder.bid_price(ProtoAdapter.UINT32.decode(reader));
                                break;
                            case 9:
                                builder.product_id(ProtoAdapter.STRING.decode(reader));
                                break;
                            case 10:
                                builder.settlement_price_enc(ProtoAdapter.STRING.decode(reader));
                                break;
                            case 11:
                                builder.is_override(ProtoAdapter.UINT32.decode(reader));
                                break;
                            case 12:
                                builder.ad_source_logo(ProtoAdapter.STRING.decode(reader));
                                break;
                            case 13:
                                builder.ad_source_channel(ProtoAdapter.STRING.decode(reader));
                                break;
                            case 14:
                                builder.ad_type(ProtoAdapter.UINT32.decode(reader));
                                break;
                            case 15:
                                map = builder.options;
                                ...
                                break;
                            case 16:
                                builder.expired_time(ProtoAdapter.UINT32.decode(reader));
                                break;
                            case 17:
                                builder.forbiden_parse_landingpage(ProtoAdapter.BOOL.decode(reader));
                                break;
                            case 18:
                                builder.display_orientation(ProtoAdapter.UINT32.decode(reader));
                                break;
                            case 19:
                                builder.ad_setting(AdSetting.ADAPTER.decode(reader));
                                break;
                            case 20:
                                builder.bid_type(ProtoAdapter.UINT32.decode(reader));
                                break;
                            case 21:
                                builder.attribution_id(ProtoAdapter.STRING.decode(reader));
                                break;
                            default:
                        ...
                        builder.enable_small_window(ProtoAdapter.BOOL.decode(reader));
                    }
                    list.add(parcelable);
                } else {
                    builder.bidding_response(BiddingResponse.ADAPTER.decode(reader));
                }
                map.putAll(protoAdapter.decode(reader));
            }
        }

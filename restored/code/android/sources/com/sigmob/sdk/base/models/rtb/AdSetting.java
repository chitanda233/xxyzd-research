...
public final class AdSetting extends AndroidMessage<AdSetting, Builder> {
    ...
    public static final class Builder extends Message.Builder<AdSetting, Builder> {
        ...
        public Builder max_redirect_count(Integer max_redirect_count) {
            this.max_redirect_count = max_redirect_count;
            return this;
        }
        ...
        public Builder shake_time_threshold(Integer shake_time_threshold) {
            this.shake_time_threshold = shake_time_threshold;
            return this;
        }

        public Builder shake_trigger_type(Integer shake_trigger_type) {
            this.shake_trigger_type = shake_trigger_type;
            return this;
        }
        ...
        public Builder widget_interval_time(Integer widget_interval_time) {
            this.widget_interval_time = widget_interval_time;
            return this;
        }
    }
    ...
    private static final class ProtoAdapter_AdSetting extends ProtoAdapter<AdSetting> {
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        builder.can_expire_reload(ProtoAdapter.BOOL.decode(reader));
                        continue;
                    case 12:
                        builder.expire_reload_count(ProtoAdapter.UINT32.decode(reader));
                        continue;
                    case 13:
                        builder.shake_count(ProtoAdapter.UINT32.decode(reader));
                        continue;
                    case 14:
                        builder.shake_time_threshold(ProtoAdapter.UINT32.decode(reader));
                        continue;
                    case 15:
                        builder.shake_trigger_type(ProtoAdapter.UINT32.decode(reader));
                        continue;
                    case 16:
                        builder.widget_interval_time(ProtoAdapter.UINT32.decode(reader));
                        continue;
                    case 18:
                        builder.max_redirect_count(ProtoAdapter.UINT32.decode(reader));
                        continue;
                }
                list.add(obj);
            }
        ...
        public void encode(ProtoWriter writer, AdSetting value) throws IOException {
            ...
            ProtoAdapter.UINT32.encodeWithTag(writer, 14, value.shake_time_threshold);
            ProtoAdapter.UINT32.encodeWithTag(writer, 15, value.shake_trigger_type);
            ProtoAdapter.UINT32.encodeWithTag(writer, 16, value.widget_interval_time);
            ProtoAdapter.UINT32.encodeWithTag(writer, 18, value.max_redirect_count);
            writer.writeBytes(value.unknownFields());
        }

        @Override // com.czhj.wire.ProtoAdapter
        public int encodedSize(AdSetting value) {
            return RvAdSetting.ADAPTER.encodedSizeWithTag(1, value.rv_setting) + SplashAdSetting.ADAPTER.encodedSizeWithTag(2, value.splash_setting) + ProtoAdapter.INT32.encodedSizeWithTag(3, value.retry_count) + SingleNativeAdSetting.ADAPTER.encodedSizeWithTag(4, value.single_native_setting) + ProtoAdapter.BOOL.encodedSizeWithTag(5, value.in_app) + ProtoAdapter.BOOL.encodedSizeWithTag(7, value.disable_download_listener) + ProtoAdapter.STRING.asRepeated().encodedSizeWithTag(8, value.scheme_white_list) + ProtoAdapter.UINT32.encodedSizeWithTag(9, value.sensitivity) + LinkAction.ADAPTER.asRepeated().encodedSizeWithTag(10, value.link_actions) + ProtoAdapter.BOOL.encodedSizeWithTag(11, value.can_expire_reload) + ProtoAdapter.UINT32.encodedSizeWithTag(12, value.expire_reload_count) + ProtoAdapter.UINT32.encodedSizeWithTag(13, value.shake_count) + ProtoAdapter.UINT32.encodedSizeWithTag(14, value.shake_time_threshold) + ProtoAdapter.UINT32.encodedSizeWithTag(15, value.shake_trigger_type) + ProtoAdapter.UINT32.encodedSizeWithTag(16, value.widget_interval_time) + ProtoAdapter.UINT32.encodedSizeWithTag(18, value.max_redirect_count) + value.unknownFields().size();
        }
    ...
    public AdSetting(RvAdSetting rv_setting, SplashAdSetting splash_setting, Integer retry_count, SingleNativeAdSetting single_native_setting, Boolean in_app, Boolean disable_download_listener, List<String> scheme_white_list, Integer sensitivity, List<LinkAction> link_actions, Boolean can_expire_reload, Integer expire_reload_count, Integer shake_count, Integer shake_time_threshold, Integer shake_trigger_type, Integer widget_interval_time, Integer max_redirect_count) {
        this(rv_setting, splash_setting, retry_count, single_native_setting, in_app, disable_download_listener, scheme_white_list, sensitivity, link_actions, can_expire_reload, expire_reload_count, shake_count, shake_time_threshold, shake_trigger_type, widget_interval_time, max_redirect_count, ByteString.EMPTY);
    }

    public AdSetting(RvAdSetting rv_setting, SplashAdSetting splash_setting, Integer retry_count, SingleNativeAdSetting single_native_setting, Boolean in_app, Boolean disable_download_listener, List<String> scheme_white_list, Integer sensitivity, List<LinkAction> link_actions, Boolean can_expire_reload, Integer expire_reload_count, Integer shake_count, Integer shake_time_threshold, Integer shake_trigger_type, Integer widget_interval_time, Integer max_redirect_count, ByteString unknownFields) {
    ...
    public String toString() {
        ...
        if (this.shake_time_threshold != null) {
            sb.append(", shake_time_threshold=").append(this.shake_time_threshold);
        }
        if (this.shake_trigger_type != null) {
            sb.append(", shake_trigger_type=").append(this.shake_trigger_type);
        }
        if (this.widget_interval_time != null) {
            sb.append(", widget_interval_time=").append(this.widget_interval_time);
        }
        if (this.max_redirect_count != null) {
            sb.append(", max_redirect_count=").append(this.max_redirect_count);
        }

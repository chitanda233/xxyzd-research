...
public class a extends Dialog implements DialogInterface.OnDismissListener, DialogInterface.OnShowListener, View.OnClickListener {
    ...
    public a(Context context, String requestId, String placement_id) {
        ...
        this.h = placement_id;
        this.i = b();
        this.d = this.f3271a.getResources().getDisplayMetrics().widthPixels;
        this.c = Dips.dipsToIntPixels(120.0f, context);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void a(View view) {
        com.sigmob.sdk.base.common.ak.a(view.getContext(), a(view.getContext(), String.format("%s,%s,%s", new StringBuilder("appid:").append(WindAds.sharedAds().getAppId()).toString(), new StringBuilder("p_id:").append(this.h).toString(), new StringBuilder("req_id:").append(this.g).toString())) ? "广告信息复制完成" : "广告信息复制失败，请检查权限", 0).show();
    }
    ...
    private ImageView b() {
        ...
        this.i.setImageAlpha(WorkQueueKt.MASK);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float fDipsToIntPixels = Dips.dipsToIntPixels(20.0f, this.f3271a);
        ...
        int iDipsToIntPixels = Dips.dipsToIntPixels(10.0f, this.f3271a);
        ...
        int iDipsToIntPixels2 = Dips.dipsToIntPixels(18.0f, this.f3271a);
        if (this.i != null) {

...
public final class SigmobCommon extends AndroidMessage<SigmobCommon, Builder> {
    ...
    public static final class Builder extends Message.Builder<SigmobCommon, Builder> {
        ...
        public Builder preload(List<SigmobPreload> preload) {
            Internal.checkElementsNotNull(preload);
            this.preload = preload;
            return this;
        }

        public Builder preload_url(String preload_url) {
    ...
    private static final class ProtoAdapter_SigmobCommon extends ProtoAdapter<SigmobCommon> {
        ...
        public SigmobCommon decode(ProtoReader reader) throws IOException {
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    case 1:
                        builder.endpoints(SigmobCommonEndpointsConfig.ADAPTER.decode(reader));
                        continue;
                    case 2:
                        builder.rv_config(SigmobRvConfig.ADAPTER.decode(reader));
                        continue;
                    case 3:
                        builder.splash_config(SigmobSplashConfig.ADAPTER.decode(reader));
                        continue;
                    case 4:
                        builder.native_config(SigmobNativeConfig.ADAPTER.decode(reader));
                        continue;
                    case 5:
                    default:
                    ...
                    case 6:
                        ...
                        continue;
                    case 7:
                        builder.anti_fraud_log(SigmobAntiFraudLogConfig.ADAPTER.decode(reader));
                        continue;
                    case 8:
                    ...
                    case 13:
                        ...
                        obj = (Integer) ProtoAdapter.UINT32.decode(reader);
                        break;
                    case 14:
                    ...
                    case 17:
                        ...
                        continue;
                    case 18:
                        builder.feedback_debug(ProtoAdapter.BOOL.decode(reader));
                        continue;
                    case 19:
                        builder.enable_extra_dclog(ProtoAdapter.BOOL.decode(reader));
                        continue;
                    case 20:
                        builder.network_timeout(ProtoAdapter.UINT32.decode(reader));
                        continue;
                    case 21:
                        builder.noncompliance_mark(ProtoAdapter.BOOL.decode(reader));
                        continue;
                    case 22:
                        builder.expire_monitor_interval(ProtoAdapter.UINT32.decode(reader));
                        continue;
                    case 23:
                        builder.enable_active_expire(ProtoAdapter.BOOL.decode(reader));
                        continue;
                    case 24:
                        builder.sniffing_type(ProtoAdapter.UINT32.decode(reader));
                        continue;
                    case 25:
                        builder.preload_url(ProtoAdapter.STRING.decode(reader));
                        continue;
                    case 26:
                        list = builder.preload;
                        obj = (SigmobPreload) SigmobPreload.ADAPTER.decode(reader);
                        break;
                }
                list.add(obj);
            }
        ...
        public SigmobCommon redact(SigmobCommon value) {
            ...
            if (builderNewBuilder.endpoints != null) {
                builderNewBuilder.endpoints = SigmobCommonEndpointsConfig.ADAPTER.redact(builderNewBuilder.endpoints);
            }
            if (builderNewBuilder.rv_config != null) {
                builderNewBuilder.rv_config = SigmobRvConfig.ADAPTER.redact(builderNewBuilder.rv_config);
            }
            if (builderNewBuilder.splash_config != null) {
                builderNewBuilder.splash_config = SigmobSplashConfig.ADAPTER.redact(builderNewBuilder.splash_config);
            }
            if (builderNewBuilder.native_config != null) {
                builderNewBuilder.native_config = SigmobNativeConfig.ADAPTER.redact(builderNewBuilder.native_config);
            }
            if (builderNewBuilder.anti_fraud_log != null) {
                builderNewBuilder.anti_fraud_log = SigmobAntiFraudLogConfig.ADAPTER.redact(builderNewBuilder.anti_fraud_log);
            }
    ...
    public SigmobCommon(SigmobCommonEndpointsConfig endpoints, SigmobRvConfig rv_config, SigmobSplashConfig splash_config, SigmobNativeConfig native_config, Integer configRefresh, SigmobAntiFraudLogConfig anti_fraud_log, Boolean is_gdpr_region, Integer tracking_expiration_time, Integer tracking_retry_interval, Integer max_send_log_records, Integer send_log_interval, List<Integer> dclog_blacklist, Boolean enable_debug_level, Integer load_interval, Boolean disable_up_location, Boolean log_enc, Boolean feedback_debug, Boolean enable_extra_dclog, Integer network_timeout, Boolean noncompliance_mark, Integer expire_monitor_interval, Boolean enable_active_expire, Integer sniffing_type, String preload_url, List<SigmobPreload> preload, ByteString unknownFields) {
        ...
        this.sniffing_type = sniffing_type;
        this.preload_url = preload_url;
        this.preload = Internal.immutableCopyOf("preload", preload);
    }
    ...
    public String toString() {
        ...
        if (this.preload_url != null) {
            sb.append(", preload_url=").append(this.preload_url);
        }

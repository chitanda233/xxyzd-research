...
public class LoadAdRequest implements Serializable {
    ...
    public LoadAdRequest(WindAdRequest adRequest) {
        ...
        this.mAdxId = adRequest.getAdxId();
        this.mTBAdxInfo = adRequest.getTBAdxInfo();
    ...
    public void setAdx_id(String adxId) {
        this.mAdxId = adxId;
        k.b(TAG, "setAdxId: adxId = " + adxId, new Object[0]);
    }
    ...
    public LoadAdRequest setLoadId(String loadId) {
        this.mLoadId = loadId;
        return this;
    }

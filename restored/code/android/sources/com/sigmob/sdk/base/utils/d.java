...
public class d {
    ...
    public static final HashMap<String, a> f3252a = new HashMap<>();
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public Integer f3253a = 0;
        public Integer b = 0;

        public String toString() {
            return "CLickCallbackObj{clickLoseRate=" + this.f3253a + ", clickCbState=" + this.b + '}';
        }
    }
    ...
    public static void a(String tag, BaseAdUnit adUnit, a obj) {
        ...
        Integer numValueOf = Integer.valueOf(obj == null ? 0 : obj.f3253a.intValue());
    ...
    public static void a(String requestId, Integer clickLoseRate, Integer clickCbState) {
        ...
        HashMap<String, a> map = f3252a;
        if (map.get(requestId) == null) {
            a aVar = new a();
            aVar.f3253a = clickLoseRate;
            aVar.b = clickCbState;

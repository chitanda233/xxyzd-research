...
public final class StrategyReq extends AndroidMessage<StrategyReq, Builder> {
    ...
    public String toString() {
        ...
        if (this.strategy_init != null) {
            sb.append(", strategy_init=").append(this.strategy_init);
        }
        if (this.last_strategy_id != null) {
            sb.append(", last_strategy_id=").append(this.last_strategy_id);
        }
        return sb.replace(0, 2, "StrategyReq{").append('}').toString();
    }
}

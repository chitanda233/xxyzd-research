...
public final class Preconditions {
    ...
    private static final String f2297a = "";

    public static final class NoThrow {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static volatile boolean f2298a = true;

        public static boolean checkArgument(boolean z) {
            return Preconditions.b(z, f2298a, "Illegal argument", "");
        }

        public static boolean checkArgument(boolean z, String str) {
            return Preconditions.b(z, f2298a, str, "");
        }

        public static boolean checkNotNull(Object obj) {
            return Preconditions.b(obj, f2298a, (String) null, "");
        }

        public static boolean checkNotNull(Object obj, String str) {
            return Preconditions.b(obj, f2298a, str, "");
        }

        public static boolean checkUiThread(String str) {
            return Preconditions.b(f2298a, str, "");
        }

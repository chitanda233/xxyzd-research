...
public class AdvertisingId implements Serializable {
    ...
    boolean b() {
        return Calendar.getInstance().getTimeInMillis() - this.f2279a.getTimeInMillis() >= 86400000;
    }
    ...
    public String toString() {
        return "AdvertisingId{mLastRotation=" + this.f2279a + ", mAdvertisingId='" + this.mAdvertisingId + "', mSigmobId='" + this.b + "', mDoNotTrack=" + this.mDoNotTrack + '}';
    }
}

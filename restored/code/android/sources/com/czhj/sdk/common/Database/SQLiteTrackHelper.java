...
public class SQLiteTrackHelper extends SQLiteOpenHelper {
    ...
    private static String f2241a = "sigmob_track.db";
    private static final int b = 9;
    private static String c = "CREATE TABLE tracks ( id integer primary key AUTOINCREMENT ,retryNum integer   ,source text   ,event text   ,request_id text   ,url text   ,timestamp integer, extInfo text, messageType integer );\n";
    private static final long d = -6;
    private static final long e = -5;
    private static final long f = -4;
    private static final long g = 0;
    private static volatile SQLiteTrackHelper h;
    ...
    public SQLiteTrackHelper(Context context) {
        super(context, f2241a, (SQLiteDatabase.CursorFactory) null, 9);
    }
    ...
    public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i2, int i3) {
        Log.w(SQLiteTrackHelper.class.getName(), "Downgrading database from version " + i2 + " to " + i3 + ", which will destroy all old data");
        b(sQLiteDatabase);
    }
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i2, int i3) {
        Log.w(SQLiteTrackHelper.class.getName(), "Upgrading database from version " + i2 + " to " + i3 + ", which will destroy all old data");
    }

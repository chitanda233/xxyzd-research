...
public class IdentifierManager {
    ...
    private static final String d = "privacy.identifier.ifa_aes_gcm";
    ...
    private static synchronized void a(Context context, AdvertisingId advertisingId) {
        ...
        editorEdit.putLong(f, advertisingId.f2279a.getTimeInMillis());
        editorEdit.apply();
    }
        ...
        if (d()) {
            ...
            if (advertisingIdInfo != null) {
                ...
                if (advertisingIdInfo.limitAdTracking && advertisingId.b()) {
                    ...
                    a(advertisingIdInfo.advertisingId, advertisingId.b, advertisingIdInfo.limitAdTracking, advertisingId.f2279a.getTimeInMillis());
                }
            }
        }
    }

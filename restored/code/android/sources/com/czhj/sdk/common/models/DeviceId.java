...
public final class DeviceId extends AndroidMessage<DeviceId, Builder> {
    ...
    public int hashCode() {
        ...
        int iHashCode29 = iHashCode28 + (str24 != null ? str24.hashCode() : 0);
    ...
    public String toString() {
        ...
        if (this.android_uuid != null) {
            sb.append(", android_uuid=").append(this.android_uuid);
        }
        if (this.imsi != null) {
        ...
        if (this.imei1 != null) {
            sb.append(", imei1=").append(this.imei1);
        }
        if (this.imei2 != null) {
            sb.append(", imei2=").append(this.imei2);
        }
        if (this.oaid != null) {
        ...
        if (this.aaid != null) {
            sb.append(", aaid=").append(this.aaid);
        }
        if (this.msa_udid != null) {
            sb.append(", msa_udid=").append(this.msa_udid);
        }
        if (this.idfa_md5 != null) {
            sb.append(", idfa_md5=").append(this.idfa_md5);
        }
        if (this.imei_md5 != null) {
            sb.append(", imei_md5=").append(this.imei_md5);
        }
        if (this.android_id_md5 != null) {
            sb.append(", android_id_md5=").append(this.android_id_md5);
        }
        if (this.gaid_md5 != null) {
            sb.append(", gaid_md5=").append(this.gaid_md5);
        }
        if (this.oaid_md5 != null) {
            sb.append(", oaid_md5=").append(this.oaid_md5);
        }
        if (this.imei1_md5 != null) {
            sb.append(", imei1_md5=").append(this.imei1_md5);
        }
        if (this.imei2_md5 != null) {
            sb.append(", imei2_md5=").append(this.imei2_md5);
        }
        if (this.is_custom_imei != null) {
            sb.append(", is_custom_imei=").append(this.is_custom_imei);
        }
        if (this.is_custom_oaid != null) {
            sb.append(", is_custom_oaid=").append(this.is_custom_oaid);
        }
        if (this.is_custom_idfa != null) {
            sb.append(", is_custom_idfa=").append(this.is_custom_idfa);
        }
        if (this.is_custom_android_id != null) {
            sb.append(", is_custom_android_id=").append(this.is_custom_android_id);
        }
        if (this.oaid_api != null) {
            sb.append(", oaid_api=").append(this.oaid_api);
        }
        return sb.replace(0, 2, "DeviceId{").append('}').toString();
    }
}

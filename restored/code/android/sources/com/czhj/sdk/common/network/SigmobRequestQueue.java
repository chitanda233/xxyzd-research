...
public class SigmobRequestQueue extends RequestQueue {
    ...
    private static final int f2269a = 10;
    ...
    class DelayedRequestHelper {
        ...
        void a() {
            this.b.postDelayed(this.c, this.f2273a);
        }
    ...
    SigmobRequestQueue(Network network, int i, int i2) {
        this(network, i, i2, new ExecutorsDelivery(ThreadPoolFactory.getFixIOExecutor()));
    }

    SigmobRequestQueue(Network network, int i, int i2, ResponseDelivery responseDelivery) {
        super(network, i, i2, responseDelivery);
        this.b = new HashMap(10);
    }

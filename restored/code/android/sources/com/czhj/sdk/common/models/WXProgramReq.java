...
public final class WXProgramReq extends AndroidMessage<WXProgramReq, Builder> {
    ...
    public String toString() {
        ...
        if (this.wx_api_ver != null) {
            sb.append(", wx_api_ver=").append(this.wx_api_ver);
        }
        if (this.opensdk_ver != null) {
            sb.append(", opensdk_ver=").append(this.opensdk_ver);
        }
        if (this.wx_installed != null) {
            sb.append(", wx_installed=").append(this.wx_installed);
        }
        return sb.replace(0, 2, "WXProgramReq{").append('}').toString();
    }
}

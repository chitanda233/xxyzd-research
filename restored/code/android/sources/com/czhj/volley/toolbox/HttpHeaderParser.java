...
public class HttpHeaderParser {
    ...
    static final String f2334a = "Content-Type";
    ...
    public static boolean isSupportRange(Map<String, String> map) {
        if (TextUtils.equals(getHeader(map, c.i), "bytes")) {
            return true;
        }
        String header = getHeader(map, c.f);
    ...
    public static String parseCharset(Map<String, String> map) {
        return parseCharset(map, b);
    }

    public static String parseCharset(Map<String, String> map, String str) {
        String str2 = map.get(f2334a);
        if (str2 != null) {
            String[] strArrSplit = str2.split(l.b, 0);

...
public class FileDownloader {
    ...
    public class DownloadController {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        FileDownloadRequest.FileDownloadListener f2332a;
        int b;
        ...
        DownloadController(DownloadItem downloadItem, FileDownloadRequest.FileDownloadListener fileDownloadListener) {
            this.f2332a = fileDownloadListener;
            this.e = downloadItem;
        }
        ...
        boolean a() {
            ...
            this.d = FileDownloader.this.buildRequest(this.e, new FileDownloadRequest.FileDownloadListener() { // from class: com.czhj.volley.toolbox.FileDownloader.DownloadController.1
                ...
                public void downloadProgress(DownloadItem downloadItem, long j, long j2) {
                    if (DownloadController.this.f2332a != null) {
                        DownloadController.this.f2332a.downloadProgress(downloadItem, j, j2);
                    }
                }
                ...
                public void onCancel(DownloadItem downloadItem) {
                    this.f2333a = true;
                    if (DownloadController.this.f2332a != null) {
                        DownloadController.this.f2332a.onCancel(downloadItem);
                    }
                ...
                public void onErrorResponse(DownloadItem downloadItem) {
                    if (DownloadController.this.f2332a != null && !this.f2333a) {
                        DownloadController.this.f2332a.onErrorResponse(downloadItem);
                    }
                    FileDownloader.this.a(DownloadController.this);
                }
                ...
                public void onSuccess(DownloadItem downloadItem) {
                    ...
                    if (DownloadController.this.f2332a != null && !this.f2333a) {
                        DownloadController.this.f2332a.onSuccess(downloadItem);
                    }
                    FileDownloader.this.a(DownloadController.this);
                }
            });
            this.b = 1;
            if (FileDownloader.this.f2331a == null) {
                return false;
            }
            FileDownloader.this.f2331a.add(this.d);
            return true;
        }
        ...
        public boolean discard() {
            ...
            if (i == 0) {
                ...
                FileDownloadRequest.FileDownloadListener fileDownloadListener = this.f2332a;

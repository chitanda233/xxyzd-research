    ...
    public static final class Location extends Message<Location, Builder> {
        ...
        public String toString() {
            ...
            if (this.leading_comments != null) {
                sb.append(", leading_comments=").append(this.leading_comments);
            }
            if (this.trailing_comments != null) {
                sb.append(", trailing_comments=").append(this.trailing_comments);
            }
            if (!this.leading_detached_comments.isEmpty()) {
                sb.append(", leading_detached_comments=").append(this.leading_detached_comments);
            }

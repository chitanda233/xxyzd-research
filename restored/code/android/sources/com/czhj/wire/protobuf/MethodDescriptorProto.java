...
public final class MethodDescriptorProto extends Message<MethodDescriptorProto, Builder> {
    ...
    public String toString() {
        ...
        if (this.input_type != null) {
            sb.append(", input_type=").append(this.input_type);
        }
        if (this.output_type != null) {
            sb.append(", output_type=").append(this.output_type);
        }
        if (this.options != null) {
            sb.append(", options=").append(this.options);
        }
        if (this.client_streaming != null) {
            sb.append(", client_streaming=").append(this.client_streaming);
        }
        if (this.server_streaming != null) {
            sb.append(", server_streaming=").append(this.server_streaming);
        }

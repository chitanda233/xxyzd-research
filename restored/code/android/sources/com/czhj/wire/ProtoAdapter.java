...
public abstract class ProtoAdapter<E> {
    ...
    private static final class MapEntryProtoAdapter<K, V> extends ProtoAdapter<Map.Entry<K, V>> {
        ...
        public void encode(ProtoWriter protoWriter, Map.Entry<K, V> entry) throws IOException {
            this.f2360a.encodeWithTag(protoWriter, 1, entry.getKey());
            this.b.encodeWithTag(protoWriter, 2, entry.getValue());
        }

        @Override // com.czhj.wire.ProtoAdapter
        public int encodedSize(Map.Entry<K, V> entry) {
            return this.f2360a.encodedSizeWithTag(1, entry.getKey()) + this.b.encodedSizeWithTag(2, entry.getValue());
        }
    }
    ...
    private static final class MapProtoAdapter<K, V> extends ProtoAdapter<Map<K, V>> {
        ...
        public Map<K, V> decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (iNextTag == 1) {
                    kDecode = this.f2361a.f2360a.decode(protoReader);
                } else if (iNextTag == 2) {
                    vDecode = this.f2361a.b.decode(protoReader);
                }
            }
        ...
        public void encodeWithTag(ProtoWriter protoWriter, int i, Map<K, V> map) throws IOException {
            ...
            while (it.hasNext()) {
                this.f2361a.encodeWithTag(protoWriter, i, it.next());
            }
        }
        ...
        public int encodedSizeWithTag(int i, Map<K, V> map) {
            ...
            while (it.hasNext()) {
                iEncodedSizeWithTag += this.f2361a.encodedSizeWithTag(i, it.next());
            }
    ...
    static {
        ProtoAdapter<Integer> protoAdapter = new ProtoAdapter<Integer>(FieldEncoding.FIXED32, Integer.class) { // from class: com.czhj.wire.ProtoAdapter.5
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.czhj.wire.ProtoAdapter
            public Integer decode(ProtoReader protoReader) throws IOException {
        ...
        INT64 = new ProtoAdapter<Long>(FieldEncoding.VARINT, Long.class) { // from class: com.czhj.wire.ProtoAdapter.6
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.czhj.wire.ProtoAdapter
        ...
        UINT64 = new ProtoAdapter<Long>(FieldEncoding.VARINT, Long.class) { // from class: com.czhj.wire.ProtoAdapter.7
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.czhj.wire.ProtoAdapter
            public Long decode(ProtoReader protoReader) throws IOException {
                return Long.valueOf(protoReader.readVarint64());
        ...
        SINT64 = new ProtoAdapter<Long>(FieldEncoding.VARINT, Long.class) { // from class: com.czhj.wire.ProtoAdapter.8
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.czhj.wire.ProtoAdapter
            public Long decode(ProtoReader protoReader) throws IOException {
        ...
        ProtoAdapter<Long> protoAdapter2 = new ProtoAdapter<Long>(FieldEncoding.FIXED64, Long.class) { // from class: com.czhj.wire.ProtoAdapter.9
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.czhj.wire.ProtoAdapter
            public Long decode(ProtoReader protoReader) throws IOException {
        ...
        FLOAT = new ProtoAdapter<Float>(FieldEncoding.FIXED32, Float.class) { // from class: com.czhj.wire.ProtoAdapter.10
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.czhj.wire.ProtoAdapter
        ...
        DOUBLE = new ProtoAdapter<Double>(FieldEncoding.FIXED64, Double.class) { // from class: com.czhj.wire.ProtoAdapter.11
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.czhj.wire.ProtoAdapter
        ...
        STRING = new ProtoAdapter<String>(FieldEncoding.LENGTH_DELIMITED, String.class) { // from class: com.czhj.wire.ProtoAdapter.12
            @Override // com.czhj.wire.ProtoAdapter
        ...
        BYTES = new ProtoAdapter<ByteString>(FieldEncoding.LENGTH_DELIMITED, ByteString.class) { // from class: com.czhj.wire.ProtoAdapter.13
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.czhj.wire.ProtoAdapter
    ...
    ProtoAdapter<?> withLabel(WireField.Label label) {
        if (label.a()) {
            return label.b() ? asPacked() : asRepeated();
        }
        return this;
    }
}

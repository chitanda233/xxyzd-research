...
final class RealBufferedSource implements BufferedSource {
    ...
    public InputStream inputStream() {
        return new InputStream() { // from class: com.czhj.wire.okio.RealBufferedSource.1
            ...
            public int available() throws IOException {
                if (RealBufferedSource.this.f2397a) {
            ...
            public int read() throws IOException {
                ...
                if (RealBufferedSource.this.buffer.c == 0 && RealBufferedSource.this.source.read(RealBufferedSource.this.buffer, PlaybackStateCompat.ACTION_PLAY_FROM_URI) == -1) {
                    return -1;
                }
    ...
    public int read(ByteBuffer byteBuffer) throws IOException {
        if (this.buffer.c == 0 && this.source.read(this.buffer, PlaybackStateCompat.ACTION_PLAY_FROM_URI) == -1) {
            return -1;
        }
    ...
    public int select(Options options) throws IOException {
        ...
        do {
            ...
            if (iA != -2) {
                this.buffer.skip(options.f2389a[iA].size());
                return iA;
            }
        } while (this.source.read(this.buffer, PlaybackStateCompat.ACTION_PLAY_FROM_URI) != -1);
        return -1;

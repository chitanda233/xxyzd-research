...
public class e extends AdnAdapterBaseFunction implements Bridge {
    ...
    private void a(Context context, String str) {
        ...
        this.f143a = new NativeUnifiedAD(context, str, this.c);
    ...
    private void a(Map<String, Object> map) {
        ...
        if (map != null) {
            ...
            if (!(obj instanceof Integer) || (iIntValue = ((Integer) obj).intValue()) <= 0 || (nativeUnifiedAD = this.f143a) == null) {
                return;
            }

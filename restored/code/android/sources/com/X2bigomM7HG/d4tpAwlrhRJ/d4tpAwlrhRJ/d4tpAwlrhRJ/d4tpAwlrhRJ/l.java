...
public class l extends AdnAdapterBaseFunction implements Bridge {
    ...
    private UnifiedInterstitialAD f155a;
    ...
    private void a(Context context, String str) {
        ...
        if (context instanceof Activity) {
            this.f155a = new UnifiedInterstitialAD((Activity) context, str, this.d);
    ...
    private void a(Map<String, Object> map) {
        ...
        if (map != null) {
            ...
            if (!(obj instanceof Integer) || (iIntValue = ((Integer) obj).intValue()) <= 0 || (unifiedInterstitialAD = this.f155a) == null) {
                return;
            }
    ...
    private void c(Map<String, Object> map) {
        ...
        UnifiedInterstitialAD unifiedInterstitialAD = this.f155a;

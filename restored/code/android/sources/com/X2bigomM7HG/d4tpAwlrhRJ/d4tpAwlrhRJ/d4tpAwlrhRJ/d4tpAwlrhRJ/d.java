...
public class d extends AdnAdapterBaseFunction implements Bridge {
    ...
    private NativeExpressADView f141a;
    private Function<SparseArray<Object>, Object> b;
    private volatile boolean c = false;

    public d(NativeExpressADView nativeExpressADView) {
        this.f141a = nativeExpressADView;
    }

    private void a(int i) {
        NativeExpressADView nativeExpressADView = this.f141a;
    ...
    private void a(Map<String, Object> map) {
        int iA;
        if (map == null || this.f141a == null || (iA = com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.a.a(map.get(MediationConstant.BIDDING_LOSE_REASON))) <= 0) {
            return;
        }
        this.f141a.sendLossNotification(0, iA, null);
    }
        ...
        if (i == 40022) {
            ...
            if (i == 40034) {
                ...
                if (this.f141a != null) {
                    ...
                    this.f141a.setBidECPM(iIntValue);
                }
            } else {
                if (i == 40035) {
                    t.a("ad view = " + this.f141a);
                    return (T) this.f141a;
                }
                if (i == 40011) {
                    t.a("onDestroy");

...
public class a extends AdnAdapterBaseFunction implements Bridge {
    ...
    private UnifiedBannerView f133a;
    private Function<SparseArray<Object>, Object> b;

    public a(UnifiedBannerView unifiedBannerView) {
        this.f133a = unifiedBannerView;
    }

    private void a(int i) {
        UnifiedBannerView unifiedBannerView = this.f133a;
    ...
    private void a(Map<String, Object> map) {
        int iA;
        if (map == null || this.f133a == null || (iA = com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.a.a(map.get(MediationConstant.BIDDING_LOSE_REASON))) <= 0) {
            return;
        }
        this.f133a.sendLossNotification(0, iA, null);
    }

...
public class j extends AdnAdapterBaseFunction implements Bridge {
    ...
    private UnifiedInterstitialAD f152a;
    ...
    private void a(Context context, String str) {
        ...
        if (context instanceof Activity) {
            this.f152a = new UnifiedInterstitialAD((Activity) context, str, this.d);
    ...
    private void a(String str, String str2) {
        ...
        if ((str == null && TextUtils.isEmpty(str2)) || (unifiedInterstitialAD = this.f152a) == null) {
            return;
        }
    ...
    private void a(Map<String, Object> map) {
        ...
        UnifiedInterstitialAD unifiedInterstitialAD = this.f152a;
    ...
    private void b(Map<String, Object> map) {
        ...
        if (map != null) {
            ...
            if (!(obj instanceof Integer) || (iIntValue = ((Integer) obj).intValue()) <= 0 || (unifiedInterstitialAD = this.f152a) == null) {
                return;
            }

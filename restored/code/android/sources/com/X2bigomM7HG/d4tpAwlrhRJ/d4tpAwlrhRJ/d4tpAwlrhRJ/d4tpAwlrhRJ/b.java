...
public class b extends AdnAdapterBaseFunction implements Bridge {
    ...
    private UnifiedBannerView f134a;
    private ADSize b;
    ...
    private final NativeExpressAD.NativeExpressADListener h = new NativeExpressAD.NativeExpressADListener() { // from class: com.X2bigomM7HG.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.b.2
        ...
        public void onRenderFail(NativeExpressADView nativeExpressADView) {
            ...
            b.this.a(new AdError(80001, "render fail"));
        }
    ...
    private void a(Context context, String str) {
        ...
        if (context instanceof Activity) {
            this.f134a = new UnifiedBannerView((Activity) context, str, new UnifiedBannerADListener() { // from class: com.X2bigomM7HG.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.b.1
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        if (i == 40066) {
            ...
            UnifiedBannerView unifiedBannerView = this.f134a;

...
public class c extends AdnAdapterBaseFunction implements Bridge {
    ...
    private NativeUnifiedADData f138a;
    ...
    public c(NativeUnifiedADData nativeUnifiedADData) {
        this.f138a = nativeUnifiedADData;
    }

    private void a(int i) {
        NativeUnifiedADData nativeUnifiedADData = this.f138a;
    ...
    private void a(Map<String, Object> map) {
        int iA;
        if (map == null || this.f138a == null || (iA = com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.a.a(map.get(MediationConstant.BIDDING_LOSE_REASON))) <= 0) {
            return;
        }
        this.f138a.sendLossNotification(0, iA, null);
    }
    ...
    private void i() {
        this.f138a.setNativeAdEventListener(new NativeADEventListener() { // from class: com.X2bigomM7HG.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.c.2
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        ...
        if (i == 40048) {
            NativeUnifiedADData nativeUnifiedADData2 = this.f138a;
        ...
        if (i == 40049) {
            NativeUnifiedADData nativeUnifiedADData3 = this.f138a;
        ...
        if (i == 40050) {
            NativeUnifiedADData nativeUnifiedADData4 = this.f138a;
        ...
        if (i == 40051) {
            NativeUnifiedADData nativeUnifiedADData5 = this.f138a;
        ...
        if (i == 40052) {
            NativeUnifiedADData nativeUnifiedADData6 = this.f138a;
        ...
        if (i == 40010) {
            NativeUnifiedADData nativeUnifiedADData10 = this.f138a;
        ...
        if (i == 40055) {
            ...
            NativeUnifiedADData nativeUnifiedADData11 = this.f138a;
            ...
            if ((viewGroup2 instanceof MediaView) && (nativeUnifiedADData = this.f138a) != null) {
            ...
            NativeUnifiedADData nativeUnifiedADData12 = this.f138a;
            ...
            if (i == 40021) {
                NativeUnifiedADData nativeUnifiedADData13 = this.f138a;
            ...
            if (i == 40061) {
                t.a("onResume");
                NativeUnifiedADData nativeUnifiedADData14 = this.f138a;
                if (nativeUnifiedADData14 != null) {
                    nativeUnifiedADData14.resume();
                }
            } else if (i == 40062) {
                t.a("onPause");
                NativeUnifiedADData nativeUnifiedADData15 = this.f138a;
                ...
                if (i == 40063) {
                    ...
                    NativeUnifiedADData nativeUnifiedADData16 = this.f138a;
                    if (nativeUnifiedADData16 != null) {
                        nativeUnifiedADData16.pauseAppDownload();
                    }
                } else if (i == 40064) {
                    t.a("resumeAppDownload");
                    NativeUnifiedADData nativeUnifiedADData17 = this.f138a;
                    ...
                    NativeUnifiedADData nativeUnifiedADData18 = this.f138a;
                    if (nativeUnifiedADData18 != null) {
                        nativeUnifiedADData18.negativeFeedback();
                    }
                } else if (i == 40007 && this.f138a != null) {
                    ...
                    this.f138a.setBidECPM(iIntValue2);
                }
            }
        }
        return null;

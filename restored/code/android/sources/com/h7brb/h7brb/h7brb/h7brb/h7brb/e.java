...
public class e extends MediationNativeAd {
    ...
    private void c() {
        ...
        if (isClientBidding()) {
            sparseArray.put(8016, Double.valueOf(Math.max(this.f2549a.getECPM(), 0.0d)));
        }
        sparseArray.put(8059, Integer.valueOf(p.a(this.f2549a.getInteractionType())));
        sparseArray.put(8033, true);
        notifyNativeValue(sparseArray);
        this.f2549a.setAdInteractionListener(new KsFeedAd.AdInteractionListener() { // from class: com.h7brb.h7brb.h7brb.h7brb.h7brb.e.1
        ...
        if (this.b != null) {
            ...
            this.f2549a.setVideoPlayConfig(kSAdVideoPlayConfigImpl);
        }
    }
    ...
    public void d() {
        try {
            ...
            if (this.f2549a != null) {
                ...
                if ((context != null ? this.f2549a.getFeedView(context) : null) != null) {
                    a(context);
                    return;
                }
            }
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        if (i == 6083) {
            ...
            if (i == 8142) {
            ...
            } else if (i == 8144 && p.b(this.f2549a)) {
                ...
                if (map2 != null) {
                    ...
                    if (this.f2549a != null) {
                        ...
                        this.f2549a.reportAdExposureFailed(iC, adExposureFailedReason);
                    }
                }
            }
        }

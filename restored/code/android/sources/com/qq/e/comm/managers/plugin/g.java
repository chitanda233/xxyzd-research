...
class g {
    ...
    boolean a(Context context, boolean z) {
        try {
            if (this.b.exists() && this.f3001a.exists()) {
                ...
                if (strArrSplit.length == 2) {
                    ...
                    if (c.a().a(str, this.f3001a)) {
                        ...
                        if (!this.f3001a.canWrite() && !this.f3001a.canExecute()) {
                            return this.f3001a.canRead();
                        }
                        return this.f3001a.setReadOnly();
                    }
                }
            }
    ...
    boolean a(File file, File file2, Context context) {
        ...
        if (file.equals(this.f3001a) || h.a(this.f3001a, file, context, true)) {

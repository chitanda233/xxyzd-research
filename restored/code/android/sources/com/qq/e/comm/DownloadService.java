...
public class DownloadService extends Service {
    ...
    class a implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.qq.e.comm.managers.a f2981a;
        ...
        class RunnableC0546a implements Runnable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ SVSD f2982a;

            RunnableC0546a(SVSD svsd) {
                this.f2982a = svsd;
            }
            ...
            public void run() {
                try {
                    this.f2982a.onCreate();
                    while (true) {
                        b bVar = (b) DownloadService.this.c.poll();
                        if (bVar == null) {
                            DownloadService.this.f2980a = this.f2982a;
                            return;
                        }
                        this.f2982a.onStartCommand(bVar.f2983a, bVar.b, bVar.c);
                    }
                } catch (Throwable th) {
        ...
        public void run() {
            try {
                SVSD aPKDownloadServiceDelegate = this.f2981a.c().getPOFactory().getAPKDownloadServiceDelegate(DownloadService.this);
                if (aPKDownloadServiceDelegate == null) {
                    GDTLogger.w("DownloadService初始化异常");
                } else {
                    new Handler(Looper.getMainLooper()).post(new RunnableC0546a(aPKDownloadServiceDelegate));
                }
            } catch (Throwable th) {
                GDTLogger.w("DownloadService初始化异常", th);
            }
    ...
    public IBinder onBind(Intent intent) {
        ...
        return this.f2980a.onBind(intent);
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (a(false)) {
            return this.f2980a.onStartCommand(intent, i, i2);
        }
    ...
    private boolean a(boolean z) {
        ...
        try {
            ...
            this.f2980a = aPKDownloadServiceDelegate;

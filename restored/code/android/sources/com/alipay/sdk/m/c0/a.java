...
public class a {
    ...
    public final long f = ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT;
    public boolean g = false;
    public Handler h = new c(Looper.getMainLooper());

    /* JADX INFO: renamed from: com.alipay.sdk.m.c0.a$a, reason: collision with other inner class name */
    public class RunnableC0035a implements Runnable {
        ...
        public void run() {
            if (a.this.f251a == null) {
                a aVar = a.this;
                a aVar2 = a.this;
                aVar.f251a = aVar2.new d(aVar2.b);
                a.this.f251a.setCancelable(a.this.g);
            }
            try {
                if (a.this.f251a.isShowing()) {
                    return;
                }
                a.this.f251a.show();
                a.this.h.sendEmptyMessageDelayed(1, ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT);
            } catch (Exception e) {
                g.a(e);
            }
        }
    ...
    public class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (a.this.f251a == null || !a.this.f251a.isShowing()) {
                return;
            }
            try {
                a.this.h.removeMessages(1);
                a.this.f251a.dismiss();
            } catch (Exception e) {
                g.a(e);
            }
        }
    ...
    public class d extends AlertDialog {
        ...
        public final View a(Context context) {
            ...
            imageView.setImageDrawable(a(context, a.i, 480));
            ...
            textView.setText(TextUtils.isEmpty(a.this.c) ? context.getString(R.string.alipay_standard_sdk_loading) : a.this.c);
        ...
        public final Drawable a(Context context, String str, int i) {
            ...
            try {
                byteArrayInputStream = new ByteArrayInputStream(com.alipay.sdk.m.p.a.a(str));
                try {

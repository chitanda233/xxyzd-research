...
public class e implements com.alipay.sdk.m.c.b {
    ...
    public static final String f277a = "content://cn.nubia.provider.deviceid.dataid/oaid";
    ...
    public String a(Context context) {
        ...
        Cursor cursorQuery = context.getContentResolver().query(Uri.parse(f277a), null, null, null, null);
        if (cursorQuery != null) {

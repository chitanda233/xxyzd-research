...
public final class a {
    ...
    public static final int f333a = 128;
    ...
    public static String a(byte[] bArr) {
        ...
        while (i4 < i3) {
            ...
            int i13 = b3 >> 4;
            if (i12 != 0) {
                i13 ^= MediaPlayer.MEDIA_PLAYER_OPTION_GET_PLAY_WASTE_DATA;
            }
            byte b8 = (byte) i13;
            int i14 = (b4 & ByteCompanionObject.MIN_VALUE) == 0 ? b4 >> 6 : (b4 >> 6) ^ MediaPlayer.MEDIA_PLAYER_OPTION_HW_DEC_DROP_NON_REF;
            int i15 = i6 + 1;
            char[] cArr2 = j;
            cArr[i6] = cArr2[b7];
            int i16 = i15 + 1;
        ...
        if (i2 == 8) {
            ...
            int i23 = b11 >> 2;
            if (i22 != 0) {
                i23 ^= MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT;
            }
            byte b15 = (byte) i23;
            int i24 = b12 & ByteCompanionObject.MIN_VALUE;
            int i25 = b12 >> 4;
            if (i24 != 0) {
                i25 ^= MediaPlayer.MEDIA_PLAYER_OPTION_GET_PLAY_WASTE_DATA;
            }
            int i26 = i6 + 1;
            char[] cArr4 = j;
            cArr[i6] = cArr4[b15];

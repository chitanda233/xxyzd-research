...
public class b {
    ...
    public static final String f322a = "OpenIdHelper";
    ...
    public static final boolean a() {
        ...
        try {
            ...
            Log.e(f322a, "ActivityThread:currentApplication --> " + e.toString());
        }
        if (context == null) {
            return false;
        }
    ...
    public static String c(Context context) {
        f fVarA = f.a();
        return fVarA.a(context.getApplicationContext(), fVarA.f325a);
    }

...
public interface a extends IInterface {
    ...
    public static abstract class AbstractBinderC0052a extends Binder implements a {
        ...
        public static final String f368a = "com.zui.deviceidservice.IDeviceidInterface";
        ...
        public static a a(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(f368a);
        ...
        public static class C0053a implements a {
            ...
            public String a() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(AbstractBinderC0052a.f368a);
                    this.f369a.transact(1, parcelObtain, parcelObtain2, 0);
            ...
            public String b() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(AbstractBinderC0052a.f368a);
                    this.f369a.transact(2, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    return parcelObtain2.readString();
                } finally {
                    parcelObtain2.recycle();
            ...
            public boolean c() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(AbstractBinderC0052a.f368a);
                    this.f369a.transact(3, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
            ...
            public String d() {
                return AbstractBinderC0052a.f368a;
            }
            ...
            public String a(String str) throws RemoteException {
                ...
                try {
                    ...
                    this.f369a.transact(5, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    return parcelObtain2.readString();
                } finally {
                    parcelObtain2.recycle();
            ...
            public String b(String str) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(AbstractBinderC0052a.f368a);
                    parcelObtain.writeString(str);
                    this.f369a.transact(4, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    return parcelObtain2.readString();
                } finally {
                    parcelObtain2.recycle();
            ...
            public boolean c(String str) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(AbstractBinderC0052a.f368a);
                    parcelObtain.writeString(str);
                    this.f369a.transact(6, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    return parcelObtain2.readInt() != 0;
                } finally {
                    parcelObtain2.recycle();

...
public class b {
    ...
    public com.alipay.sdk.m.v0.a b;
    public ServiceConnection c;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public Context f374a = null;
    public InterfaceC0055b d = null;
    ...
    public class a implements ServiceConnection {
        ...
        public synchronized void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            b.this.b = com.alipay.sdk.m.v0.a.AbstractBinderC0052a.a(iBinder);
            if (b.this.d != null) {
    ...
    public String b() {
        ...
        try {
            com.alipay.sdk.m.v0.a aVar = this.b;
            if (aVar != null) {
                return aVar.a();
            }
            return null;
    ...
    public void f() {
        try {
            this.f374a.unbindService(this.c);
    ...
    public int a(Context context, InterfaceC0055b<String> interfaceC0055b) {
        if (context != null) {
            this.f374a = context;
            ...
            if (this.f374a.bindService(intent, this.c, 1)) {

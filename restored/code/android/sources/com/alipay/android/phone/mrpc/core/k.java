...
public final class k {
    ...
    private static final Pattern f188a = Pattern.compile("([0-9]{1,2})[- ]([A-Za-z]{3,9})[- ]([0-9]{2,4})[ ]([0-9]{1,2}:[0-9][0-9]:[0-9][0-9])");
    ...
    public static long a(String str) {
        ...
        int i2;
        int i3;
        Matcher matcher = f188a.matcher(str);
        if (matcher.find()) {
        ...
        time.set(aVarE.c, aVarE.b, aVarE.f189a, i, i2, i3);
    ...
    private static a e(String str) {
        ...
        int i3 = i2 + 1;
        int i4 = i3 + 1 + 1;
        return new a(iCharAt, ((str.charAt(i2) - '0') * 10) + (str.charAt(i3) - '0'), ((str.charAt(i4) - '0') * 10) + (str.charAt(i4 + 1) - '0'));
    }
}

...
public final class b implements HttpClient {
    ...
    public static long f180a = 160;
    private static String[] b = {"text/", "application/xml", an.d};
    ...
    public class a implements HttpRequestInterceptor {
        ...
        public void process(HttpRequest httpRequest, HttpContext httpContext) {
            C0026b c0026b = b.this.f;
            if (c0026b != null && c0026b.a() && (httpRequest instanceof HttpUriRequest)) {
                c0026b.a(b.b((HttpUriRequest) httpRequest, false));
            }
        }
    }
    ...
    public static class C0026b {
        ...
        public void a(String str) {
            Log.println(this.b, this.f182a, str);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public boolean a() {
            return Log.isLoggable(this.f182a, this.b);
        }
    }
    ...
    public static b a(String str, Context context) {
        ...
        schemeRegistry.register(new Scheme("https", SSLCertificateSocketFactory.getHttpSocketFactory(KSImageLoader.InnerImageLoadingListener.MAX_DURATION, context == null ? null : new SSLSessionCache(context)), 443));
    ...
    public static String b(HttpUriRequest httpUriRequest, boolean z) throws IOException {
        ...
        for (Header header : httpUriRequest.getAllHeaders()) {
            if (z || (!header.getName().equals("Authorization") && !header.getName().equals(com.sigmob.sdk.base.e.f3213a))) {
                sb.append("--header \"");

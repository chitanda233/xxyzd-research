...
public class MainMdidSdk implements IIdentifierListener {
    ...
    /* JADX INFO: renamed from: com.bun.miitmdid.core.MainMdidSdk$1, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$com$bun$miitmdid$content$ProviderList$DEVICE_PROVIDER;

        static {
            int[] iArr = new int[ProviderList.DEVICE_PROVIDER.values().length];
    ...
    private int _InnerFailed(int i, IdSupplier idSupplier) {
        return ((Integer) Utils.rL(new Object[]{this, Integer.valueOf(i), idSupplier, 24, 1594371206300L})).intValue();
    }

    public int OnInit(Context context, IIdentifierListener iIdentifierListener) {
        return ((Integer) Utils.rL(new Object[]{this, context, iIdentifierListener, 25, 1594371206301L})).intValue();
    }

    @Override // com.bun.miitmdid.interfaces.IIdentifierListener
    public void OnSupport(boolean z, IdSupplier idSupplier) {
        Utils.rL(new Object[]{this, Boolean.valueOf(z), idSupplier, 26, 1594371206302L});
    }
}

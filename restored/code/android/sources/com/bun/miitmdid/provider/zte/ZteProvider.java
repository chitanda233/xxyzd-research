...
public class ZteProvider extends BaseProvider {
    ...
    /* JADX INFO: renamed from: com.bun.miitmdid.provider.zte.ZteProvider$1, reason: invalid class name */
    ...
    public static /* synthetic */ String access$202(ZteProvider zteProvider, String str) {
        ...
        objArr[1] = zteProvider;
        objArr[2] = str;
        objArr[3] = Integer.valueOf(WorkQueueKt.MASK);
    ...
    public void doStart() {
        Utils.rL(new Object[]{this, Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE), 1594371206406L});
    }
    ...
    public void shutDown() {
        Utils.rL(new Object[]{this, Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_SIDE_DATA), 1594371206408L});
    }
}

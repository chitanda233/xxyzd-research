...
public class SceneImpl extends com.kwad.sdk.core.response.a.a implements KsScene, Serializable, Cloneable {
    ...
    public static SceneImpl covert(KsScene ksScene) {
        ...
        try {
            ...
            if (com.kwad.framework.a.a.oV.booleanValue() && bu.Xm() != null) {
                sceneImpl.query = bu.Xm();
            }
    ...
    public void setPosId(long j) {
        this.posId = j;
        this.entryScene = j;
        if (!com.kwad.framework.a.a.oV.booleanValue() || bu.getPosId() == 0) {
            return;
        }
    ...
    public void setAdNum(int i) {
        this.adNum = i;
        if (!com.kwad.framework.a.a.oV.booleanValue() || bu.Xl() == 0) {
            return;
        }
        this.adNum = (int) bu.Xl();
    }

...
public class UploadEntryNative extends NativeObject implements e {
    ...
    public final JSONObject Iq() {
        try {
            JSONObject jSONObject = new JSONObject();
            ac.putValue(jSONObject, "packageName", AppStatusNative.uploadEntryGetPackageName(this));
            ac.putValue(jSONObject, IAdInterListener.AdProdType.PRODUCT_CONTENT, com.kwad.sdk.collector.e.dk(AppStatusNative.uploadEntryGetOriginFilePath(this)));
            ac.putValue(jSONObject, "fileName", Is());
            return jSONObject;
        } catch (Throwable unused) {
            return null;
        }

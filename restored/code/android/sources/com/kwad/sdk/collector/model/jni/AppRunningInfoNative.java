...
public class AppRunningInfoNative extends NativeObject implements b<AppRunningInfoNative> {
    ...
    public String toString() {
        return "AppRunningInfo{packageName='" + c.b(this) + "', lastRunningTime=" + at(c.c(this)) + '}';
    }

    private static String at(long j) {
        return asc.format(new Date(j));
    }
    ...
    public JSONObject toJson() {
        ...
        ac.putValue(jSONObject, com.alipay.sdk.m.n.c.e, AppStatusNative.appRunningInfoGetName(this));

...
public class DownloadTask implements Serializable {
    ...
    private void initDownloadTaskParams() {
        ...
        for (Map.Entry<String, String> entry : this.mRequestHeaders.entrySet()) {
            this.mBaseDownloadTask.bS(entry.getKey());
            this.mBaseDownloadTask.x(entry.getKey(), entry.getValue());
        }
    }
    ...
    void instantiateDownloadTask() {
        String path;
        r.BS();
        com.kwad.framework.filedownloader.a aVarCf = r.bT(this.mUrl).bs(true).cf(3);
        ...
        this.mBaseDownloadTask = aVarCf.c(path, TextUtils.isEmpty(this.mDestinationFileName)).a(new com.kwad.framework.filedownloader.i() { // from class: com.kwad.sdk.DownloadTask.1
    ...
    void resume(DownloadRequest downloadRequest) {
        if (aq.isNetworkConnected(c.EK().getContext())) {
            ...
            if (!this.mBaseDownloadTask.isRunning()) {
                try {
                    if (com.kwad.framework.filedownloader.d.d.cN(this.mBaseDownloadTask.AT())) {
                        this.mBaseDownloadTask.AJ();
                    }
                    submit();
    ...
    public boolean isPaused() {
        return this.mBaseDownloadTask.AT() == -2;
    }

    public boolean isError() {
        return this.mBaseDownloadTask.AT() == -1;
    }

    public boolean isCompleted() {
        return this.mBaseDownloadTask.AT() == -3;
    }

    public boolean isInvalid() {
        return this.mBaseDownloadTask.AT() == 0;
    }
    ...
    public int getStatus() {
        return this.mBaseDownloadTask.AT();
    }
    ...
    */
    public void onConnected(com.kwad.framework.filedownloader.a r1, java.lang.String r2, boolean r3, int r4, int r5) {
        /*
            ...
            goto L2d
        L15:
            boolean r4 = com.kwad.sdk.utils.be.useStoragePermissionDisable()     // Catch: java.lang.Exception -> L28
            if (r4 != 0) goto L2c
        ...
        L2d:
            ...
            if (r2 >= 0) goto L43
            com.kwad.sdk.c r2 = com.kwad.sdk.c.EK()
            int r3 = r1.getId()
            r2.cancel(r3)
    ...
    private void onCanceled(com.kwad.framework.filedownloader.a aVar) {
        try {
            ...
            r.BS().u(getId(), this.mBaseDownloadTask.getTargetFilePath());
            releaseDownloadTask();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public boolean isErrorBecauseWifiRequired() {
        return this.mBaseDownloadTask.Ba() && isError() && (this.mBaseDownloadTask.AV() instanceof FileDownloadNetworkPolicyException);
    }
    ...
    public static class DownloadRequest implements Serializable {
        ...
        public boolean downloadEnablePause = false;
        private String mDestinationDir = c.EK().EL().getPath();

        public DownloadRequest(String str) {
            this.mAllowedNetworkTypes = 3;
            this.mDownloadUrl = str;
            NetworkInfo networkInfoDy = aq.dy(c.EK().getContext());
            if (networkInfoDy != null && networkInfoDy.getType() == 0) {
                this.mAllowedNetworkTypes = 3;
            } else {

...
public final class b extends d {
    ...
    private void a(AnrExceptionMessage anrExceptionMessage, File file) throws Throwable {
        anrExceptionMessage.mLogUUID = com.kwad.sdk.crash.utils.g.gG(file.getName());
        ...
        } else if (gA(anrExceptionMessage.mCrashDetail)) {
    ...
    private static boolean gA(String str) {
        for (String str2 : com.kwad.sdk.crash.e.Qm().Qn()) {

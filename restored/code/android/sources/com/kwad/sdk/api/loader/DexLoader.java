...
public class DexLoader {
    ...
    public static ClassLoader initDex(Context context, ClassLoader classLoader) {
        q qVarHT = r.HT();
        if (qVarHT != null) {
            qVarHT.onInit(context);
        }
        Log.w(TAG, "initDex liteApi: " + qVarHT);
        ...
        if (!dexLoadError.success()) {
            if (qVarHT != null) {
                ...
                qVarHT.reportDexLoadError(context, dexLoadError);
            }
            return null;
        }
    ...
    private static File copyAssetsToData(Context context, String str, DexLoadError dexLoadError) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                try {
                    try {
                        int iA = p.a(getTargetDexFilePath(context), inputStreamOpen, p.br(context));

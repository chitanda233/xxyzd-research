        ...
        try {
            ...
            try {
                ...
                try {
                    q qVarHT = r.HT();
                    if (qVarHT != null) {
                        qVarHT.holdSdkConfig(sdkConfig);
                    }
                    IKsAdSDK iKsAdSDKInit = Loader.get().init(contextBl, KsAdSDK.class.getClassLoader());
                    sSdk = iKsAdSDKInit;
                    ...
                    Context contextWrapContextIfNeed = Wrapper.wrapContextIfNeed(contextBl);
                    ...
                    aa.a(contextBl, sSdk);
                    com.kwad.sdk.api.loader.b.c(contextBl, sdkConfig);
                    c.pf();
            ...
            revertDynamic(th, contextBl, sdkConfig);
            return false;
        } catch (Throwable th5) {
            th5.printStackTrace();
        }

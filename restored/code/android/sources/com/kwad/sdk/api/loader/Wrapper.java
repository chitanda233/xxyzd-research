...
public class Wrapper {
    ...
    private static boolean returnUnWrappedContext(Context context) {
        ...
        if (aVar != null) {
            if (aVar.aDY.get() != context || Math.abs(System.currentTimeMillis() - aVar.aEc) >= 150) {
                ...
                a.c(aVar);
                if (aVar.aDZ >= (context instanceof Application ? 15 : 5) && needAutoUnWrap(context, aVar)) {
                    aVar.clear();
                    return true;
                }
            }
    ...
    private static boolean needAutoUnWrap(Context context, a aVar) {
        ...
        if (!containsAllElements(stackTrace, aVar.aEa)) {
            if (aVar.aEa != null) {
                aVar.clear();
                return false;
            }
    ...
    static int getThemeResId(Context context) {
        if (context instanceof ContextThemeWrapper) {
            Object obj = ApiReflect.k(context).cX("getThemeResId").get();
            if (obj != null) {

...
public final class d {
    private static final Map<Class, b> aKL = new ConcurrentHashMap();

    public static DevelopMangerComponents.DevelopValue dM(String str) {
        return null;
    }
    ...
    public static void init(Context context) {
        ArrayList<b> arrayList = new ArrayList(aKL.values());

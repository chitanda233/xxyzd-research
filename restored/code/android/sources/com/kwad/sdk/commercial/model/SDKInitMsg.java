...
public class SDKInitMsg extends com.kwad.sdk.commercial.c.a implements Serializable {
    ...
    public SDKInitMsg() {
        this.initProcess = ba.isInMainProcess(ServiceProvider.Um()) ? 1 : 2;
        this.initThread = Looper.getMainLooper() == Looper.myLooper() ? 1 : 2;
        this.intDynamicSDK = com.kwad.framework.a.a.ayP.booleanValue() ? 1 : 2;
        this.intBuildNumber = MediaPlayer.MEDIA_PLAYER_OPTION_LAST_AUDIO_DECODE_TIME;
    }

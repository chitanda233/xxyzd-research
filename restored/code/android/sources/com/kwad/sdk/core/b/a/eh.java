...
public final class eh implements com.kwad.sdk.core.d<com.kwad.components.ad.draw.a.d> {
    ...
    private static void a(com.kwad.components.ad.draw.a.d dVar, JSONObject jSONObject) {
        ...
        dVar.dK = jSONObject.optLong("resource_load_time_ms");
    }
    ...
    private static JSONObject b(com.kwad.components.ad.draw.a.d dVar, JSONObject jSONObject) {
        ...
        if (dVar.materialType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "material_type", dVar.materialType);
        }
        if (dVar.materialUrl != null && !dVar.materialUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "material_url", dVar.materialUrl);
        }
        if (dVar.dK != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "resource_load_time_ms", dVar.dK);
        }
        return jSONObject;
    }
}

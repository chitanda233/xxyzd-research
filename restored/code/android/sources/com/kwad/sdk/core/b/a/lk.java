...
public final class lk implements com.kwad.sdk.core.d<AdMatrixInfo.ShakeInfo> {
    ...
    private static void a(AdMatrixInfo.ShakeInfo shakeInfo, JSONObject jSONObject) {
        ...
        shakeInfo.title = jSONObject.optString(com.alipay.sdk.m.c0.d.w);
    ...
    private static JSONObject b(AdMatrixInfo.ShakeInfo shakeInfo, JSONObject jSONObject) {
        ...
        if (shakeInfo.title != null && !shakeInfo.title.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.alipay.sdk.m.c0.d.w, shakeInfo.title);
        }

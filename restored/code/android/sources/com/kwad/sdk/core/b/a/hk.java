...
public final class hk implements com.kwad.sdk.core.d<WebCardVideoPositionHandler.VideoPosition.KSAdJSCornerModel> {
    ...
    private static JSONObject b(WebCardVideoPositionHandler.VideoPosition.KSAdJSCornerModel kSAdJSCornerModel, JSONObject jSONObject) {
        ...
        if (kSAdJSCornerModel.topLeft != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "topLeft", kSAdJSCornerModel.topLeft);
        }
        if (kSAdJSCornerModel.topRight != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "topRight", kSAdJSCornerModel.topRight);
        }
        if (kSAdJSCornerModel.bottomRight != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "bottomRight", kSAdJSCornerModel.bottomRight);
        }
        if (kSAdJSCornerModel.bottomLeft != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "bottomLeft", kSAdJSCornerModel.bottomLeft);
        }
        return jSONObject;
    }
}

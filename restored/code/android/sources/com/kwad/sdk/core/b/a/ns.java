...
public final class ns implements com.kwad.sdk.core.d<PhotoInfo.VideoInfo> {
    ...
    private static void a(PhotoInfo.VideoInfo videoInfo, JSONObject jSONObject) {
        ...
        videoInfo.duration = jSONObject.optLong(MediationConstant.EXTRA_DURATION);
    ...
    private static JSONObject b(PhotoInfo.VideoInfo videoInfo, JSONObject jSONObject) {
        ...
        if (videoInfo.duration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediationConstant.EXTRA_DURATION, videoInfo.duration);
        }
        if (videoInfo.size != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "size", videoInfo.size);
        }
        if (videoInfo.width != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_WIDTH, videoInfo.width);
        }
        if (videoInfo.height != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_HEIGHT, videoInfo.height);
        }

...
public final class ex implements com.kwad.sdk.core.d<FeedPageInfo> {
    ...
    private static JSONObject b(FeedPageInfo feedPageInfo, JSONObject jSONObject) {
        ...
        if (feedPageInfo.loadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_type", feedPageInfo.loadType);
        }
        ...
        if (feedPageInfo.renderType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "render_type", feedPageInfo.renderType);
        }

...
public final class kz implements com.kwad.sdk.core.d<RewardWebViewInfo> {
    ...
    private static JSONObject b(RewardWebViewInfo rewardWebViewInfo, JSONObject jSONObject) {
        ...
        if (rewardWebViewInfo.source != null && !rewardWebViewInfo.source.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.sigmob.sdk.base.n.l, rewardWebViewInfo.source);
        }

...
public final class f {
    ...
    public static void a(String str, Map<String, String> map, String str2) {
        map.put(LiteKsSig1Util.PARAM_SIGNATURE, eE(generateInputString(str, str2)));
    }

    private static String generateInputString(String str, String str2) {
        Uri uri = Uri.parse(str);
        return uri.getPath() + com.alipay.sdk.m.w.a.p + getSortedQuery(uri.getQuery()) + com.alipay.sdk.m.w.a.p + str2;
    }
    ...
    private static String getSortedQuery(String str) {
        ...
        return TextUtils.join(com.alipay.sdk.m.w.a.p, strArrSplit);
    }

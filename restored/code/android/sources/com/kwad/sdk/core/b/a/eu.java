...
public final class eu implements com.kwad.sdk.core.d<FeedErrorInfo> {
    ...
    private static JSONObject b(FeedErrorInfo feedErrorInfo, JSONObject jSONObject) {
        ...
        if (feedErrorInfo.width != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_WIDTH, feedErrorInfo.width);
        }
        ...
        if (feedErrorInfo.errorType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "error_type", feedErrorInfo.errorType);
        }
        return jSONObject;
    }
}

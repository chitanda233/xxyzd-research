...
public final class eo implements com.kwad.sdk.core.d<AdStyleInfo.ExposeTagInfo> {
    ...
    private static JSONObject b(AdStyleInfo.ExposeTagInfo exposeTagInfo, JSONObject jSONObject) {
        ...
        if (exposeTagInfo.text != null && !exposeTagInfo.text.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.baidu.mobads.sdk.internal.a.b, exposeTagInfo.text);
        }
        return jSONObject;
    }
}

...
public final class hq implements com.kwad.sdk.core.d<com.kwad.components.core.page.c.a> {
    ...
    private static void a(com.kwad.components.core.page.c.a aVar, JSONObject jSONObject) {
        ...
        aVar.adM = jSONObject.optInt("neo_tk_render_type");
    }
    ...
    private static JSONObject b(com.kwad.components.core.page.c.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.adM != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "neo_tk_render_type", aVar.adM);
        }
        return jSONObject;
    }
}

...
public final class la implements com.kwad.sdk.core.d<AdMatrixInfo.RotateDegreeInfo> {
    ...
    private static JSONObject b(AdMatrixInfo.RotateDegreeInfo rotateDegreeInfo, JSONObject jSONObject) {
        ...
        if (rotateDegreeInfo.direction != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "direction", rotateDegreeInfo.direction);
        }
        return jSONObject;
    }
}

...
public final class jc implements com.kwad.sdk.core.d<NativeAdMonitor.NativeReportMsg> {
    ...
    private static void a(NativeAdMonitor.NativeReportMsg nativeReportMsg, JSONObject jSONObject) {
        ...
        nativeReportMsg.height = jSONObject.optInt(MediaFormat.KEY_HEIGHT);
        nativeReportMsg.width = jSONObject.optInt(MediaFormat.KEY_WIDTH);
    }
    ...
    private static JSONObject b(NativeAdMonitor.NativeReportMsg nativeReportMsg, JSONObject jSONObject) {
        ...
        if (nativeReportMsg.height != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_HEIGHT, nativeReportMsg.height);
        }
        if (nativeReportMsg.width != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_WIDTH, nativeReportMsg.width);
        }
        return jSONObject;
    }
}

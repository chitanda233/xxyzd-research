...
public class ImageLoadImpl implements IImageLoader {
    ...
    public void checkInit() {
        ...
        builder.taskExecutor(GlobalThreadPools.Oh());
        builder.taskExecutorForCachedImages(GlobalThreadPools.Oi());
        builder.setTaskDistributor(GlobalThreadPools.Oj());
        builder.denyCacheImageMultipleSizesInMemory();
        builder.diskCacheFileNameGenerator(new Md5FileNameGenerator());
        builder.diskCacheSize(20971520);
        builder.tasksProcessingOrder(QueueProcessingType.LIFO);
        builder.cacheParentDir(bg.ed(context).getPath());

...
public final class gv implements com.kwad.sdk.core.d<com.kwad.components.ad.interstitial.c.a> {
    ...
    private static void a(com.kwad.components.ad.interstitial.c.a aVar, JSONObject jSONObject) {
        ...
        aVar.mr = jSONObject.optInt("aggregateAdShowCount");
    }
    ...
    private static JSONObject b(com.kwad.components.ad.interstitial.c.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.mr != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "aggregateAdShowCount", aVar.mr);
        }
        return jSONObject;
    }
}

...
public final class md implements com.kwad.sdk.core.d<SplashMonitorInfo> {
    ...
    private static JSONObject b(SplashMonitorInfo splashMonitorInfo, JSONObject jSONObject) {
        ...
        if (splashMonitorInfo.count != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "count", splashMonitorInfo.count);
        }
        ...
        if (splashMonitorInfo.size != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "size", splashMonitorInfo.size);
        }
        ...
        if (splashMonitorInfo.updateType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "update_type", splashMonitorInfo.updateType);
        }
        ...
        if (splashMonitorInfo.loadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_type", splashMonitorInfo.loadType);
        }

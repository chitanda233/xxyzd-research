...
public final class ms implements com.kwad.sdk.core.d<AdMatrixInfo.StyleInfo> {
    ...
    private static void a(AdMatrixInfo.StyleInfo styleInfo, JSONObject jSONObject) {
        ...
        styleInfo.title = jSONObject.optString(com.alipay.sdk.m.c0.d.w);
    ...
    private static JSONObject b(AdMatrixInfo.StyleInfo styleInfo, JSONObject jSONObject) {
        ...
        if (styleInfo.title != null && !styleInfo.title.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.alipay.sdk.m.c0.d.w, styleInfo.title);
        }
        return jSONObject;
    }
}

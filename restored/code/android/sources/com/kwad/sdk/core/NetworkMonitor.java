...
public final class NetworkMonitor {
    ...
    private final List<a> aKR;
    private final WeakHashMap<a, AdTemplate> aKS;
    private final Map<a, AdTemplate> aKT;
    private boolean aKU;
    private final BroadcastReceiver aKV;
    ...
    private synchronized void bJ(Context context) {
        ...
        try {
            context.getApplicationContext().registerReceiver(this.aKV, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
            aKQ = true;
        } catch (Throwable th) {

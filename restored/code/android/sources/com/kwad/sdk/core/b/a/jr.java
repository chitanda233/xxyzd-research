...
public final class jr implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.p> {
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.p pVar, JSONObject jSONObject) {
        ...
        if (pVar.scene != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "scene", pVar.scene);
        }
        return jSONObject;
    }
}

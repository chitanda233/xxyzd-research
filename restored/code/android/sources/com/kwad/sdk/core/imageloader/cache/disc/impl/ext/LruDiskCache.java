...
public class LruDiskCache implements DiskCache {
    ...
    public File get(String str) throws Throwable {
        ...
        File fileEl = null;
        try {
            cVarEl = this.cache.el(getKey(str));
            if (cVarEl != null) {
                try {
                    try {
                        fileEl = cVarEl.el(0);
    ...
    public boolean save(String str, InputStream inputStream, IoUtils.CopyListener copyListener) {
        a.C0505a c0505aEm = this.cache.em(getKey(str));
        if (c0505aEm == null) {
            return false;
        }
        BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(c0505aEm.ei(0), this.bufferSize);
        try {
    ...
    public void clear() {
        ...
        try {
            initCache(this.cache.getDirectory(), this.reserveCacheDir, this.cache.getMaxSize(), this.cache.LC());
        } catch (IOException e2) {
            L.e(e2);
        }
    }

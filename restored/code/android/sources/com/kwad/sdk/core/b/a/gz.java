...
public final class gz implements com.kwad.sdk.core.d<InterstitialRealTimeInfo> {
    ...
    private static JSONObject b(InterstitialRealTimeInfo interstitialRealTimeInfo, JSONObject jSONObject) {
        ...
        if (interstitialRealTimeInfo.renderType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "render_type", interstitialRealTimeInfo.renderType);
        }

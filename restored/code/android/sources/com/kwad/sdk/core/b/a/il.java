...
public final class il implements com.kwad.sdk.core.d<AdInfo.MaterialSize> {
    ...
    private static JSONObject b(AdInfo.MaterialSize materialSize, JSONObject jSONObject) {
        ...
        if (materialSize.width != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_WIDTH, materialSize.width);
        }
        if (materialSize.height != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_HEIGHT, materialSize.height);
        }
        return jSONObject;
    }
}

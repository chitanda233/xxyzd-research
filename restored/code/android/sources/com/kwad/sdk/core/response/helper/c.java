...
public final class c {
    ...
    public static <R extends AdResultData, T extends AdTemplate> T a(R r, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            while (it.hasNext()) {
                T t = (T) it.next();
                if (String.valueOf(e.eM(t).adBaseInfo.creativeId).equals(str)) {
                    return t;
                }
            }
        }
    ...
    public static AdInfo s(AdResultData adResultData) {
        ...
        return e.eM(firstAdTemplate);
    }

    public static AdResultData ex(AdTemplate adTemplate) {
        if (adTemplate == null) {
            return null;
        }
    ...
    public static <T extends AdResultData> AdResultData a(AdResultData adResultData, AdTemplate adTemplate) {
        ...
        AdResultData adResultDataM180clone = adResultData.m180clone();
        adResultDataM180clone.setAdTemplateList(arrayList);
        return adResultDataM180clone;
    }

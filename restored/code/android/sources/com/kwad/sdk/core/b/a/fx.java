...
public final class fx implements com.kwad.sdk.core.d<com.kwad.sdk.commercial.f.b> {
    ...
    private static void a(com.kwad.sdk.commercial.f.b bVar, JSONObject jSONObject) {
        ...
        bVar.adu = jSONObject.optInt("landing_page_type");
    ...
    private static JSONObject b(com.kwad.sdk.commercial.f.b bVar, JSONObject jSONObject) {
        ...
        if (bVar.adu != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "landing_page_type", bVar.adu);
        }

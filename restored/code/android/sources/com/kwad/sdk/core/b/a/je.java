...
public final class je implements com.kwad.sdk.core.d<AdGlobalConfigInfo.NeoScanAggregationSceneInfo> {
    ...
    private static void a(AdGlobalConfigInfo.NeoScanAggregationSceneInfo neoScanAggregationSceneInfo, JSONObject jSONObject) {
        ...
        neoScanAggregationSceneInfo.mute = jSONObject.optBoolean(com.sigmob.sdk.base.common.a.z);
    }
    ...
    private static JSONObject b(AdGlobalConfigInfo.NeoScanAggregationSceneInfo neoScanAggregationSceneInfo, JSONObject jSONObject) {
        ...
        if (neoScanAggregationSceneInfo.mute) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.sigmob.sdk.base.common.a.z, neoScanAggregationSceneInfo.mute);
        }
        return jSONObject;
    }
}

...
public final class cp implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.f> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.f fVar, JSONObject jSONObject) {
        ...
        fVar.aun = jSONObject.optInt("closeDelaySeconds");
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.f fVar, JSONObject jSONObject) {
        ...
        if (fVar.aun != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "closeDelaySeconds", fVar.aun);
        }
        return jSONObject;
    }
}

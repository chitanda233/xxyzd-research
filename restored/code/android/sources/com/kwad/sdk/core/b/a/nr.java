...
public final class nr implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.x> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.x xVar, JSONObject jSONObject) {
        ...
        xVar.auB = jSONObject.optInt("videoCloseTime", new Integer("0").intValue());
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.x xVar, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.ac.putValue(jSONObject, "videoCloseTime", xVar.auB);
        return jSONObject;
    }
}

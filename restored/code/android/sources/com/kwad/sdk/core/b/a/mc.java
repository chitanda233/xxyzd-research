...
public final class mc implements com.kwad.sdk.core.d<com.kwad.components.ad.splashscreen.local.a> {
    ...
    private static void a(com.kwad.components.ad.splashscreen.local.a aVar, JSONObject jSONObject) {
        ...
        aVar.jW = jSONObject.optInt("currentDailyCount");
    }
    ...
    private static JSONObject b(com.kwad.components.ad.splashscreen.local.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.jW != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "currentDailyCount", aVar.jW);
        }
        return jSONObject;
    }
}

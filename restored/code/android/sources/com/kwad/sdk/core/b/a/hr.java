...
public final class hr implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.m> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.m mVar, JSONObject jSONObject) {
        ...
        mVar.auu = jSONObject.optString("landingPageUrl");
        if (JSONObject.NULL.toString().equals(mVar.auu)) {
            mVar.auu = "";
        }
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.m mVar, JSONObject jSONObject) {
        ...
        if (mVar.auu != null && !mVar.auu.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "landingPageUrl", mVar.auu);
        }
        return jSONObject;
    }
}

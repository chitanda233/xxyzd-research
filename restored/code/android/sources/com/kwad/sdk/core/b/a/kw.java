...
public final class kw implements com.kwad.sdk.core.d<AdMatrixInfo.RewardVideoInteractInfo> {
    ...
    private static void a(AdMatrixInfo.RewardVideoInteractInfo rewardVideoInteractInfo, JSONObject jSONObject) {
        ...
        rewardVideoInteractInfo.duration = jSONObject.optInt(MediationConstant.EXTRA_DURATION, new Integer(PointType.SIGMOB_APP).intValue());
    ...
    private static JSONObject b(AdMatrixInfo.RewardVideoInteractInfo rewardVideoInteractInfo, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.ac.putValue(jSONObject, MediationConstant.EXTRA_DURATION, rewardVideoInteractInfo.duration);

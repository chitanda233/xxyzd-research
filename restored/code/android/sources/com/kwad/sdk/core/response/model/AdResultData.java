...
public class AdResultData extends BaseResultData implements com.kwad.sdk.core.b {
    ...
    public boolean isBidding() {
        ...
        return proceedTemplateList.size() != 0 && e.fa(proceedTemplateList.get(0)) > 0;
    }
            ...
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    ...
                    if (jSONObjectOptJSONObject != null) {
                        ...
                        com.kwad.sdk.commercial.d.a.ce(adTemplate);
                        ...
                        if (sceneImpl != null && !styleMatch(sceneImpl, adTemplate)) {
                            ...
                            com.kwad.sdk.commercial.d.a.c(adTemplate, "ad_style", String.valueOf(i2));
                        }
                    }
                }
                return;
    ...
    public String getResponseJson() {
        ...
        ac.putValue(json, "pcursor", this.pcursor);
        ac.a(json, "pageInfo", this.pageInfo);
        ac.putValue(json, "impAdInfo", ((com.kwad.sdk.core.a.e) d.f(com.kwad.sdk.core.a.e.class)).av(ac.Y(getAdTemplateList()).toString()));

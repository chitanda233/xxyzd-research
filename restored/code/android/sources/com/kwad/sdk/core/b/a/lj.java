...
public final class lj implements com.kwad.sdk.core.d<SceneImpl> {
    ...
    private static JSONObject b(SceneImpl sceneImpl, JSONObject jSONObject) {
        ...
        if (sceneImpl.width != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_WIDTH, sceneImpl.width);
        }
        if (sceneImpl.height != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_HEIGHT, sceneImpl.height);
        }

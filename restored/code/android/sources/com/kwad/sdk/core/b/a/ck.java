...
public final class ck implements com.kwad.sdk.core.d<com.kwad.sdk.core.webview.d.b.c> {
    ...
    private static JSONObject b(com.kwad.sdk.core.webview.d.b.c cVar, JSONObject jSONObject) {
        ...
        if (cVar.width != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_WIDTH, cVar.width);
        }
        if (cVar.height != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_HEIGHT, cVar.height);
        }
        return jSONObject;
    }
}

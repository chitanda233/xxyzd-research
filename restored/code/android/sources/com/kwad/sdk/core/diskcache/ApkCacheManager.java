...
public class ApkCacheManager {
    ...
    private ApkCacheManager() {
        ...
        this.aRp = new Callable<Void>() { // from class: com.kwad.sdk.core.diskcache.ApkCacheManager.1
            ...
            public Void call() {
                synchronized (ApkCacheManager.class) {
                    try {
                        try {
                            if (ApkCacheManager.this.aRn != null && ApkCacheManager.this.aRn.exists() && !ApkCacheManager.this.Lw()) {
        ...
        try {
            this.aRn = bg.ee(((f) ServiceProvider.get(f.class)).getContext());
        } catch (Throwable unused) {
        }
    }
    ...
    public final void Lx() {
        ...
        if (future == null || future.isDone()) {
            this.aEx = this.aRo.submit(this.aRp);
        }
    }

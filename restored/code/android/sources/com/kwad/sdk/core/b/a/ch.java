...
public final class ch implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.e> {
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.e eVar, JSONObject jSONObject) {
        ...
        if (eVar.height != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_HEIGHT, eVar.height);
        }
        return jSONObject;
    }
}

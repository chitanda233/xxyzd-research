...
public final class fi implements com.kwad.sdk.core.d<RewardFraudVerifyRespInfo.FraudDataInfo> {
    ...
    private static JSONObject b(RewardFraudVerifyRespInfo.FraudDataInfo fraudDataInfo, JSONObject jSONObject) {
        ...
        if (fraudDataInfo.code != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, PluginConstants.KEY_ERROR_CODE, fraudDataInfo.code);
        }
        return jSONObject;
    }
}

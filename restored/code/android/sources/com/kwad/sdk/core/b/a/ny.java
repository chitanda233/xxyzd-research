...
public final class ny implements com.kwad.sdk.core.d<WebCardVideoPositionHandler.VideoPosition> {
    ...
    private static JSONObject b(WebCardVideoPositionHandler.VideoPosition videoPosition, JSONObject jSONObject) {
        ...
        if (videoPosition.width != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_WIDTH, videoPosition.width);
        }
        if (videoPosition.height != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediaFormat.KEY_HEIGHT, videoPosition.height);
        }

...
public final class gh implements com.kwad.sdk.core.d<ImageLoaderInfo> {
    ...
    private static void a(ImageLoaderInfo imageLoaderInfo, JSONObject jSONObject) {
        ...
        imageLoaderInfo.duration = jSONObject.optDouble(MediationConstant.EXTRA_DURATION);
    }
    ...
    private static JSONObject b(ImageLoaderInfo imageLoaderInfo, JSONObject jSONObject) {
        ...
        if (imageLoaderInfo.duration != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, MediationConstant.EXTRA_DURATION, imageLoaderInfo.duration);
        }
        return jSONObject;
    }
}

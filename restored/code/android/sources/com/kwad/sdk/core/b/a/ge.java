...
public final class ge implements com.kwad.sdk.core.d<HybridLoadMsg> {
    ...
    private static JSONObject b(HybridLoadMsg hybridLoadMsg, JSONObject jSONObject) {
        ...
        if (hybridLoadMsg.loadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_type", hybridLoadMsg.loadType);
        }
        ...
        if (hybridLoadMsg.interval != null && !hybridLoadMsg.interval.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "interval", hybridLoadMsg.interval);
        }

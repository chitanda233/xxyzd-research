...
public final class co implements com.kwad.sdk.core.d<com.kwad.components.core.webview.jshandler.a.f.a> {
    ...
    private static void a(com.kwad.components.core.webview.jshandler.a.f.a aVar, JSONObject jSONObject) {
        ...
        aVar.text = jSONObject.optString(com.baidu.mobads.sdk.internal.a.b);
    ...
    private static JSONObject b(com.kwad.components.core.webview.jshandler.a.f.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.text != null && !aVar.text.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.baidu.mobads.sdk.internal.a.b, aVar.text);
        }
        return jSONObject;
    }
}

...
public final class mf implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.v> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.v vVar, JSONObject jSONObject) {
        ...
        vVar.ri = jSONObject.optInt("currentTime");
        vVar.aji = jSONObject.optBoolean("finished");
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.v vVar, JSONObject jSONObject) {
        ...
        if (vVar.ri != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "currentTime", vVar.ri);
        }
        if (vVar.aji) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "finished", vVar.aji);
        }
        return jSONObject;
    }
}

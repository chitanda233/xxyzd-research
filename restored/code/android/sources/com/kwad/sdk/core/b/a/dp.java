...
public final class dp implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.h> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.h hVar, JSONObject jSONObject) {
        ...
        hVar.auo = jSONObject.optInt("hasDeepReward");
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.h hVar, JSONObject jSONObject) {
        ...
        if (hVar.auo != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "hasDeepReward", hVar.auo);
        }
        return jSONObject;
    }
}

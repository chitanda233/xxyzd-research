...
public final class nj implements com.kwad.sdk.core.d<UaidInfo> {
    ...
    private static void a(UaidInfo uaidInfo, JSONObject jSONObject) {
        ...
        uaidInfo.traceId = jSONObject.optString(PointParamKey.TRACE_ID);
        ...
        uaidInfo.result = jSONObject.optInt(com.alipay.sdk.m.y.o.c);
        uaidInfo.token = jSONObject.optString(Constants.TOKEN);
    ...
    private static JSONObject b(UaidInfo uaidInfo, JSONObject jSONObject) {
        ...
        if (uaidInfo.traceId != null && !uaidInfo.traceId.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, PointParamKey.TRACE_ID, uaidInfo.traceId);
        }
        ...
        if (uaidInfo.result != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.alipay.sdk.m.y.o.c, uaidInfo.result);
        }
        if (uaidInfo.token != null && !uaidInfo.token.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, Constants.TOKEN, uaidInfo.token);
        }
        ...
        if (uaidInfo.errorMsg != null && !uaidInfo.errorMsg.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "error_msg", uaidInfo.errorMsg);
        }
        return jSONObject;
    }
}

...
public final class cb {
    public static boolean r(View view, int i) {
        return view != null && b(view, i, true) && view.hasWindowFocus() && dK(view.getContext());
    }

    public static boolean a(View view, int i, boolean z) {
        return view != null && b(view, i, z) && dK(view.getContext());
    }

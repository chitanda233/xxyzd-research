...
public final class SystemUtil {
    ...
    public static long WN() throws Throwable {
    ...
    public static a WO() throws Throwable {
        String strAC;
        a aVar = new a();
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(line)) {
                        if (line.startsWith("VmSize") && line.contains("kB")) {
                            String strAC2 = aC(line, "VmSize");
                            if (strAC2 != null) {
                                aVar.bqL = Long.valueOf(strAC2).longValue();
                            }
                        } else if (line.startsWith("VmRSS:") && line.contains("kB")) {
                            String strAC3 = aC(line, "VmRSS:");
                            if (strAC3 != null) {
                                aVar.bqM = Long.valueOf(strAC3).longValue();
                            }
                        } else if (line.startsWith("Threads:") && (strAC = aC(line, "Threads:")) != null) {
                            aVar.mThreadsCount = Integer.valueOf(strAC).intValue();
                        }
                    }

...
public final class d extends com.kwad.framework.filedownloader.c.b.a implements com.kwad.framework.filedownloader.message.e.b, i {
    private final RemoteCallbackList<com.kwad.framework.filedownloader.c.a> aDf = new RemoteCallbackList<>();
    private final g aDg;
    ...
    private synchronized int v(MessageSnapshot messageSnapshot) {
        ...
        iBeginBroadcast = this.aDf.beginBroadcast();
        for (int i = 0; i < iBeginBroadcast; i++) {
            try {
                try {
                    ((com.kwad.framework.filedownloader.c.a) this.aDf.getBroadcastItem(i)).q(messageSnapshot);
                } catch (Throwable th) {
                    this.aDf.finishBroadcast();
                    throw th;
                }
            } catch (RemoteException e) {
                com.kwad.framework.filedownloader.f.d.a(this, e, "callback error", new Object[0]);
                remoteCallbackList = this.aDf;
    ...
    d(WeakReference<FileDownloadServiceProxy> weakReference, g gVar) {
        ...
        this.aDg = gVar;
        com.kwad.framework.filedownloader.message.e.Dd().a(this);
    }

    @Override // com.kwad.framework.filedownloader.c.b
    public final void a(com.kwad.framework.filedownloader.c.a aVar) {
        this.aDf.register(aVar);
    }

    @Override // com.kwad.framework.filedownloader.c.b
    public final void b(com.kwad.framework.filedownloader.c.a aVar) {
        this.aDf.unregister(aVar);
    }
    ...
    public final void onDestroy() {
        com.kwad.framework.filedownloader.message.e.Dd().a(null);
    }

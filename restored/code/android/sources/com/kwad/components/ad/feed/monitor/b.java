...
public final class b {
    ...
    public static void a(AdTemplate adTemplate, int i, int i2, long j, String str) {
        b(new FeedPageInfo().setStatus(5).setType(adTemplate.type).setMaterialType(com.kwad.sdk.core.response.helper.a.bk(e.eM(adTemplate))).setRenderType(i).setLoadType(adTemplate.loadType).setExpectedRenderType(i2).setErrorMsg(str).setRenderDuration(j).setAdTemplate(adTemplate), (i == 2 || i == 3) ? false : true);
    }

    public static void a(int i, long j) {
        JSONObject jSONObject = new JSONObject();
        ac.putValue(jSONObject, "feedLoadOptimizeType", com.kwad.sdk.core.config.e.Jx());
        ac.putValue(jSONObject, "feedLoadOptimizeExternalEnable", com.kwad.sdk.core.config.e.JA());
        ac.putValue(jSONObject, "isExternal", o.GE().FG());
    ...
    public static void c(AdTemplate adTemplate, int i, int i2) {
        ...
        ac.putValue(jSONObject, "feedLoadOptimizeExternalEnable", com.kwad.sdk.core.config.e.JA());
        ac.putValue(jSONObject, "isExternal", o.GE().FG());
        a(new FeedPageInfo().setStatus(7).setType(adTemplate.type).setLoadType(adTemplate.loadType).setMaterialType(com.kwad.sdk.core.response.helper.a.bk(e.eM(adTemplate))).setRenderType(i).setExpectedRenderType(i2).setAbParams(jSONObject.toString()).setAdTemplate(adTemplate));
    }

    public static void a(AdTemplate adTemplate, int i, long j) {
        a(new FeedPageInfo().setStatus(8).setType(adTemplate.type).setMaterialType(com.kwad.sdk.core.response.helper.a.bk(e.eM(adTemplate))).setRenderType(i).setConvertDuration(j).setAdTemplate(adTemplate));
    }
    ...
    private static void b(com.kwad.sdk.commercial.c.a aVar, boolean z) {
        try {
            c.d(d.Iz().dm(z ? ILoggerReporter.Category.ERROR_LOG : ILoggerReporter.Category.APM_LOG).g(z ? 0.01d : 0.001d).P("ad_sdk_feed_load", "status").b(BusinessType.AD_FEED).A(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.buq));
        } catch (Exception e) {
    ...
    private static void b(com.kwad.sdk.commercial.c.a aVar) {
        try {
            c.d(d.Iz().dm(ILoggerReporter.Category.APM_LOG).g(0.01d).P("ad_sdk_feed_callback", "callback_type").b(BusinessType.AD_FEED).A(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.buq));
        } catch (Exception e) {
    ...
    public static void a(int i, AdTemplate adTemplate, String str, int i2) {
        b(new FeedPageInfo().setCallbackType(i).setMaterialType(com.kwad.sdk.core.response.helper.a.bk(e.eM(adTemplate))).setMaterialUrl(str).setRenderType(i2).setAdTemplate(adTemplate));
    }
    ...
    private static void a(String str, FeedErrorInfo feedErrorInfo, double d) {
        try {
            c.d(d.Iz().dm(ILoggerReporter.Category.ERROR_LOG).b(BusinessType.AD_FEED).P(str, "default").dn(str).a(com.kwai.adclient.kscommerciallogger.model.a.buq).A(feedErrorInfo).g(d));
        } catch (Exception e) {
    ...
    private static List<FeedPageInfo.a> c(List<KsFeedAd> list) {
        ...
        for (KsFeedAd ksFeedAd : list) {
            if (ksFeedAd instanceof com.kwad.components.ad.feed.c) {
                AdInfo adInfoEM = e.eM(((com.kwad.components.ad.feed.c) ksFeedAd).getAdTemplate());
                arrayList.add(new FeedPageInfo.a().i(com.kwad.sdk.core.response.helper.a.L(adInfoEM)).D(com.kwad.sdk.core.response.helper.a.bk(adInfoEM)).t(com.kwad.sdk.core.response.helper.a.bh(adInfoEM)));
            }
        }
        return arrayList;
    }

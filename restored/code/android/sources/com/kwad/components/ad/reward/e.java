...
public final class e {
    ...
    public final void L(AdTemplate adTemplate) {
        ...
        if (!TextUtils.isEmpty(com.kwad.sdk.core.response.helper.a.bZ(adInfoEM))) {
            M(adTemplate);
        } else {
            p.b(adTemplate, adInfoEM);
        }
    }
    ...
    static class b extends com.kwad.sdk.core.network.l<f, BaseResultData> {
        ...
        private com.kwad.sdk.core.network.o<f, BaseResultData> so = new com.kwad.sdk.core.network.o<f, BaseResultData>() { // from class: com.kwad.components.ad.reward.e.b.1
            ...
            public void onSuccess(f fVar, BaseResultData baseResultData) {
                ...
                com.kwad.components.core.p.a.vX().h(b.this.adTemplate, 0, cb.o);
            ...
            public void onError(f fVar, int i, String str) {
                ...
                com.kwad.components.core.p.a.vX().h(b.this.adTemplate, 1, str);
        ...
        /* JADX INFO: renamed from: gL, reason: merged with bridge method [inline-methods] */

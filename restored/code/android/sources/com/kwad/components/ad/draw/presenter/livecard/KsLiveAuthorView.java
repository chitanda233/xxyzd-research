...
public class KsLiveAuthorView extends FrameLayout implements cc.a {
    ...
    private View eE;
    protected View eF;
    protected ViewGroup ev;
    protected KSCornerImageView ew;
    protected KSCornerImageView ex;
    protected KSCornerImageView ey;
    protected KSCornerImageView ez;
    ...
    public void A(Context context) {
        ...
        this.eA = (TextView) findViewById(R.id.ksad_fans_count);
        this.eB = (ImageView) findViewById(R.id.ksad_author_arrow_down);
        this.eD = findViewById(R.id.ksad_origin_live_bottom_layout);
        this.eC = findViewById(R.id.ksad_top_layout);
        this.eF = findViewById(R.id.ksad_author_icon_layout);
        this.eE = findViewById(R.id.ksad_top_flag_layout);
    }

    public void j(AdTemplate adTemplate) {
        AdInfo adInfoEM = e.eM(adTemplate);
        String strCv = com.kwad.sdk.core.response.helper.a.cv(adInfoEM);
        if (!TextUtils.isEmpty(strCv)) {
            KSImageLoader.loadImage(this.ex, strCv, adTemplate);
        }
        int iBm = com.kwad.sdk.core.response.helper.a.bm(adInfoEM);
        if (com.kwad.sdk.core.response.helper.a.cY(e.eM(adTemplate))) {
            this.eA.setText("直播中");
            if (iBm == 8) {
            ...
            this.eA.setText(com.kwad.sdk.core.response.helper.a.cT(adInfoEM));
        }
    ...
    public final void a(com.kwad.components.core.widget.e eVar) {
        ...
        this.eB.setImageResource(R.drawable.ksad_draw_follow_arrow_down);
        a(eVar, this.ey.getBackground());
        a(eVar, this.ew.getBackground());
        a(eVar, this.ez.getBackground());
        a(eVar, this.ev.getBackground());
    }

    private void a(com.kwad.components.core.widget.e eVar, Drawable drawable) {
        if (drawable instanceof GradientDrawable) {
            ((GradientDrawable) drawable).setStroke(getResources().getDimensionPixelSize(R.dimen.ksad_draw_author_icon_stroke_width), eVar.Aj());
        }
    }
    ...
    public void a(Message message) {
        ...
        final Animator animatorA4 = a(this.eC, 500);

...
public class TailFrameBarAppPortraitVertical extends a {
    ...
    public final void j(AdTemplate adTemplate) {
        if (e.O(adTemplate)) {
            this.HS.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.ksad_translucent));
            this.nN.setTextColor(Color.parseColor("#FFFFFF"));
            this.Op.setTextColor(Color.parseColor("#FFFFFF"));
        } else {
            this.HS.setBackgroundColor(Color.parseColor("#E6FFFFFF"));
        }
        super.j(adTemplate);
    }
}

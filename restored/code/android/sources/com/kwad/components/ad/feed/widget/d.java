...
public final class d extends FrameLayout {
    ...
    private void B(Context context) {
        ...
        this.im = (ImageView) findViewById(R.id.ksad_inside_circle);
        this.io = (ImageView) findViewById(R.id.ksad_outside_circle);
        this.iq = (ImageView) findViewById(R.id.ksad_hand);
    }
    ...
    public final void cB() {
        ...
        Animation animation = this.it;
        if (animation != null) {
            animation.cancel();
        }
        Animation animation2 = this.iu;
        if (animation2 != null) {
            animation2.cancel();
        }
    }
    ...
    private void cC() {
        this.ir = d(this.iq);
        this.is = e(this.iq);
        this.it = a(this.im, 0.45f, com.kwad.sdk.c.a.a.a(getContext(), 34.0f));
        this.iu = a(this.io, 0.5f, com.kwad.sdk.c.a.a.a(getContext(), 50.0f));
        this.ir.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.feed.widget.d.1
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public final void onAnimationEnd(Animator animator) {
                d.this.im.startAnimation(d.this.it);
                d.this.io.startAnimation(d.this.iu);
                d.this.is.start();
            }
        });
        this.is.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.feed.widget.d.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public final void onAnimationEnd(Animator animator) {
                d.f(d.this);
                if (d.this.count >= 5) {
    ...
    private Animator d(View view) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(view, com.sigmob.sdk.base.common.a.B, 0.0f, -10.0f);
    ...
    private Animator e(View view) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(view, com.sigmob.sdk.base.common.a.B, -10.0f, 0.0f);

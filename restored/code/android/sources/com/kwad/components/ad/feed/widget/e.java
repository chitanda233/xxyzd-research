...
public final class e extends FrameLayout {
    ...
    private Animator iy;
    private com.kwad.sdk.widget.d iz;
    ...
    private void init(Context context) {
        ...
        setClickable(false);
        this.iw = findViewById(R.id.ksad_feed_shake_bg);
        this.ix = (ImageView) findViewById(R.id.ksad_feed_shake_icon);
    }
    ...
    public final void a(final AnimatorListenerAdapter animatorListenerAdapter) {
        ...
        this.ix.post(new bi() { // from class: com.kwad.components.ad.feed.widget.e.1
            @Override // com.kwad.sdk.utils.bi
            public final void doTask() {
                e eVar = e.this;
                eVar.iy = eVar.cD();
                if (e.this.iy != null) {
                    e.this.iy.addListener(animatorListenerAdapter);
                    e.this.iy.start();
                } else {
    ...
    public Animator cD() {
        View view = this.iw;
        if (view == null || this.ix == null || view.getWidth() + this.iw.getHeight() == 0 || this.ix.getWidth() + this.ix.getHeight() == 0) {
            return null;
        }
        Animator animatorCE = cE();
        Animator animatorA = a(this.ix, 100L, 16.0f);
        Animator animatorCF = cF();
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.playSequentially(animatorCE, animatorA, animatorCF);
        return animatorSet;
    }
    ...
    private Animator a(View view, long j, float f) {
        ...
        this.ix.setPivotX(view.getWidth());
        this.ix.setPivotY(view.getHeight());
    ...
    private Animator cE() {
        Animator animatorC = c(this.iw, com.kwad.sdk.c.a.a.a(getContext(), 128.0f));
        Animator animatorC2 = c(this.ix, com.kwad.sdk.c.a.a.a(getContext(), 71.11f));
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    private Animator cF() {
        Animator animatorF = f(this.iw);
        Animator animatorF2 = f(this.ix);
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.setDuration(500L);
    ...
    private Animator c(final View view, int i) {
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.feed.widget.e.2
            ...
            public final void onAnimationStart(Animator animator) {
                ...
                new com.kwad.sdk.widget.h(view, e.this.iz);
            }
        });
        return animatorSet;
    }

...
public class HandSlideView extends KSFrameLayout {
    ...
    static /* synthetic */ int b(HandSlideView handSlideView) {
        int i = handSlideView.EL;
        handSlideView.EL = i + 1;
        return i;
    }
    ...
    public final void init(Context context, AttributeSet attributeSet) {
        ...
        this.iq = (ImageView) findViewById(R.id.ksad_hand_slide_hand);
        this.ED = findViewById(R.id.ksad_hand_slide_tail);
        this.EF = getContext().getResources().getDimension(R.dimen.ksad_hand_slide_up);
        this.EG = getContext().getResources().getDimension(R.dimen.ksad_hand_slide_tail_height_start);
        this.EH = getContext().getResources().getDimension(R.dimen.ksad_hand_slide_tail_height_end);
    }

    public final void a(final a aVar) {
        this.started = true;
        AnimatorSet animatorSetB = b(this.iq, this.ED);
        this.EE = animatorSetB;
        animatorSetB.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.reward.widget.HandSlideView.1
            ...
            public final void onAnimationEnd(Animator animator) {
                ...
                if (HandSlideView.this.EE == null) {
                    return;
                }
                HandSlideView.b(HandSlideView.this);
                if (HandSlideView.this.EL < HandSlideView.this.EK) {
                    HandSlideView.this.EE.start();
                    return;
                }
                HandSlideView.this.EE.removeListener(this);
                a aVar2 = aVar;
                if (aVar2 != null) {
    ...
    public final void destroy() {
        this.started = false;
        AnimatorSet animatorSet = this.EE;
        if (animatorSet != null) {
    ...
    private AnimatorSet b(View view, View view2) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(view, "translationY", 0.0f, -this.EF);
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(view, com.sigmob.sdk.base.common.a.B, 30.0f);
        ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(view, "alpha", 0.0f, 1.0f);
        objectAnimatorOfFloat3.setDuration(10L);
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.EG, this.EH);
        ...
        animatorSet.setDuration(this.EI);
        ...
        animatorSet2.setDuration(this.EJ);

...
public final class i extends c {
    ...
    private final com.kwad.components.core.video.a.InterfaceC0460a f5if;
    ...
    public i(Context context) {
        super(context);
        this.f5if = new com.kwad.components.core.video.a.InterfaceC0460a() { // from class: com.kwad.components.ad.feed.widget.i.1
            ...
            public final void a(int i, al.a aVar) {
                ...
                i.this.cl();
                com.kwad.components.core.e.d.a.a(new com.kwad.components.core.e.d.a.C0428a(i.this.getContext()).aF(i.this.mAdTemplate).b(i.this.mApkDownloadHelper).aD(i3).as(z).au(true).aB(5).aC(i2).d(aVar).aw(true).a(new com.kwad.components.core.e.d.a.b() { // from class: com.kwad.components.ad.feed.widget.i.1.1

...
public final class a extends KSFrameLayout {
    ...
    private void O(Context context) {
        ...
        this.qQ = (ImageView) viewA.findViewById(R.id.rotate_line);
        this.qO = (ImageView) viewA.findViewById(R.id.rotate_phone);
        this.qP = (ImageView) viewA.findViewById(R.id.rotate_alpha_phone);
    }
    ...
    public final void fW() {
        ...
        this.qM = animatorFX;
        if (animatorFX != null) {
            animatorFX.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.nativead.e.a.1
    ...
    private Animator fX() {
        ...
        ObjectAnimator duration11 = ObjectAnimator.ofFloat(interactionView, com.sigmob.sdk.base.common.a.B, 0.0f, 0.0f).setDuration(300L);

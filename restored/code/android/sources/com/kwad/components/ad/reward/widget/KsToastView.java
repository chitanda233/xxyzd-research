...
public class KsToastView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        this.Fq = (TextView) findViewById(R.id.ksad_total_count_down_text);
    }

    public final void ak(int i) {
        if (this.Fs == null) {
            this.Fs = new Runnable() { // from class: com.kwad.components.ad.reward.widget.KsToastView.1
    ...
    public void G(int i) {
        this.Fq.setText(String.format(this.Fr, Integer.valueOf(i)));
    }

...
public final class a extends com.kwad.components.ad.reward.presenter.b {
    private AdLiveHandleClickListener em = new AdLiveHandleClickListener() { // from class: com.kwad.components.ad.reward.presenter.b.a.1
        ...
        public final void handleAdLiveClick(int i) {
            if (i == 1) {
                a.this.ub.a(1, a.this.getContext(), 115, 1);
            } else if (i == 2) {
                a.this.ub.a(1, a.this.getContext(), 117, 1);
            }
        }
    };
    ...
    public final void av() {
        super.av();
        if (this.ub.dP != null) {
            this.ub.dP.registerClickListener(this.em);
        }
    }
    ...
    public final void onUnbind() {
        super.onUnbind();
        if (this.ub.dP != null) {
            this.ub.dP.unRegisterClickListener(this.em);
        }
    }
}

...
public class NovelDownloadProgressView extends DownloadProgressView {
    ...
    protected final void or() {
        this.NX = getResources().getDrawable(R.drawable.ksad_feed_download_progress_novel);
    }

    @Override // com.kwad.components.ad.widget.DownloadProgressView
    protected final void os() {
        this.NY = getResources().getDrawable(R.drawable.ksad_feed_actionbar_before_bg);
    }
}

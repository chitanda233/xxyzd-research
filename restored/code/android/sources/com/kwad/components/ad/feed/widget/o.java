...
public final class o extends a implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    private void cp() {
        ...
        com.kwad.sdk.c.a.a.a(this, this.hO, this.iI, this.hV);
    ...
    private void d(View view, final int i) {
        if (view == this.hQ) {
            ...
            com.kwad.components.core.e.d.a.a(new com.kwad.components.core.e.d.a.C0428a(getContext()).aB(5).aC(i).aF(this.mAdTemplate).b(this.mApkDownloadHelper).aD(view == this.hV ? 1 : 2).as(view == this.hV).a(new com.kwad.components.core.e.d.a.b() { // from class: com.kwad.components.ad.feed.widget.o.1

...
public final class a {
    ...
    private static void a(String str, com.kwad.sdk.commercial.c.a aVar) {
        if (o.GE().FJ()) {
            try {
                com.kwad.sdk.commercial.c.d(com.kwad.sdk.commercial.d.Iz().dm(ILoggerReporter.Category.APM_LOG).g(0.01d).P("ad_sdk_interstitial_callback", str).b(BusinessType.AD_INTERSTITIAL).A(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.buq));
            } catch (Throwable th) {

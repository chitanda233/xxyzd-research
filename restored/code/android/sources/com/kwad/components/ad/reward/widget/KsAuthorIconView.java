...
public class KsAuthorIconView extends FrameLayout implements cc.a {
    ...
    private KSCornerImageView ew;
    private KSCornerImageView ex;
    private KSCornerImageView ey;
    private KSCornerImageView ez;
    ...
    private void A(Context context) {
        ...
        this.Ff = findViewById(R.id.ksad_fans_hot_icon);
        this.Fe = findViewById(R.id.ksad_author_btn_follow);
    ...
    public final void a(com.kwad.components.core.widget.e eVar) {
        ...
        this.eB.setImageResource(R.drawable.ksad_reward_follow_arrow_down);
    ...
    private void a(com.kwad.components.core.widget.e eVar, Drawable drawable) {
        if (drawable instanceof GradientDrawable) {
            ((GradientDrawable) drawable).setStroke(getResources().getDimensionPixelSize(R.dimen.ksad_reward_author_icon_stroke_width), eVar.Aj());
        }
    }

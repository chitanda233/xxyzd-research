...
public class KsShakeView extends KSFrameLayout {
    ...
    private void a(Context context, AttributeSet attributeSet, int i) {
        ...
        this.LE = typedArrayObtainStyledAttributes.getDimension(R.styleable.ksad_KsShakeView_ksad_outerStrokeWidth, 1.0f);
        this.LF = typedArrayObtainStyledAttributes.getColor(R.styleable.ksad_KsShakeView_ksad_outerStrokeColor, Color.parseColor("#4DFFFFFF"));
        this.LG = typedArrayObtainStyledAttributes.getColor(R.styleable.ksad_KsShakeView_ksad_solidColor, Color.parseColor("#66000000"));
        this.LD = typedArrayObtainStyledAttributes.getInteger(R.styleable.ksad_KsShakeView_ksad_shakeViewStyle, 1);
        this.LH = typedArrayObtainStyledAttributes.getColor(R.styleable.ksad_KsShakeView_ksad_innerCircleStrokeColor, Color.parseColor("#B3FFFFFF"));
        this.LI = typedArrayObtainStyledAttributes.getDimension(R.styleable.ksad_KsShakeView_ksad_innerCircleStrokeWidth, 1.0f);
        this.LK = typedArrayObtainStyledAttributes.getResourceId(R.styleable.ksad_KsShakeView_ksad_shakeIcon, R.drawable.ksad_ic_shake_hand);
        this.LJ = typedArrayObtainStyledAttributes.getDimension(R.styleable.ksad_KsShakeView_ksad_innerCirclePadding, com.kwad.sdk.c.a.a.a(context, 10.0f));
    ...
    private void nX() {
        this.ix.setImageResource(this.LK);
    }
    ...
    public final void oa() {
        ...
        Animator animatorA = a(this.ix, 100L, 16.0f);
        this.iy = animatorA;
        if (animatorA != null) {
            animatorA.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.splashscreen.widget.KsShakeView.1
                ...
                public final void onAnimationEnd(Animator animator2) {
                    ...
                    if (KsShakeView.this.LM || KsShakeView.this.iy == null) {
                        return;
                    }
                    KsShakeView.this.iy.start();
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public final void onAnimationCancel(Animator animator2) {
                    super.onAnimationCancel(animator2);
                    KsShakeView.this.ix.setRotation(0.0f);
                }
            });
            this.iy.start();
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.LD == 2) {
            ...
            canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, fMin - this.LJ, this.mPaint);
        }
    ...
    private void setInnerCirclePaint(Paint paint) {
        paint.reset();
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(this.LI);
        paint.setColor(this.LH);
        paint.setAntiAlias(true);
    }

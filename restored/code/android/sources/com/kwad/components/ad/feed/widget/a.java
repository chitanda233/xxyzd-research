...
public abstract class a extends com.kwad.components.core.widget.b<AdResultData, AdTemplate> {
    ...
    protected SimpleImageLoadingListener hM;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (a(motionEvent)) {
            if (!com.kwad.sdk.utils.b.a(this.hL, motionEvent, this.mAdTemplate)) {
                return true;
            }
            if (action == 3 && this.hK == 0) {
    ...
    private boolean a(MotionEvent motionEvent) {
        ...
        if (action == 1 || !(action != 3 || motionEvent.getX() == 0.0f || motionEvent.getY() == 0.0f)) {
            return Math.abs(motionEvent.getX() - this.hI) > 20.0f || Math.abs(motionEvent.getY() - this.hJ) > 20.0f;
        }
        return false;
    }
    ...
    public a(Context context) {
        super(context);
        this.hK = 0;
        this.hM = new SimpleImageLoadingListener() { // from class: com.kwad.components.ad.feed.widget.a.1
            @Override // com.kwad.sdk.core.imageloader.core.listener.SimpleImageLoadingListener, com.kwad.sdk.core.imageloader.core.listener.ImageLoadingListener
            public final void onLoadingFailed(String str, View view, FailReason failReason) {
                com.kwad.components.ad.feed.monitor.b.a(a.this.mAdTemplate, 2, 2, str, failReason.toString(), SystemClock.elapsedRealtime() - a.this.hH);
            }

            @Override // com.kwad.sdk.core.imageloader.core.listener.SimpleImageLoadingListener, com.kwad.sdk.core.imageloader.core.listener.ImageLoadingListener
            public final void onLoadingComplete(String str, View view, DecodedResult decodedResult) {
                com.kwad.components.ad.feed.monitor.b.a(a.this.mAdTemplate, 1, 2, str, null, SystemClock.elapsedRealtime() - a.this.hH);
            }
        };
    }

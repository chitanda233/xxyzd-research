...
public class KsButtonBorderSpreadView extends c {
    ...
    protected final void a(Context context, AttributeSet attributeSet, int i) {
        ...
        this.Ls = typedArrayObtainStyledAttributes.getResourceId(R.styleable.ksad_KsShakeView_ksad_shakeIcon, R.drawable.ksad_splash_shake_combo_border);
    ...
    protected final void nX() {
        this.Lr.setImageResource(this.Ls);
    }

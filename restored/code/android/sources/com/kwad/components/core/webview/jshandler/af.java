...
public final class af implements com.kwad.sdk.core.webview.c.a {
    ...
    private final boolean aqs = false;
    private com.kwad.sdk.core.network.l<com.kwad.components.core.request.a, AdResultData> aqt;
    ...
    public final void a(String str, com.kwad.sdk.core.webview.c.c cVar) {
        if (this.aqs) {
            AdTemplate adTemplate = this.apL.getAdTemplate();
            ...
            impInfo.sdkExtraData = com.kwad.sdk.core.response.helper.e.eV(adTemplate);
            a(impInfo, cVar);
            return;
        }
        if (this.apL.PE()) {
            ...
            cVar.b(new a(this.apL.iF()));
        }
    }

    @Override // com.kwad.sdk.core.webview.c.a
    public final void onDestroy() {
        com.kwad.sdk.core.network.l<com.kwad.components.core.request.a, AdResultData> lVar = this.aqt;
        if (lVar != null) {
            lVar.cancel();
        }
    }

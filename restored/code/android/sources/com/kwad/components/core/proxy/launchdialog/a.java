...
public final class a implements k {
    private List<k> aiW = new CopyOnWriteArrayList();
    private Map<com.kwad.components.core.proxy.a, List<c>> aiX = new HashMap();
    private com.kwad.components.core.proxy.a aiY;

    public final com.kwad.components.core.proxy.a vP() {
        return this.aiY;
    }
    ...
    private void b(k kVar) {
        if (kVar != null) {
            this.aiW.remove(kVar);
        }
    }

    public final c a(DetectEventType detectEventType) {
        List<c> list;
        com.kwad.components.core.proxy.a aVar = this.aiY;
        if (aVar == null || (list = this.aiX.get(aVar)) == null) {
            return null;
        }
        for (c cVar : list) {

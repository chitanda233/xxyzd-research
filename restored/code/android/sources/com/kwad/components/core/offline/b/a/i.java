...
public final class i implements ILifeCycle {
    private final AtomicInteger abL = new AtomicInteger(1);
    private final Map<Integer, com.kwad.sdk.core.c.d> abM = new HashMap();
    ...
    public final int registerLifeCycleListener(final ILifeCycleListener iLifeCycleListener) {
        ...
        int iIncrementAndGet = this.abL.incrementAndGet();
        this.abM.put(Integer.valueOf(iIncrementAndGet), dVar);
        return iIncrementAndGet;
    }

    @Override // com.kwad.components.offline.api.core.api.ILifeCycle
    public final void unregisterLifeCycleListener(int i) {
        com.kwad.sdk.core.c.d dVar = this.abM.get(Integer.valueOf(i));
        if (dVar != null) {
            com.kwad.sdk.core.c.b.Mh();

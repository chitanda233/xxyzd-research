...
public final class WebCardVideoPositionHandler implements com.kwad.sdk.core.webview.c.a {
    private a arS;
    private VideoPosition arR = new VideoPosition();
    ...
    public final void a(String str, com.kwad.sdk.core.webview.c.c cVar) {
        try {
            this.arR.parseJson(new JSONObject(str));
            if (this.arS != null) {
                this.jc.post(new com.kwad.sdk.utils.bi() { // from class: com.kwad.components.core.webview.jshandler.WebCardVideoPositionHandler.1
                    @Override // com.kwad.sdk.utils.bi
                    public final void doTask() {
                        WebCardVideoPositionHandler.this.arS.a(WebCardVideoPositionHandler.this.arR);
                    }
                });
            }

...
public class AdnAdapterValueSetBuilder {
    ...
    private final SparseArray<Object> f1904a;
    ...
    private static final class ValueSetImpl implements ValueSet {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final SparseArray<Object> f1905a;
        private int b;

        private ValueSetImpl(SparseArray<Object> sparseArray) {
            this.b = -1;
            this.f1905a = sparseArray;
        }
        ...
        public boolean containsKey(int i) {
            return this.f1905a.indexOfKey(i) >= 0;
        }
        ...
        public Set<Integer> keys() {
            ...
            for (int i = 0; i < size; i++) {
                hashSet.add(Integer.valueOf(this.f1905a.keyAt(i)));
            }
            this.b = hashSet.size();
            return hashSet;
        }
        ...
        public SparseArray<Object> sparseArray() {
            SparseArray<Object> sparseArray = this.f1905a;
    ...
    private AdnAdapterValueSetBuilder(SparseArray<Object> sparseArray) {
        this.f1904a = sparseArray == null ? new SparseArray<>() : sparseArray;
    }

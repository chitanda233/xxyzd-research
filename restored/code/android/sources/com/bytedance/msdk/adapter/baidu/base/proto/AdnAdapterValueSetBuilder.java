...
public class AdnAdapterValueSetBuilder {
    ...
    private final SparseArray<Object> f1825a;
    ...
    private static final class ValueSetImpl implements ValueSet {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final SparseArray<Object> f1826a;
        private int b;

        private ValueSetImpl(SparseArray<Object> sparseArray) {
            this.b = -1;
            this.f1826a = sparseArray;
        }
        ...
        public boolean containsKey(int i) {
            return this.f1826a.indexOfKey(i) >= 0;
        }
        ...
        public Set<Integer> keys() {
            ...
            for (int i = 0; i < size; i++) {
                hashSet.add(Integer.valueOf(this.f1826a.keyAt(i)));
            }
            this.b = hashSet.size();
            return hashSet;
        }
        ...
        public SparseArray<Object> sparseArray() {
            SparseArray<Object> sparseArray = this.f1826a;
    ...
    private AdnAdapterValueSetBuilder(SparseArray<Object> sparseArray) {
        this.f1825a = sparseArray == null ? new SparseArray<>() : sparseArray;
    }

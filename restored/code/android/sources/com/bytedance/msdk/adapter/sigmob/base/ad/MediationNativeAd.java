package com.bytedance.msdk.adapter.sigmob.base.ad;
...
public abstract class MediationNativeAd extends AdnAdapterBaseFunction implements Bridge {
    ...
    private MediationAdLoaderBaseFunction f1895a;
    ...
    public MediationNativeAd(MediationAdLoaderBaseFunction mediationAdLoaderBaseFunction, Function<SparseArray<Object>, Object> function) {
        this.f1895a = mediationAdLoaderBaseFunction;
        this.mGMAd = function;
        a();
    }
    ...
    public String getAdm() {
        MediationAdLoaderBaseFunction mediationAdLoaderBaseFunction = this.f1895a;
    ...
    public boolean isClientBidding() {
        return this.f1895a.isClientBidding();
    }
    ...
    public boolean isMultiBidding() {
        return this.f1895a.isMultiBidding();
    }

    public boolean isServerBidding() {
        return this.f1895a.isServerBidding();
    }

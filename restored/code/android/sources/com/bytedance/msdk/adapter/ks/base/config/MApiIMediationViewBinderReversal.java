...
public class MApiIMediationViewBinderReversal {
    ...
    public int getCallToActionId() {
        ...
        if (this.f1855a != null) {
            ...
            num = (Integer) this.f1855a.apply(sparseArray);
        } else {
            num = null;
        }
        if (num != null) {
    ...
    public Map<String, Integer> getExtras() {
        ...
        return (Map) this.f1855a.apply(sparseArray);
    }

...
public class MApiIMediationViewBinderReversal {
    ...
    public int getCallToActionId() {
        ...
        if (this.f1840a != null) {
            ...
            num = (Integer) this.f1840a.apply(sparseArray);
        } else {
            num = null;
        }
        if (num != null) {
    ...
    public Map<String, Integer> getExtras() {
        ...
        return (Map) this.f1840a.apply(sparseArray);
    }

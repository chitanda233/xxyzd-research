...
public class AdnAdapterBridgeWrapper extends AdnAdapterBaseFunction {
    ...
    private final Bridge f1903a;

    public AdnAdapterBridgeWrapper(Bridge bridge) {
        this.f1903a = bridge == null ? AdnAdapterValueSetBuilder.EMPTY_BRIDGE : bridge;
    }
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        return (T) this.f1903a.call(i, AdnAdapterValueSetBuilder.create(sparseArray).build(), cls);
    }

    @Override // com.bytedance.msdk.adapter.sigmob.base.proto.AdnAdapterBaseFunction
    public SparseArray<Object> get() {
        return AdnAdapterValueSetBuilder.converToSparseArray(this.f1903a.values());
    }

...
public abstract class MediationNativeAd extends AdnAdapterBaseFunction implements Bridge {
    ...
    private MediationAdLoaderBaseFunction f1852a;
    ...
    public MediationNativeAd(MediationAdLoaderBaseFunction mediationAdLoaderBaseFunction, Function<SparseArray<Object>, Object> function) {
        this.f1852a = mediationAdLoaderBaseFunction;
        this.mGMAd = function;
        a();
    }
    ...
    public String getAdm() {
        MediationAdLoaderBaseFunction mediationAdLoaderBaseFunction = this.f1852a;
    ...
    public boolean isClientBidding() {
        return this.f1852a.isClientBidding();
    }
    ...
    public boolean isMultiBidding() {
        return this.f1852a.isMultiBidding();
    }

    public boolean isServerBidding() {
        return this.f1852a.isServerBidding();
    }

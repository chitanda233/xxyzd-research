...
public class AdnAdapterBridgeWrapper extends AdnAdapterBaseFunction {
    ...
    private final Bridge f1860a;

    public AdnAdapterBridgeWrapper(Bridge bridge) {
        this.f1860a = bridge == null ? AdnAdapterValueSetBuilder.EMPTY_BRIDGE : bridge;
    }
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        return (T) this.f1860a.call(i, AdnAdapterValueSetBuilder.create(sparseArray).build(), cls);
    }

    @Override // com.bytedance.msdk.adapter.ks.base.proto.AdnAdapterBaseFunction
    public SparseArray<Object> get() {
        return AdnAdapterValueSetBuilder.converToSparseArray(this.f1860a.values());
    }

...
public class GoogleApiManager implements Handler.Callback {
    ...
    private long zae = ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT;
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (message.what) {
            case 1:
                this.zae = true == ((Boolean) message.obj).booleanValue() ? ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT : 300000L;

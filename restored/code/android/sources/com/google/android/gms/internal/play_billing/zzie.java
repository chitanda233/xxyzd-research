...
public enum zzie implements zzfk {
    ...
    NULL_DATA_WITH_PLAY_CANCELED_RESULT_CODE(MediaPlayer.MEDIA_PLAYER_OPTION_SINGLE_PLAY_DOWNLOAD_BYTES),
    NULL_DATA_WITH_PLAY_CANCELED_WITHOUT_COMPLETE_ACTION_RESULT_CODE(MediaPlayer.MEDIA_PLAYER_OPTION_LAZY_SEEK),
    ...
    NULL_BUNDLE_RETURNED_BY_PHONESKY(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE),
    PBL_REASON_IN_DEVELOPMENT(131),
    RUNTIME_EXCEPTION_WHEN_LAUNCHING_INTENT(MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_SIDE_DATA),
    NULL_INTENT_RETURNED_BY_PHONESKY(MediaPlayer.MEDIA_PLAYER_OPTION_DISABLE_ACCURATE_START),
    ERROR_IN_ACTIVITY_RESULT(MediaPlayer.MEDIA_PLAYER_OPTION_SET_MAX_FPS),
    MISSING_RESPONSE_CODE_IN_PHONESKY_BUNDLE(MediaPlayer.MEDIA_PLAYER_OPTION_SET_PIPE_START_OFFSET),
    BILLING_API_VERSION_NOT_SET_IN_BUNDLE(MediaPlayer.MEDIA_PLAYER_OPTION_SET_PIPE_DECLARE_LENGTH),
    RESPONSE_CODE_NOT_SET_IN_BUNDLE(MediaPlayer.MEDIA_PLAYER_OPTION_LOOP_START_TIME),
    NON_OK_CODE_RETURNED_BY_PHONESKY(MediaPlayer.MEDIA_PLAYER_OPTION_LOOP_END_TIME),
    INITIALIZE_SERVICE_CALL_EXCEPTION(MediaPlayer.MEDIA_PLAYER_OPTION_RENDER_DEVICE),
    INITIALIZE_DEAD_OBJECT_EXCEPTION(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_CODEC_ID),
    INITIALIZE_SECURITY_EXCEPTION(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_CODEC_ID),
    INITIALIZE_REMOTE_EXCEPTION(MediaPlayer.MEDIA_PLAYER_OPTION_META_DATA_INFO),
    PBL_REASON_IN_DEVELOPMENT2(MediaPlayer.MEDIA_PLAYER_OPTION_SEEK_END_ENABLE),
    PBL_REASON_IN_DEVELOPMENT3(MediaPlayer.MEDIA_PLAYER_OPTION_SPADE),
    INTENT_SENDER_EXCEPTION(MediaPlayer.MEDIA_PLAYER_OPTION_EANABLE_DROPPING_DTS_ROLLBACK),

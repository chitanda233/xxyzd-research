...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(MediaFormat.KEY_WIDTH, this.zac);
            jSONObject.put(MediaFormat.KEY_HEIGHT, this.zad);
    ...
    public WebImage(JSONObject jSONObject) throws IllegalArgumentException {
        ...
        this(uri, jSONObject.optInt(MediaFormat.KEY_WIDTH, 0), jSONObject.optInt(MediaFormat.KEY_HEIGHT, 0));
    }
}

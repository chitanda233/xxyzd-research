...
abstract class zzck<V> extends zzdf implements zzcz<V> {
    ...
    static {
        ...
        zzco zzcoVar = null;
        if (property == null || property.contains(Constants.LOG_OS)) {
            try {
        ...
        if (th2 != null) {
            zzcy zzcyVar = zzb;
            zzcyVar.zza().logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFutureState", "<clinit>", "UnsafeAtomicHelper is broken!", th);
            zzcyVar.zza().logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFutureState", "<clinit>", "AtomicReferenceFieldUpdaterAtomicHelper is broken!", th2);
        }
    }

...
public class SwappyDisplayManager implements DisplayManager.DisplayListener {
    ...
    public SwappyDisplayManager(long j, Activity activity) {
        ...
        synchronized (this) {
            ...
            this.mLooper = dVar;
            dVar.start();
            displayManager.registerDisplayListener(this, this.mLooper.f2533a);
        }
    }
    ...
    public void onDisplayChanged(int i) {
        synchronized (this) {
            ...
            if (z) {
                ...
                nOnRefreshPeriodChanged(this.mCookie, j, defaultDisplay.getAppVsyncOffsetNanos(), j - (this.mWindowManager.getDefaultDisplay().getPresentationDeadlineNanos() - C.MICROS_PER_SECOND));
            }
        }
    }
    ...
    public void terminate() {
        this.mLooper.f2533a.getLooper().quit();
    }
}

...
public class t {
    ...
    public static final String f2732a = "k";
    ...
    public long a(s sVar) {
        ...
        try {
            if (b(sVar.f2731a)) {
                jInsert = this.C.update(bg.q, contentValues, "k=" + sVar.f2731a, null);
            } else {
                contentValues.put(f2732a, Integer.valueOf(sVar.f2731a));
        ...
        try {
            ...
            if (cursorQuery != null) {
                while (cursorQuery.moveToNext()) {
                    try {
                        s sVar = new s();
                        sVar.f2731a = cursorQuery.getInt(cursorQuery.getColumnIndex(f2732a));
                        ...
                        sVar.d = cursorQuery.getString(cursorQuery.getColumnIndex(c));
    ...
    public boolean b(int i2) {
        ...
        boolean z = false;
        try {
            cursorQuery = this.C.query(bg.q, new String[]{b}, "k=" + i2, null, null, null, null);
            if (cursorQuery != null) {
                try {
    ...
    public void b() {
        ...
        try {
            ...
            for (s sVar2 : arrayList) {
                ...
                this.C.delete(bg.q, "k=" + sVar2.f2731a, null);
                if (r.b != null && !r.b.contains(Integer.valueOf(sVar2.f2731a))) {
                    dl.c(this.D.getFilesDir().getCanonicalPath() + bg.j + sVar2.f2731a);
                }
    ...
    public boolean d(int i2) {
        ...
        boolean z = false;
        try {
            cursorQuery = this.C.query(bg.q, new String[]{g}, "k=" + i2, null, null, null, null);
            if (cursorQuery != null) {
                try {
                    if (cursorQuery.moveToFirst() && cursorQuery.getInt(cursorQuery.getColumnIndex(g)) == 1) {
                        z = true;
                    }
                } catch (Throwable unused) {
                    if (cursorQuery != null && !cursorQuery.isClosed()) {

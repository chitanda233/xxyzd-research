...
public final class bq {
    ...
    public static final String f2658a = "weapon.set";
    ...
    private static void c(Context context, String str) {
        try {
            if (b(context)) {
                ...
                Settings.System.putString(contentResolver, f2658a, new StringBuilder().append(System.currentTimeMillis()).toString());
            }
        } catch (Exception unused) {
        }
    }

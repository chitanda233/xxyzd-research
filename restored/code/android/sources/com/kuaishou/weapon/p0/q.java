...
public class q {
    ...
    public static final int f2727a = 3;
        ...
        try {
            ...
            for (s sVar : this.f.a()) {
                ...
                if (canonicalPath != null) {
                    sVar.m = canonicalPath + bg.j + sVar.f2731a;
                    dl.c(sVar.m + "/lib");
                    dl.c(sVar.m);
    ...
    public void c() {
        for (s sVar : this.f.a()) {
            ...
            if ((rVarA != null ? rVarA.d(sVar.c) : null) == null) {
                a(sVar.f2731a, sVar.d, (PackageInfo) null);
            }
        }
    }
    ...
    public boolean a(s sVar, String str, String str2) {
        ...
        try {
            if (!this.f.b(sVar.f2731a)) {
                this.f.a(sVar);
            }
            r rVarA = r.a(this.e.getApplicationContext(), true);
            this.f.a(sVar.f2731a, 1);
            b(sVar.c);
            if (!rVarA.a(sVar, true)) {
                file.delete();
                a(sVar.f2731a, sVar.d, null, true, null);
                this.f.a(sVar.f2731a, 0);
                return false;
            }
            sVar = rVarA.c(sVar.e);
            if (sVar == null) {

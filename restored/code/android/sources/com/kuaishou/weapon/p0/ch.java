...
public class ch {
        ...
        try {
            ...
            if (hVarA.b(dd.G, 1) == 1) {
                ...
                if (hVarA.b(dd.K, 0) == 1 && Engine.loadSuccess) {
                    ...
                    jSONObject.put(PointType.SIGMOB_APP, apVar.b(PointType.SIGMOB_APP));
                    jSONObject.put("11", apVar.b("11"));
                    jSONObject.put("12", apVar.b("12"));
                    jSONObject.put(PointType.SIGMOB_REPORT_TRACKING, apVar.b(PointType.SIGMOB_REPORT_TRACKING));
                    jSONObject.put("14", apVar.b("14"));
                    jSONObject.put("15", apVar.b("15"));
                    jSONObject.put("16", apVar.b("16"));
                    jSONObject.put(PointType.LOAD_READY, apVar.b(PointType.LOAD_READY));
                ...
                if (hVarA.b(dd.J, 1) == 1 && Engine.loadSuccess) {
                    ...
                    i = 0;
                    jSONObject.put("52", atVar.a(this.f2675a, "52", 0));
                    ...
                    ay ayVar = new ay(this.f2675a, 200);
                ...
                if (hVarA.b(dd.M, 1) == 1) {
                    aw awVar = new aw(this.f2675a);
                    jSONObject.put("53", awVar.a(this.f2675a, "53", 1));
                ...
                if (hVarA.b(dd.N, 1) == 1) {
                    ...
                    jSONObject.put(PointType.WIND_ACTIVE, cqVar.b());
                    String strD = am.d();
                    if (!TextUtils.isEmpty(strD)) {
                        jSONObject.put("77", strD);
                    }
                    jSONObject.put("104", am.c());
                    jSONObject.put("109", dj.e(this.f2675a));
                    aj ajVar = new aj(this.f2675a);
    ...
    public String a(String str) {
        ...
        try {
            JSONObject jSONObjectA2 = new ck(str, ci.j).a(this.f2675a);

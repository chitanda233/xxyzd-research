...
public class cj {
    ...
    public JSONObject a() {
        ...
        try {
            ...
            jSONObject.put("36", ab.a(this.f2677a) ? 1 : 0);
            JSONObject jSONObjectA = ai.a(this.f2677a);
            if (jSONObjectA != null) {
                jSONObject.put("4", jSONObjectA);
            }
            z zVar = new z();
            JSONArray jSONArrayA = zVar.a(this.f2677a);
            ...
            boolean zA = acVar.a(this.f2677a);
            jSONObject.put(GlobalSetting.UNIFIED_INTERSTITIAL_HS_AD, zA ? 1 : 0);
            if (zA) {
                jSONObject.put("61", acVar.b(this.f2677a));
            }
            jSONObject.put("181", acVar.f(this.f2677a) ? 1 : 0);
            jSONObject.put("9", acVar.d(this.f2677a));
            jSONObject.put(PointType.SIGMOB_APP, acVar.e(this.f2677a));
            jSONObject.put("11", acVar.c(this.f2677a));
            ae aeVar = new ae();
            ...
            if (setA != null) {
                ...
                if (setB != null || setC != null) {
                    ...
                    jSONObject.put(PointType.SIGMOB_REPORT_TRACKING, anVar.a(this.f2677a, 13, hashSet));
                    jSONObject.put("14", anVar.a(this.f2677a, 14, hashSet));
                    jSONObject.put("15", anVar.a(this.f2677a, 15, hashSet));
                    jSONObject.put("16", anVar.a(this.f2677a, 16, hashSet));
                    jSONObject.put(PointType.LOAD_READY, anVar.a(this.f2677a, 17, hashSet));
                    jSONObject.put("18", anVar.a(this.f2677a, 18, hashSet));
                    jSONObject.put("19", anVar.a(this.f2677a, 19, hashSet));
                    jSONObject.put("20", anVar.a(this.f2677a, 20, hashSet));
                    jSONObject.put("21", anVar.a(this.f2677a, 21, hashSet));
            ...
            jSONObject2.put("03007", bt.a(this.f2677a));
            jSONObject2.put("03014", bf.g(this.f2677a));
            jSONObject2.put("03020", bt.b(this.f2677a));
            jSONObject2.put("03030", be.d(this.f2677a));
            ...
            jSONObject.put("145", ahVar.a(this.f2677a));
            jSONObject.put("132", di.a());
            jSONObject.put("133", new aj(this.f2677a).g());
            if (hVarA.b(dd.an, 1) == 1) {
                jSONObject.put("139", dj.c(this.f2677a));
                jSONObject.put("140", dj.d(this.f2677a));
            ...
            if (Engine.loadSuccess) {
                as asVar = new as(this.f2677a, 100);
                ...
                if (hVarA.b(dd.ab, 1) == 1) {
                    ...
                    aq aqVar3 = new aq(this.f2677a, 4);
                ...
                if (hVarA.b(dd.aj, 0) == 1) {
                    av avVar = new av(this.f2677a, 100);
                    ...
                    av avVar2 = new av(this.f2677a, 200);
                    jSONObject.put("173", avVar2.a("173"));
                    jSONObject.put("182", avVar2.a("182"));
                }
                if (hVarA.b(dd.Y, 1) == 1) {
                    jSONObject.put("129", new bc(this.f2677a, 4).a("129"));
                    bc bcVar = new bc(this.f2677a, 1);
                    jSONObject.put("121", bcVar.a(bcVar.a(), "121"));
                    bc bcVar2 = new bc(this.f2677a, 2);
                ...
                if (hVarA.b(dd.U, 1) == 1) {
                    az azVar = new az(this.f2677a, 100);
                    ...
                    jSONObject.put("177", new az(this.f2677a, 500).d("177"));
                }
                if ((zE || zE2) && hVarA.b(dd.W, 0) == 1) {
                    jSONObject.put("158", new az(this.f2677a, 300).b("158"));
                }
                i = 0;
                if (hVarA.b(dd.am, 0) == 1) {
                    bb bbVar = new bb(this.f2677a);
                    jSONObject.put("162", bbVar.a("162"));
                    jSONObject.put("160", bbVar.a(bbVar.a(), "160"));
                    az azVar2 = new az(this.f2677a, MediaPlayer.MEDIA_PLAYER_OPTION_USE_CODEC_POOL);
                ...
                if (hVarA.b(dd.ak, 1) == 1) {
                    ax axVar = new ax(this.f2677a, 600);
    ...
    public String a(String str) {
        ...
        try {
            JSONObject jSONObjectA2 = new ck(str, ci.j).a(this.f2677a);

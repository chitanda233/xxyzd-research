...
public final class ProductDetails {
    ...
    public static final class SubscriptionOfferDetails {
        ...
        SubscriptionOfferDetails(JSONObject jSONObject) throws JSONException {
            ...
            if (jSONObjectOptJSONObject2 != null) {
                ...
                jSONObjectOptJSONObject2.optString(d.w);
                jSONObjectOptJSONObject2.optString(c.e);
    ...
    ProductDetails(String str) throws JSONException {
        ...
        this.zze = jSONObject.optString(d.w);
        this.zzf = jSONObject.optString(c.e);
    ...
    public String toString() {
        List list = this.zzj;
        return "ProductDetails{jsonString='" + this.zza + "', parsedJson=" + this.zzb.toString() + ", productId='" + this.zzc + "', productType='" + this.zzd + "', title='" + this.zze + "', productDetailsToken='" + this.zzh + "', subscriptionOfferDetails=" + String.valueOf(list) + l.d;
    }

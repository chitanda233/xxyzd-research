...
006875478  ldr      x23, [x23, #0x508] ; GLOBAL Method$HotFix.BattleLogic.SinglePlayerSkillCreator.GetNormalSkill() @ 0x92aa970
...
0068754A4  ldr      x0, [x0, #0x1c0] ; GLOBAL Method$System.Array.IndexOf<int>() @ 0x92370c8
0068754A8  bl       #0x382bd14 ; 
0068754AC  adrp     x0, #0x8ee8000
0068754B0  ldr      x0, [x0, #0x898] ; GLOBAL LocalModels.Const_TypeInfo @ 0x91e3900
0068754B4  bl       #0x382bd14 ; 
0068754B8  adrp     x0, #0x8f08000
0068754BC  ldr      x0, [x0, #0x40] ; GLOBAL LocalModels.Bean.IChapter_TypeInfo @ 0x91e9160
0068754C0  bl       #0x382bd14 ; 
0068754C4  adrp     x0, #0x8f23000
0068754C8  ldr      x0, [x0, #0xbb0] ; GLOBAL Method$System.Collections.Generic.List<NewPlayerBoostRecord>.Add() @ 0x921eb98
0068754CC  bl       #0x382bd14 ; 
0068754D0  adrp     x0, #0x8f23000
0068754D4  ldr      x0, [x0, #0xbb8] ; GLOBAL Method$System.Collections.Generic.List<NewPlayerBoostRecord>.Clear() @ 0x921eba0
0068754D8  bl       #0x382bd14 ; 
0068754DC  adrp     x0, #0x8f08000
0068754E0  ldr      x0, [x0, #0x630] ; GLOBAL Method$System.Collections.Generic.List<int>.Contains() @ 0x921de60
0068754E4  bl       #0x382bd14 ; 
0068754E8  adrp     x0, #0x8f23000
0068754EC  ldr      x0, [x0, #0xbc0] ; GLOBAL Method$System.Collections.Generic.List<NewPlayerBoostRecord>.get_Count() @ 0x921eba8
0068754F0  bl       #0x382bd14 ; 
0068754F4  adrp     x0, #0x8f23000
0068754F8  ldr      x0, [x0, #0xbc8] ; GLOBAL Method$System.Collections.Generic.List<NewPlayerBoostRecord>.get_Item() @ 0x921ebb0
0068754FC  bl       #0x382bd14 ; 
006875500  adrp     x0, #0x8f24000
006875504  ldr      x0, [x0, #0x508] ; GLOBAL Method$HotFix.BattleLogic.SinglePlayerSkillCreator.GetNormalSkill() @ 0x92aa970
...
00687555C  ldr      x0, [x0, #0xfd8] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_BattleMgr() @ 0x923fe60
006875560  bl       #0x382bd14 ; 
006875564  mov      w8, #1
006875568  strb     w8, [x23, #0xfc4]
00687556C  adrp     x8, #0x8f05000
006875570  ldr      x8, [x8, #0xfd8] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_BattleMgr() @ 0x923fe60
006875574  ldr      x1, [x8]
...
006875628  ldr      x21, [x21, #0xbc8] ; GLOBAL Method$System.Collections.Generic.List<NewPlayerBoostRecord>.get_Item() @ 0x921ebb0
...
0068756DC  ldr      x0, [x0, #0xb98] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_InitSkillGroupCount() @ 0x923fee8
0068756E0  bl       #0x382bd14 ; 
0068756E4  mov      w8, #1
0068756E8  strb     w8, [x20, #0xb84]
0068756EC  adrp     x8, #0x8f23000
0068756F0  ldr      x8, [x8, #0xb98] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_InitSkillGroupCount() @ 0x923fee8
0068756F4  ldr      x1, [x8]
...
006875740  ldr      x0, [x0, #0xb80] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.DoInitSkillGroup() @ 0x923f8b8
006875744  bl       #0x382bd14 ; 
006875748  mov      w8, #1
00687574C  strb     w8, [x20, #0xb83]
006875750  adrp     x8, #0x8f23000
006875754  ldr      x8, [x8, #0xb80] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.DoInitSkillGroup() @ 0x923f8b8
006875758  ldr      x1, [x8]
...
0068757B4  ldr      x20, [x20, #0x40] ; GLOBAL LocalModels.Bean.IChapter_TypeInfo @ 0x91e9160
...
006875888  ldr      x8, [x8, #0x1c0] ; GLOBAL Method$System.Array.IndexOf<int>() @ 0x92370c8
00687588C  mov      w1, #3
006875890  ldr      x2, [x8]
006875894  bl       #0x47b3cd0 ; System.Array$$IndexOf<int>
006875898  tbnz     w0, #0x1f, #0x6875538
00687589C  adrp     x24, #0x8ee8000
0068758A0  ldr      x24, [x24, #0x898] ; GLOBAL LocalModels.Const_TypeInfo @ 0x91e3900
...
0068758C8  ldr      x9, [x9, #0x630] ; GLOBAL Method$System.Collections.Generic.List<int>.Contains() @ 0x921de60
...
0068758F4  ldr      x23, [x23, #0xbb0] ; GLOBAL Method$System.Collections.Generic.List<NewPlayerBoostRecord>.Add() @ 0x921eb98

...
00686E0C8  ldr      x26, [x26, #0x218] ; GLOBAL Method$HotFix.BattleLogic.HeroComponentRandomSkill.GetNormalSkill() @ 0x927f9d8
...
00686E0EC  ldr      x0, [x0, #0x898] ; GLOBAL LocalModels.Const_TypeInfo @ 0x91e3900
00686E0F0  bl       #0x382bd14 ; 
00686E0F4  adrp     x0, #0x8ee6000
00686E0F8  ldr      x0, [x0, #0xd8] ; GLOBAL Method$HotFix.BattleLogic.EntityBase<EntityCharacterData>.get_Data() @ 0x9210180
00686E0FC  bl       #0x382bd14 ; 
00686E100  adrp     x0, #0x8f23000
00686E104  ldr      x0, [x0, #0x140] ; GLOBAL Method$HotFix.BattleLogic.EntityComponentBase<EntityCharacterData, EntityHero>.get_Entity() @ 0x9210268
00686E108  bl       #0x382bd14 ; 
00686E10C  adrp     x0, #0x8f24000
00686E110  ldr      x0, [x0, #0x218] ; GLOBAL Method$HotFix.BattleLogic.HeroComponentRandomSkill.GetNormalSkill() @ 0x927f9d8
00686E114  bl       #0x382bd14 ; 
00686E118  adrp     x0, #0x8f24000
00686E11C  ldr      x0, [x0, #0x220] ; GLOBAL LevelUpSkillUpRate% @ 0x9304090
...
00686E148  ldr      x0, [x0, #0xb28] ; GLOBAL Method$HotFix.BattleLogic.PooledWorldElement.get_WorldContext() @ 0x929a6f0
00686E14C  bl       #0x382bd14 ; 
00686E150  mov      w8, #1
00686E154  strb     w8, [x26, #0xa4b]
00686E158  adrp     x27, #0x8ee5000
00686E15C  ldr      x27, [x27, #0xb28] ; GLOBAL Method$HotFix.BattleLogic.PooledWorldElement.get_WorldContext() @ 0x929a6f0
...
00686E1DC  ldr      x0, [x0, #0xb28] ; GLOBAL Method$HotFix.BattleLogic.PooledWorldElement.get_WorldContext() @ 0x929a6f0
...
00686E204  ldr      x25, [x25, #0x898] ; GLOBAL LocalModels.Const_TypeInfo @ 0x91e3900
...
00686E244  ldr      x0, [x0, #0x470] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_Table() @ 0x923ffc8
00686E248  bl       #0x382bd14 ; 
00686E24C  mov      w8, #1
00686E250  strb     w8, [x27, #0xfcc]
00686E254  adrp     x8, #0x8f06000
00686E258  ldr      x8, [x8, #0x470] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_Table() @ 0x923ffc8
00686E25C  ldr      x1, [x8]
...
00686E290  ldr      x28, [x28, #0x898] ; GLOBAL LocalModels.Const_TypeInfo @ 0x91e3900
...
00686E2F0  ldr      x0, [x0, #0x228] ; GLOBAL Method$LocalModels.Bean.Exp_exp.get_randomSkillFactor() @ 0x926a2c8
00686E2F4  bl       #0x382bd14 ; 
00686E2F8  mov      w8, #1
00686E2FC  strb     w8, [x26, #0xbb2]
00686E300  adrp     x8, #0x8f24000
00686E304  ldr      x8, [x8, #0x228] ; GLOBAL Method$LocalModels.Bean.Exp_exp.get_randomSkillFactor() @ 0x926a2c8
00686E308  ldr      x1, [x8]
...
00686E390  ldr      x8, [x8, #0x140] ; GLOBAL Method$HotFix.BattleLogic.EntityComponentBase<EntityCharacterData, EntityHero>.get_Entity() @ 0x9210268
00686E394  ldr      x1, [x8]
...
00686E3BC  ldr      x8, [x8, #0xd8] ; GLOBAL Method$HotFix.BattleLogic.EntityBase<EntityCharacterData>.get_Data() @ 0x9210180
00686E3C0  ldr      x1, [x8]
...
00686E3F4  ldr      x0, [x0, #0x2d8] ; GLOBAL Method$HotFix.BattleLogic.EntityCharacterData.get_Attribute() @ 0x9263310
00686E3F8  bl       #0x382bd14 ; 
00686E3FC  mov      w8, #1
00686E400  strb     w8, [x27, #0xa7f]
00686E404  adrp     x8, #0x8ee6000
00686E408  ldr      x8, [x8, #0x2d8] ; GLOBAL Method$HotFix.BattleLogic.EntityCharacterData.get_Attribute() @ 0x9263310
00686E40C  ldr      x1, [x8]
...
00686E434  ldr      x8, [x8, #0x220] ; GLOBAL LevelUpSkillUpRate% @ 0x9304090
...
00686E4CC  ldr      x0, [x0, #0xc8] ; GLOBAL Method$HotFix.BattleLogic.HeroComponentRandomSkill.get_AllSkills() @ 0x927faf0
00686E4D0  bl       #0x382bd14 ; 
00686E4D4  mov      w8, #1
00686E4D8  strb     w8, [x27, #0x4c7]
00686E4DC  adrp     x8, #0x8f09000
00686E4E0  ldr      x8, [x8, #0xc8] ; GLOBAL Method$HotFix.BattleLogic.HeroComponentRandomSkill.get_AllSkills() @ 0x927faf0
00686E4E4  ldr      x1, [x8]

...
0065CC854  ldr      x21, [x21, #0x878] ; GLOBAL Method$HotFix.BattleLogic.WaterfallBattleManager.OnProgressFinish() @ 0x92c8168
0065CC858  mov      x19, x0
0065CC85C  tbnz     w8, #0, #0x65cc88c
0065CC860  adrp     x0, #0x8f09000
0065CC864  ldr      x0, [x0, #0x540] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.CreateRenderEvent<ShowBossNoticeEvent>() @ 0x923f448
0065CC868  bl       #0x382bd14 ; 
0065CC86C  adrp     x0, #0x8f09000
0065CC870  ldr      x0, [x0, #0x548] ; GLOBAL Method$HotFix.BattleLogic.IRenderBridge.DispatchRenderEvent<ShowBossNoticeEvent>() @ 0x92848f8
0065CC874  bl       #0x382bd14 ; 
0065CC878  adrp     x0, #0x8f0a000
0065CC87C  ldr      x0, [x0, #0x878] ; GLOBAL Method$HotFix.BattleLogic.WaterfallBattleManager.OnProgressFinish() @ 0x92c8168
...
0065CC930  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
0065CC934  bl       #0x382bd14 ; 
0065CC938  mov      w8, #1
0065CC93C  strb     w8, [x22, #0x286]
0065CC940  adrp     x24, #0x8f07000
0065CC944  ldr      x24, [x24, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CC974  ldr      x8, [x8, #0x540] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.CreateRenderEvent<ShowBossNoticeEvent>() @ 0x923f448
...
0065CC9A4  ldr      x0, [x0, #0x308] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_RenderEventPool() @ 0x923ff98
0065CC9A8  bl       #0x382bd14 ; 
0065CC9AC  mov      w8, #1
0065CC9B0  strb     w8, [x25, #0xa61]
0065CC9B4  adrp     x8, #0x8ee6000
0065CC9B8  ldr      x8, [x8, #0x308] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_RenderEventPool() @ 0x923ff98
0065CC9BC  ldr      x1, [x8]
...
0065CCA00  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
0065CCA04  bl       #0x382bd14 ; 
0065CCA08  mov      w8, #1
0065CCA0C  strb     w8, [x21, #0x286]
0065CCA10  adrp     x23, #0x8f07000
0065CCA14  ldr      x23, [x23, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CCA44  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
0065CCA48  bl       #0x382bd14 ; 
0065CCA4C  mov      w8, #1
0065CCA50  strb     w8, [x22, #0x286]
0065CCA54  adrp     x23, #0x8f07000
0065CCA58  ldr      x23, [x23, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CCAA4  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CCAE4  ldr      x9, [x9, #0x548] ; GLOBAL Method$HotFix.BattleLogic.IRenderBridge.DispatchRenderEvent<ShowBossNoticeEvent>() @ 0x92848f8
...
0065CCB3C  ldr      x8, [x8, #0x540] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.CreateRenderEvent<ShowBossNoticeEvent>() @ 0x923f448
...
0065CCB6C  ldr      x0, [x0, #0x308] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_RenderEventPool() @ 0x923ff98
0065CCB70  bl       #0x382bd14 ; 
0065CCB74  mov      w8, #1
0065CCB78  strb     w8, [x24, #0xa61]
0065CCB7C  adrp     x8, #0x8ee6000
0065CCB80  ldr      x8, [x8, #0x308] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_RenderEventPool() @ 0x923ff98
0065CCB84  ldr      x1, [x8]
...
0065CCBD0  ldr      x0, [x0, #0xcf0] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_DropMgr() @ 0x923feb8
0065CCBD4  bl       #0x382bd14 ; 
0065CCBD8  mov      w8, #1
0065CCBDC  strb     w8, [x22, #0x287]
0065CCBE0  adrp     x24, #0x8f07000
0065CCBE4  ldr      x24, [x24, #0xcf0] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_DropMgr() @ 0x923feb8
...
0065CCC34  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CCC74  ldr      x9, [x9, #0x548] ; GLOBAL Method$HotFix.BattleLogic.IRenderBridge.DispatchRenderEvent<ShowBossNoticeEvent>() @ 0x92848f8
...
0065CCD34  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CCD78  ldr      x0, [x0, #0xcf0] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_DropMgr() @ 0x923feb8
...
0065CCDD8  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CCE1C  ldr      x0, [x0, #0xcf0] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_DropMgr() @ 0x923feb8

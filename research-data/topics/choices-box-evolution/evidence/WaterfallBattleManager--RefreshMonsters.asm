...
0065CD178  ldr      x21, [x21, #0x890] ; GLOBAL Method$HotFix.BattleLogic.WaterfallBattleManager.RefreshMonsters() @ 0x92c81a0
0065CD17C  mov      x19, x0
0065CD180  tbnz     w8, #0, #0x65cd1a4
0065CD184  adrp     x0, #0x8f09000
0065CD188  ldr      x0, [x0, #0xc08] ; GLOBAL LocalModels.Bean.IWaterfallMission_TypeInfo @ 0x91ea930
0065CD18C  bl       #0x382bd14 ; 
0065CD190  adrp     x0, #0x8f0a000
0065CD194  ldr      x0, [x0, #0x890] ; GLOBAL Method$HotFix.BattleLogic.WaterfallBattleManager.RefreshMonsters() @ 0x92c81a0
...
0065CD20C  ldr      x26, [x26, #0xc08] ; GLOBAL LocalModels.Bean.IWaterfallMission_TypeInfo @ 0x91ea930
...
0065CD26C  ldr      x24, [x24, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
0065CD270  cmp      w0, #9
...
0065CD294  ldr      x0, [x0, #0x898] ; GLOBAL Method$LocalModels.Bean.ChapterWave_Waves.get_bgMusic() @ 0x924a2e8
0065CD298  bl       #0x382bd14 ; 
0065CD29C  mov      w8, #1
0065CD2A0  strb     w8, [x22, #0x656]
0065CD2A4  adrp     x23, #0x8f0a000
0065CD2A8  ldr      x23, [x23, #0x898] ; GLOBAL Method$LocalModels.Bean.ChapterWave_Waves.get_bgMusic() @ 0x924a2e8
...
0065CD2E0  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CD328  ldr      x0, [x0, #0x898] ; GLOBAL Method$LocalModels.Bean.ChapterWave_Waves.get_bgMusic() @ 0x924a2e8
...
0065CD578  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CD5C0  ldr      x0, [x0, #0xaf0] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_MapMgr() @ 0x923ff20
0065CD5C4  bl       #0x382bd14 ; 
0065CD5C8  mov      w8, #1
0065CD5CC  strb     w8, [x21, #0xa9c]
0065CD5D0  adrp     x8, #0x8ee6000
0065CD5D4  ldr      x8, [x8, #0xaf0] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_MapMgr() @ 0x923ff20
0065CD5D8  ldr      x1, [x8]
...
0065CD610  ldr      x0, [x0, #0xd58] ; GLOBAL Method$HotFix.BattleLogic.MapManager.get_MissionData() @ 0x928e768
0065CD614  bl       #0x382bd14 ; 
0065CD618  mov      w8, #1
0065CD61C  strb     w8, [x21, #0x26f]
0065CD620  adrp     x8, #0x8f06000
0065CD624  ldr      x8, [x8, #0xd58] ; GLOBAL Method$HotFix.BattleLogic.MapManager.get_MissionData() @ 0x928e768
0065CD628  ldr      x1, [x8]
...
0065CD658  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8
...
0065CD6A0  ldr      x0, [x0, #0xe98] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_CurMissionIndex() @ 0x923fe98
0065CD6A4  bl       #0x382bd14 ; 
0065CD6A8  mov      w8, #1
0065CD6AC  strb     w8, [x22, #0x28d]
0065CD6B0  adrp     x8, #0x8f07000
0065CD6B4  ldr      x8, [x8, #0xe98] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_CurMissionIndex() @ 0x923fe98
0065CD6B8  ldr      x1, [x8]
...
0065CD6D4  ldr      x0, [x0, #0xea0] ; GLOBAL Method$HotFix.BattleLogic.BattleData.get_MissionIndex() @ 0x923c3a8
0065CD6D8  bl       #0x382bd14 ; 
0065CD6DC  mov      w8, #1
0065CD6E0  strb     w8, [x22, #0x2ab]
0065CD6E4  adrp     x8, #0x8f07000
0065CD6E8  ldr      x8, [x8, #0xea0] ; GLOBAL Method$HotFix.BattleLogic.BattleData.get_MissionIndex() @ 0x923c3a8
0065CD6EC  ldr      x1, [x8]
...
0065CD760  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext() @ 0x923ccd8

...
0065CB65C  ldr      x21, [x21, #0x7f8] ; GLOBAL Method$HotFix.BattleLogic.WaterfallBattleManager.InitNewWaveData()
0065CB660  mov      x19, x0
0065CB664  tbnz     w8, #0, #0x65cb6ac
0065CB668  adrp     x0, #0x8f0a000
0065CB66C  ldr      x0, [x0, #0x800] ; GLOBAL Method$System.Collections.Generic.Dictionary<int, WaveMissionRandomData>.Clear()
0065CB670  bl       #0x382bd14 ; 
0065CB674  adrp     x0, #0x8ee6000
0065CB678  ldr      x0, [x0, #0xd8] ; GLOBAL Method$HotFix.BattleLogic.EntityBase<EntityCharacterData>.get_Data()
0065CB67C  bl       #0x382bd14 ; 
0065CB680  adrp     x0, #0x8f09000
0065CB684  ldr      x0, [x0, #0xc08] ; GLOBAL LocalModels.Bean.IWaterfallMission_TypeInfo
0065CB688  bl       #0x382bd14 ; 
0065CB68C  adrp     x0, #0x8f0a000
0065CB690  ldr      x0, [x0, #0x808] ; GLOBAL Method$Rock.Collections.OrderedDictionary<int, int>.Clear()
0065CB694  bl       #0x382bd14 ; 
0065CB698  adrp     x0, #0x8f0a000
0065CB69C  ldr      x0, [x0, #0x7f8] ; GLOBAL Method$HotFix.BattleLogic.WaterfallBattleManager.InitNewWaveData()
...
0065CB6CC  ldr      x29, [x29, #0xc08] ; GLOBAL LocalModels.Bean.IWaterfallMission_TypeInfo
...
0065CB808  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext()
0065CB80C  bl       #0x382bd14 ; 
0065CB810  strb     w20, [x26, #0x286]
0065CB814  adrp     x20, #0x8f07000
0065CB818  ldr      x20, [x20, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext()
...
0065CB8C4  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext()
...
0065CB90C  ldr      x0, [x0, #0x470] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_Table()
0065CB910  bl       #0x382bd14 ; 
0065CB914  mov      w8, #1
0065CB918  strb     w8, [x27, #0xfcc]
0065CB91C  adrp     x22, #0x8f06000
0065CB920  ldr      x22, [x22, #0x470] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_Table()
...
0065CB974  ldr      x8, [x8, #0x808] ; GLOBAL Method$Rock.Collections.OrderedDictionary<int, int>.Clear()
0065CB978  ldr      x1, [x8]
...
0065CB9A4  ldr      x8, [x8, #0x800] ; GLOBAL Method$System.Collections.Generic.Dictionary<int, WaveMissionRandomData>.Clear()
0065CB9A8  ldr      x1, [x8]
...
0065CB9CC  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext()
...
0065CBA14  ldr      x0, [x0, #0x280] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_CurMissionId()
0065CBA18  bl       #0x382bd14 ; 
0065CBA1C  mov      w8, #1
0065CBA20  strb     w8, [x21, #0x2c3]
0065CBA24  adrp     x8, #0x8f08000
0065CBA28  ldr      x8, [x8, #0x280] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_CurMissionId()
0065CBA2C  ldr      x1, [x8]
...
0065CBA64  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext()
...
0065CBAA8  ldr      x0, [x0, #0x470] ; GLOBAL Method$HotFix.BattleLogic.BattleWorldContext.get_Table()
...
0065CBAE8  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext()
...
0065CBBB0  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext()
...
0065CBBFC  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext()
...
0065CBC44  ldr      x0, [x0, #0xc98] ; GLOBAL Method$HotFix.BattleLogic.BattleManager.get_WorldContext()
...
0065CBC84  ldr      x8, [x8, #0xd8] ; GLOBAL Method$HotFix.BattleLogic.EntityBase<EntityCharacterData>.get_Data()
...
0065CBCC4  ldr      x0, [x0, #0x2d8] ; GLOBAL Method$HotFix.BattleLogic.EntityCharacterData.get_Attribute()
0065CBCC8  bl       #0x382bd14 ; 
0065CBCCC  mov      w8, #1
0065CBCD0  adrp     x9, #0x9591000
0065CBCD4  strb     w8, [x9, #0xa7f]
0065CBCD8  adrp     x8, #0x8ee6000
0065CBCDC  ldr      x8, [x8, #0x2d8] ; GLOBAL Method$HotFix.BattleLogic.EntityCharacterData.get_Attribute()
0065CBCE0  ldr      x1, [x8]
...
0065CBF80  ldr      x0, [x0, #0x810] ; GLOBAL Method$LocalModels.Bean.ChapterWave_Waves.get_WaveAllExp()
0065CBF84  bl       #0x382bd14 ; 
0065CBF88  mov      w8, #1
0065CBF8C  strb     w8, [x21, #0x658]
0065CBF90  adrp     x22, #0x8f0a000
0065CBF94  ldr      x22, [x22, #0x810] ; GLOBAL Method$LocalModels.Bean.ChapterWave_Waves.get_WaveAllExp()
...
0065CBFD4  ldr      x0, [x0, #0x810] ; GLOBAL Method$LocalModels.Bean.ChapterWave_Waves.get_WaveAllExp()

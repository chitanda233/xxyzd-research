...
def render():
    ...
    parts.append('''</ul><a href="core.html">整体链路报告</a><p><a href="choices-box-evolution.html">三选一与宝箱专题</a></p><p><a href="monsters.html">怪物、弹幕与章节分布</a></p></nav><article class="article"><h2 id="overview">1. 章节怎样组织</h2><p class="summary">策划解读：这套章节把“稳定的局内成长预算”与“持续变化的敌人压力”分开控制。前10章承担技能方向引导，后续章节沿用共同成长规则，通过敌人组合、波次属性与场景复用持续扩展；周期性插入10波章节改变构筑长度和交战节奏。</p><p>章节表有1—70章与隐藏条目9999。以下统计只计70个非隐藏条目，隐藏条目保存在数据里；配置存在不代表线上已开放。规划意图属于从数据归纳的策划解读，不是开发团队声明。</p>''')
    ...
    with zipfile.ZipFile(out,'w',zipfile.ZIP_DEFLATED,compresslevel=9) as z:
        for p in files:
            ...
            if p.suffix=='.html':
                ...
                for page in ['core.html','choices-box-evolution.html','monsters.html']:s=s.replace('href="'+page+'"','href="https://chitanda233.github.io/xxyzd-research/'+page+'"')

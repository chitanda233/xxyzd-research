...
def render():
 ...
 out.append('<p><a href="https://github.com/chitanda233/xxyzd-research/tree/main/research-data/topics/monsters/">查看怪物专题数据与证据目录</a></p>')
 ...
 __import__('planner_reports').render_lookup('monsters', ''.join(out))
 __import__('planner_reports').render_page('monsters')
def manifest():
